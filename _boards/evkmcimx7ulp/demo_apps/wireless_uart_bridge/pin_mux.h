...
/* Routed pin properties */
#define BOARD_I2S1_TX_BCLK_PERIPHERAL                                        PTB   /*!< Peripheral name */
#define BOARD_I2S1_TX_BCLK_SIGNAL                                           port   /*!< Signal name */
#define BOARD_I2S1_TX_BCLK_CHANNEL                                             1   /*!< Signal channel */
#define BOARD_I2S1_TX_BCLK_PIN_NAME                                         PTB1   /*!< Routed pin name */
...
#define BOARD_I2S1_TX_BCLK_NAME                                   "I2S1_TX_BCLK"   /*!< Identifier */

/* PTB2 (number AE3), I2S1_TX_FS */
/* Routed pin properties */
#define BOARD_I2S1_TX_FS_PERIPHERAL                                          PTB   /*!< Peripheral name */
#define BOARD_I2S1_TX_FS_SIGNAL                                             port   /*!< Signal name */
#define BOARD_I2S1_TX_FS_CHANNEL                                               2   /*!< Signal channel */
#define BOARD_I2S1_TX_FS_PIN_NAME                                           PTB2   /*!< Routed pin name */
#define BOARD_I2S1_TX_FS_PIN_FUNCTION_ID                        IOMUXC_PTB2_PTB2   /*!< Pin function id */
#define BOARD_I2S1_TX_FS_LABEL                                      "I2S1_TX_FS"   /*!< Label */
#define BOARD_I2S1_TX_FS_NAME                                       "I2S1_TX_FS"   /*!< Identifier */

/* PTB3 (number AE4), I2S1_TXD0 */
/* Routed pin properties */
#define BOARD_I2S1_TXD0_PERIPHERAL                                           PTB   /*!< Peripheral name */
#define BOARD_I2S1_TXD0_SIGNAL                                              port   /*!< Signal name */
#define BOARD_I2S1_TXD0_CHANNEL                                                3   /*!< Signal channel */
#define BOARD_I2S1_TXD0_PIN_NAME                                            PTB3   /*!< Routed pin name */
#define BOARD_I2S1_TXD0_PIN_FUNCTION_ID                         IOMUXC_PTB3_PTB3   /*!< Pin function id */
#define BOARD_I2S1_TXD0_LABEL                                        "I2S1_TXD0"   /*!< Label */
#define BOARD_I2S1_TXD0_NAME                                         "I2S1_TXD0"   /*!< Identifier */

/* PTB10 (number AC7), I2S1_RXD0 */
/* Routed pin properties */
#define BOARD_I2S1_RXD0_PERIPHERAL                                           PTB   /*!< Peripheral name */
#define BOARD_I2S1_RXD0_SIGNAL                                              port   /*!< Signal name */
#define BOARD_I2S1_RXD0_CHANNEL                                               10   /*!< Signal channel */
#define BOARD_I2S1_RXD0_PIN_NAME                                           PTB10   /*!< Routed pin name */
#define BOARD_I2S1_RXD0_PIN_FUNCTION_ID                       IOMUXC_PTB10_PTB10   /*!< Pin function id */
#define BOARD_I2S1_RXD0_LABEL                                        "I2S1_RXD0"   /*!< Label */
#define BOARD_I2S1_RXD0_NAME                                         "I2S1_RXD0"   /*!< Identifier */

/* PTB4 (number AG4), PTB4 */
/* Routed pin properties */
#define BOARD_PTB4_PERIPHERAL                                                PTB   /*!< Peripheral name */
#define BOARD_PTB4_SIGNAL                                                   port   /*!< Signal name */
#define BOARD_PTB4_CHANNEL                                                     4   /*!< Signal channel */
#define BOARD_PTB4_PIN_NAME                                                 PTB4   /*!< Routed pin name */
#define BOARD_PTB4_PIN_FUNCTION_ID                              IOMUXC_PTB4_PTB4   /*!< Pin function id */
#define BOARD_PTB4_LABEL                                                  "PTB4"   /*!< Label */
#define BOARD_PTB4_NAME                                                   "PTB4"   /*!< Identifier */

/* PTB5 (number AF4), PTB5 */
/* Routed pin properties */
#define BOARD_PTB5_PERIPHERAL                                                PTB   /*!< Peripheral name */
#define BOARD_PTB5_SIGNAL                                                   port   /*!< Signal name */
#define BOARD_PTB5_CHANNEL                                                     5   /*!< Signal channel */
#define BOARD_PTB5_PIN_NAME                                                 PTB5   /*!< Routed pin name */
#define BOARD_PTB5_PIN_FUNCTION_ID                              IOMUXC_PTB5_PTB5   /*!< Pin function id */
#define BOARD_PTB5_LABEL                                                  "PTB5"   /*!< Label */
#define BOARD_PTB5_NAME                                                   "PTB5"   /*!< Identifier */
...
/* Routed pin properties */
#define BOARD_SEN_INT_PERIPHERAL                                             PTB   /*!< Peripheral name */
#define BOARD_SEN_INT_SIGNAL                                                port   /*!< Signal name */
#define BOARD_SEN_INT_CHANNEL                                                  9   /*!< Signal channel */
#define BOARD_SEN_INT_PIN_NAME                                              PTB9   /*!< Routed pin name */
#define BOARD_SEN_INT_PIN_FUNCTION_ID                           IOMUXC_PTB9_PTB9   /*!< Pin function id */
#define BOARD_SEN_INT_LABEL                                           "SEN_INT#"   /*!< Label */
#define BOARD_SEN_INT_NAME                                             "SEN_INT"   /*!< Identifier */
...
/* Routed pin properties */
#define BOARD_RTC_CLK_PERIPHERAL                                             RTC   /*!< Peripheral name */
#define BOARD_RTC_CLK_SIGNAL                                          rtc_clkout   /*!< Signal name */
#define BOARD_RTC_CLK_PIN_NAME                                             PTB14   /*!< Routed pin name */
#define BOARD_RTC_CLK_PIN_FUNCTION_ID                    IOMUXC_PTB14_RTC_CLKOUT   /*!< Pin function id */
#define BOARD_RTC_CLK_LABEL                                            "RTC_CLK"   /*!< Label */
#define BOARD_RTC_CLK_NAME                                             "RTC_CLK"   /*!< Identifier */

/* PTA11 (number AD18), UART2_RX */
/* Routed pin properties */
#define BOARD_UART2_RX_PERIPHERAL                                        LPUART2   /*!< Peripheral name */
#define BOARD_UART2_RX_SIGNAL                                          lpuart_rx   /*!< Signal name */
#define BOARD_UART2_RX_PIN_NAME                                            PTA11   /*!< Routed pin name */
#define BOARD_UART2_RX_PIN_FUNCTION_ID                   IOMUXC_PTA11_LPUART2_RX   /*!< Pin function id */
#define BOARD_UART2_RX_LABEL                                          "UART2_RX"   /*!< Label */
#define BOARD_UART2_RX_NAME                                           "UART2_RX"   /*!< Identifier */

/* PTA10 (number AD16), UART2_TX */
/* Routed pin properties */
#define BOARD_UART2_TX_PERIPHERAL                                        LPUART2   /*!< Peripheral name */
#define BOARD_UART2_TX_SIGNAL                                          lpuart_tx   /*!< Signal name */
#define BOARD_UART2_TX_PIN_NAME                                            PTA10   /*!< Routed pin name */
#define BOARD_UART2_TX_PIN_FUNCTION_ID                   IOMUXC_PTA10_LPUART2_TX   /*!< Pin function id */
#define BOARD_UART2_TX_LABEL                                          "UART2_TX"   /*!< Label */
#define BOARD_UART2_TX_NAME                                           "UART2_TX"   /*!< Identifier */
