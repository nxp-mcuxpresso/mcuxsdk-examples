...
void fsciRegisterRndis(uint32_t fsciInterfaceId)
{
    ...
    FSCI_RegisterOpGroup(gFSCI_RndisReqOpcodeGroup_c, gFsciMonitorMode_c, fsciRndisReqHandler, NULL, fsciInterfaceId);
}
...
void fsciRegisterRndisToHost(uint32_t fsciInterfaceId)
{
    ...
    FSCI_RegisterOpGroup(gFSCI_RndisCnfOpcodeGroup_c, gFsciMonitorMode_c, fsciRndisCnfHandler, NULL, fsciInterfaceId);
#endif
}
