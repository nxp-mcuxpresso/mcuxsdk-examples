 ...
 * data length sent by the host. In this way, the field isSetup is 0. The buffer is the address of the data sent from
 * the host. The length is the received data length. The setup is the setup packet address. @n
 ...
 * many kinds of class handles. However, there is only one device handle. Therefore, the handle points to a device
 * instead of a class. The class handle can be received from the #usb_device_class_config_struct_t::classHandle after
