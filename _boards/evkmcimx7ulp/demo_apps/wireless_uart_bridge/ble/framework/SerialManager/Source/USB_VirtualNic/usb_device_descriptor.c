...
usb_device_endpoint_struct_t g_cdcVnicDicEp[USB_CDC_VNIC_ENDPOINT_DIC_COUNT] = {
    ...
    {
        USB_CDC_VNIC_BULK_OUT_ENDPOINT | (USB_OUT << 7U),
        USB_ENDPOINT_BULK,
        FS_CDC_VNIC_BULK_OUT_PACKET_SIZE,
    }};
...
#if gVNICSerialNoEnable_d
uint8_t g_UsbDeviceString3[USB_DESCRIPTOR_LENGTH_STRING3] = {sizeof(g_UsbDeviceString3), USB_DESCRIPTOR_TYPE_STRING,
