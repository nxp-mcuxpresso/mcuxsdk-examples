mcux_add_source(
    ...
    SOURCES ${board_root}/${board}/FreeRTOSConfigBoard.h
            ${board_root}/${board}/multicore_examples/erpc_matrix_multiply_rpmsg_rtos/FreeRTOSConfig.h
            ${board_root}/${board}/multicore_examples/erpc_matrix_multiply_rpmsg_rtos/rpmsg_config.h
...
mcux_add_include(
    ...
    INCLUDES ${board_root}/evkmcimx7ulp
             ${board_root}/evkmcimx7ulp/multicore_examples/erpc_matrix_multiply_rpmsg_rtos
)
