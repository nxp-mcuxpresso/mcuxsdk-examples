...
const struct nt_electrode El_3 = {
    ...
    .gpio_input               = {GPIO_PTE0, GPIO_PTA10},
};
const struct nt_electrode El_4 = {
    ...
    .gpio_input               = {GPIO_PTE1, GPIO_PTA10},
};
const struct nt_electrode El_5 = {
    ...
    .gpio_input               = {GPIO_PTE0, GPIO_PTA11},
};
const struct nt_electrode El_6 = {
    ...
    .gpio_input               = {GPIO_PTE1, GPIO_PTA11},
};
