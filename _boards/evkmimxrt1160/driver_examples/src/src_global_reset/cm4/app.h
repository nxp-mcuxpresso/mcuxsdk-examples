 ...
 * procedure. In the start up stage the value of SRSR has been saved to SRC->GPR[11]. So that read SRC->GPR[11] to get
 * reset status.*/
#define DEMO_GET_RESET_STATUS_FLAGS (SRC->GPR[11])
#endif
/*${macro:end}*/
