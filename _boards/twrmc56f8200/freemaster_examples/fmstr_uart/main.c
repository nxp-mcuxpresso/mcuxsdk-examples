...
/* Use SCI_1 at OSBDM virtual serial port, GPIO_F, see jumper J8/J9 */
...
#define QSCIx_TIDLE_IRQn(x) QSCIx_IRQn(x, TIDLE)
...
static void init_freemaster_qsci(void)
{
    ...
    EnableIRQWithPriority(QSCIx_TIDLE_IRQn(BOARD_FMSTR_UART_INSTANCE), 1);
...
void QSCI_IRQ_HANDER(BOARD_FMSTR_UART_INSTANCE, TIDLE)(void);
