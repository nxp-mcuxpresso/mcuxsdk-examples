...
- pin_list:
  ...
  - {pin_num: '46', peripheral: PWMA, signal: 'A, 0', pin_signal: GPIOE1/PWM_0A}
  - {pin_num: '48', peripheral: PWMA, signal: 'A, 1', pin_signal: GPIOE3/PWM_1A}
  - {pin_num: '52', peripheral: PWMA, signal: 'A, 2', pin_signal: GPIOE5/PWM_2A/XB_IN3}
  - {pin_num: '45', peripheral: PWMA, signal: 'B, 0', pin_signal: GPIOE0/PWM_0B}
  - {pin_num: '56', peripheral: PWMA, signal: 'FAULT, 5', pin_signal: GPIOC15/SCL0/XB_OUT5/PWM_FAULT5}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    GPIO_PinSetPeripheralMux(kGPIO_Peri_C15_PWM_FAULT5);
