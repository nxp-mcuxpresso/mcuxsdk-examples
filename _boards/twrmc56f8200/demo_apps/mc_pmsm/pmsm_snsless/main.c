...
app_ver_t g_sAppIdFM = {
    "../boards/twrmc56f8200/mc_pmsm/pmsm_snsless",                       /* User Path 1- the highest priority */
    "../../../boards/twrmc56f8200/demo_apps/mc_pmsm/pmsm_snsless",       /* User Path 2 */
    "twrmc56f8200",    /* board id */
...
void PIT0_IRQHANDLER(void)
{
    ...
    /* Check if transition between M1/MID was requested. */
    M1_MID_Switch_BL();
	...
	{
		/* RED LED ON */
		GPIO_PinSet(MISC_PINS_LED_USER_GPIO, MISC_PINS_LED_USER_PIN_MASK);
	}
	...
	{
		/* RED LED OFF */
		GPIO_PinClear(MISC_PINS_LED_USER_GPIO, MISC_PINS_LED_USER_PIN_MASK);
	}
...
/* kGPIOF_VECTORn interrupt handler */
#pragma interrupt alignsp saveall
void BUTTON_IRQHANDLER(void) {
    /* clear interrupt flags - SW5 GC13*/
	GPIO_PinClearEdgeDetectedStatusFlags(MISC_PINS_SW1_GPIO, MISC_PINS_SW1_PIN_MASK);
