...
##
##  4. In SDM .x_FlashData could be used when compiler supports __has_feature(FE_POINTER_MODIFIERS)
##
##  5. In SDM .x_FlashData could be used when data allocation only range in x space address 0x4000-0x7FFF
##
##    ***************************************************************
