...
mcux_add_source(
    ...
    SOURCES middleware/ethos-u-core-software/examples/ethosu_apps/ethosu_apps.cpp
            middleware/ethos-u-core-software/examples/ethosu_apps/conv2d_model.hpp
...
mcux_add_include(
    ...
    INCLUDES middleware/ethos-u-core-software/include
             middleware/ethos-u-core-software/boards/mcimx93wevk
             middleware/ethos-u-core-software/examples/ethosu_apps
             middleware/ethos-u-core-software/board/mcimx93wevk
)
...
mcux_add_iar_linker_script(
    BASE_PATH ${SdkRootDirPath}
    TARGETS debug release
    LINKER middleware/ethos-u-core-software/boards/${board}/MIMX93W52_cm33_ram.icf
)
mcux_add_armgcc_linker_script(
    BASE_PATH ${SdkRootDirPath}
    TARGETS debug release
    LINKER middleware/ethos-u-core-software/boards/${board}/MIMX93W52_cm33_ram.ld
)
