  ...
  pin_labels:
  - {pin_num: M12, pin_signal: GPIO_AD_B1_03, label: SD_PWREN, identifier: SPDIF_IN;SD_PWREN}
  ...
  - pin_list:
    - {pin_num: M12, peripheral: GPIO1, signal: 'gpio_io, 19', pin_signal: GPIO_AD_B1_03, identifier: SD_PWREN, software_input_on: Disable, hysteresis_enable: Disable,
