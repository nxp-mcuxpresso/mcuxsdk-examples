  ...
  #define BOARD_SD_PWREN_PERIPHERAL                                          GPIO1   /*!< Peripheral name */
  #define BOARD_SD_PWREN_SIGNAL                                            gpio_io   /*!< Signal name */
  #define BOARD_SD_PWREN_CHANNEL                                               19U   /*!< Signal channel */
  
  /* Symbols to be used with GPIO driver */
  #define BOARD_SD_PWREN_GPIO                                                GPIO1   /*!< GPIO peripheral base pointer */
  #define BOARD_SD_PWREN_GPIO_PIN                                              19U   /*!< GPIO pin number */
  #define BOARD_SD_PWREN_GPIO_PIN_MASK                                 (1U << 19U)   /*!< GPIO pin mask */
  #define BOARD_SD_PWREN_PORT                                                GPIO1   /*!< PORT peripheral base pointer */
  #define BOARD_SD_PWREN_PIN                                                   19U   /*!< PORT pin number */
  #define BOARD_SD_PWREN_PIN_MASK                                      (1U << 19U)   /*!< PORT pin mask */
