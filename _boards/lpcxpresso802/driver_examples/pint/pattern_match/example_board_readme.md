...
2. This example configures "Pin Interrupt 0" to be invoked when ISP switch is pressed by the user. 
   ...
   "Pin Interrupt 2" is configured to be invoked when rising edge on ISP, USER is detected. The 
