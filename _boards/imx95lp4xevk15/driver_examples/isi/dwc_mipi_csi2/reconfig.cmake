  ...
  if(CONFIG_TOOLCHAIN STREQUAL "armgcc")
    ...
    mcux_add_custom_command(
      ...
      BUILD_COMMAND ${CMAKE_COMMAND}
        ...
        -P ${SdkRootDirPath}/${board_root}/imx95lp4xevk15/driver_examples/isi/dwc_mipi_csi2/ap1302_embed_objcopy.cmake
    )
  ...
  elseif(CONFIG_TOOLCHAIN STREQUAL "iar")
    ...
    mcux_add_custom_command(
      ...
      BUILD_COMMAND ${CMAKE_COMMAND}
        ...
        -P ${SdkRootDirPath}/${board_root}/imx95lp4xevk15/driver_examples/isi/dwc_mipi_csi2/ap1302_bin2iar_s.cmake
    )
...
mcux_add_armgcc_linker_script(
        TARGETS debug release
        BASE_PATH ${SdkRootDirPath}
        LINKER ${board_root}/imx95lp4xevk15/driver_examples/isi/dwc_mipi_csi2/linker/MIMX9596_cm7_isi_ram.ld
)
...
mcux_add_iar_linker_script(
        TARGETS debug release
        BASE_PATH ${SdkRootDirPath}
        LINKER ${board_root}/imx95lp4xevk15/driver_examples/isi/dwc_mipi_csi2/linker/MIMX9596_cm7_isi_ram.icf
)

# include ISI example file
include(${SdkRootDirPath}/${board_root}/imx95lp4xevk15/driver_examples/isi/reconfig.cmake)
