...
mcux_add_source(
    BASE_PATH ${SdkRootDirPath}
    SOURCES examples/demo_apps/safety_iec60730b/common/cm4_cm7/safety_cm4_cm7_imx8m.c
			examples/demo_apps/safety_iec60730b/common/cm4_cm7/safety_cm4_cm7_imx8m.h
			examples/demo_apps/safety_iec60730b/common/cm4_cm7/main_imx8m.c
)

# Remove MDK related files since MDK IDE is not supported
...
# Remove FreeMASTER related files - not available for evkmimx8mp safety example
mcux_project_remove_source(
    BASE_PATH ${SdkRootDirPath}
    SOURCES ${board_root}/${board}/demo_apps/safety_iec60730b/${multicore_foldername}/freemaster/freemaster_cfg.h
)

mcux_project_remove_include(
    BASE_PATH ${SdkRootDirPath}
    SOURCES ${board_root}/${board}/demo_apps/safety_iec60730b/${multicore_foldername}/freemaster
)
