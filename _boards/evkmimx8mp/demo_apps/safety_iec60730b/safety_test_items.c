...
fs_dio_test_imx_t dio_safety_test_item_0 = {
    ...
    .muxAddr = MUX_ADDR(IOMUXC_GPIO1_IO11_GPIO1_IO11),
    .padAddr = PAD_ADDR(IOMUXC_GPIO1_IO11_GPIO1_IO11),
};
...
fs_dio_test_imx_t dio_safety_test_item_1 = {
    ...
    .pinNum  = 9U,
    .pinDir  = PIN_DIRECTION_IN,
    .muxAddr = MUX_ADDR(IOMUXC_GPIO1_IO09_GPIO1_IO09),
    .padAddr = PAD_ADDR(IOMUXC_GPIO1_IO09_GPIO1_IO09),
};
