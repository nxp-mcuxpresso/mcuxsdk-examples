...
#define SYSTICK_FREQ             800000000U /* 800MHz */
#define SYSTICK_RELOAD_VALUE     800000U    /* 800MHz/800kHz = 1ms period */
...
#define Watchdog_refresh     \
    USED_WDOG->WSR = 0x5555; \
    USED_WDOG->WSR = 0xAAAA
...
#define WD_RUN_TEST_CONDITION \
    (SRC_SRSR_ipp_reset_b_MASK | SRC_SRSR_csu_reset_b_MASK | SRC_SRSR_ipp_user_reset_b_MASK | SRC_SRSR_jtag_sw_rst_MASK)
