...
#define BOARD_BOOTCLOCKFRO12M_BUS_CLOCK               6000000UL      /* Clock consumers of BUS_clock output : N/A */
#define BOARD_BOOTCLOCKFRO12M_CLK16K_0_CLOCK          0UL            /* Clock consumers of CLK16K_0_clock output : CMP0, LPTMR0, WAKETIMER0 */
...
#define BOARD_BOOTCLOCKFRO12M_SLOW_CLOCK              2000000UL      /* Clock consumers of Slow_clock output : AOI0, AOI1, LPTMR0 */
#define BOARD_BOOTCLOCKFRO12M_SYSTEM_CLOCK            12000000UL     /* Clock consumers of System_clock output : ADC0, ADC1, ADC2, ADC3, CAN0, CAN1, CMP0, CMP1, CMP2, CTIMER0, CTIMER1, CTIMER2, CTIMER3, CTIMER4, DAC0, DMA0, EQDC0, EQDC1, FLEXIO0, FREQME0, GPIO0, GPIO1, GPIO2, GPIO3, GPIO4, I3C0, LPI2C0, LPI2C1, LPI2C2, LPI2C3, LPSPI0, LPSPI1, LPUART0, LPUART1, LPUART2, LPUART3, LPUART4, LPUART5, OSTIMER0, PORT0, PORT1, PORT2, PORT3, PORT4, USB0, UTICK0, WWDT0 */
 ...
 ******************************************************************************/
#define BOARD_BOOTCLOCKFRO24M_CORE_CLOCK           45000000U  /*!< Core clock frequency: 45000000Hz */

/* Clock outputs (values are in Hz): */
#define BOARD_BOOTCLOCKFRO24M_ADC_CLOCK               0UL            /* Clock consumers of ADC_clock output : ADC0, ADC1, ADC2, ADC3 */
#define BOARD_BOOTCLOCKFRO24M_BUS_CLOCK               22500000UL     /* Clock consumers of BUS_clock output : N/A */
#define BOARD_BOOTCLOCKFRO24M_CLK16K_0_CLOCK          0UL            /* Clock consumers of CLK16K_0_clock output : CMP0, LPTMR0, WAKETIMER0 */
#define BOARD_BOOTCLOCKFRO24M_CLK16K_1_CLOCK          0UL            /* Clock consumers of CLK16K_1_clock output : CMP1, CMP2, WAKETIMER0 */
...
#define BOARD_BOOTCLOCKFRO24M_CLK_45M_CLOCK           45000000UL     /* Clock consumers of CLK_45M_clock output : N/A */
#define BOARD_BOOTCLOCKFRO24M_CLK_IN_CLOCK            0UL            /* Clock consumers of CLK_IN_clock output : N/A */
#define BOARD_BOOTCLOCKFRO24M_CMP0_FUNC_DIV_CLOCK     0UL            /* Clock consumers of CMP0_FUNC_DIV_clock output : CMP0 */
#define BOARD_BOOTCLOCKFRO24M_CMP0_RR_DIV_CLOCK       0UL            /* Clock consumers of CMP0_RR_DIV_clock output : CMP0 */
#define BOARD_BOOTCLOCKFRO24M_CMP1_FUNC_DIV_CLOCK     0UL            /* Clock consumers of CMP1_FUNC_DIV_clock output : CMP1 */
#define BOARD_BOOTCLOCKFRO24M_CMP1_RR_DIV_CLOCK       0UL            /* Clock consumers of CMP1_RR_DIV_clock output : CMP1 */
#define BOARD_BOOTCLOCKFRO24M_CMP2_FUNC_DIV_CLOCK     0UL            /* Clock consumers of CMP2_FUNC_DIV_clock output : CMP2 */
#define BOARD_BOOTCLOCKFRO24M_CMP2_RR_DIV_CLOCK       0UL            /* Clock consumers of CMP2_RR_DIV_clock output : CMP2 */
#define BOARD_BOOTCLOCKFRO24M_CPU_CLOCK               45000000UL     /* Clock consumers of CPU_clock output : N/A */
...
#define BOARD_BOOTCLOCKFRO24M_FLEXCAN1_CLOCK          0UL            /* Clock consumers of FLEXCAN1_clock output : CAN1 */
#define BOARD_BOOTCLOCKFRO24M_FLEXIO0_CLOCK           0UL            /* Clock consumers of FLEXIO0_clock output : FLEXIO0 */
#define BOARD_BOOTCLOCKFRO24M_FREQME_REFERENCE_CLOCK  0UL            /* Clock consumers of FREQME_reference_clock output : N/A */
#define BOARD_BOOTCLOCKFRO24M_FREQME_TARGET_CLOCK     0UL            /* Clock consumers of FREQME_target_clock output : N/A */
#define BOARD_BOOTCLOCKFRO24M_FRO_12M_DIV_CLOCK       0UL            /* Clock consumers of FRO_12M_DIV_clock output : N/A */
#define BOARD_BOOTCLOCKFRO24M_FRO_12M_CLOCK           12000000UL     /* Clock consumers of FRO_12M_clock output : N/A */
#define BOARD_BOOTCLOCKFRO24M_FRO_HF_DIV_CLOCK        0UL            /* Clock consumers of FRO_HF_DIV_clock output : N/A */
#define BOARD_BOOTCLOCKFRO24M_FRO_HF_CLOCK            45000000UL     /* Clock consumers of FRO_HF_clock output : N/A */
...
#define BOARD_BOOTCLOCKFRO24M_LPUART5_CLOCK           0UL            /* Clock consumers of LPUART5_clock output : LPUART5 */
#define BOARD_BOOTCLOCKFRO24M_MAIN_CLOCK              45000000UL     /* Clock consumers of MAIN_clock output : FLEXPWM0, FLEXPWM1 */
#define BOARD_BOOTCLOCKFRO24M_OSTIMER0_CLOCK          0UL            /* Clock consumers of OSTIMER0_clock output : OSTIMER0 */
#define BOARD_BOOTCLOCKFRO24M_PLL1_DIV_CLOCK          0UL            /* Clock consumers of PLL1_DIV_clock output : N/A */
#define BOARD_BOOTCLOCKFRO24M_PLL1_CLOCK              0UL            /* Clock consumers of PLL1_clock output : N/A */
#define BOARD_BOOTCLOCKFRO24M_SYSTICK_CLOCK           0UL            /* Clock consumers of SYSTICK_clock output : N/A */
#define BOARD_BOOTCLOCKFRO24M_SLOW_CLOCK              7500000UL      /* Clock consumers of Slow_clock output : AOI0, AOI1, LPTMR0 */
#define BOARD_BOOTCLOCKFRO24M_SYSTEM_CLOCK            45000000UL     /* Clock consumers of System_clock output : ADC0, ADC1, ADC2, ADC3, CAN0, CAN1, CMP0, CMP1, CMP2, CTIMER0, CTIMER1, CTIMER2, CTIMER3, CTIMER4, DAC0, DMA0, EQDC0, EQDC1, FLEXIO0, FREQME0, GPIO0, GPIO1, GPIO2, GPIO3, GPIO4, I3C0, LPI2C0, LPI2C1, LPI2C2, LPI2C3, LPSPI0, LPSPI1, LPUART0, LPUART1, LPUART2, LPUART3, LPUART4, LPUART5, OSTIMER0, PORT0, PORT1, PORT2, PORT3, PORT4, USB0, UTICK0, WWDT0 */
#define BOARD_BOOTCLOCKFRO24M_TRACE_CLOCK             45000000UL     /* Clock consumers of TRACE_clock output : N/A */
#define BOARD_BOOTCLOCKFRO24M_USB0_CLOCK              0UL            /* Clock consumers of USB0_clock output : USB0 */
#define BOARD_BOOTCLOCKFRO24M_UTICK0_CLOCK            1000000UL      /* Clock consumers of UTICK0_clock output : UTICK0 */
 ...
 ******************************************************************************/
#define BOARD_BOOTCLOCKFRO48M_CORE_CLOCK           45000000U  /*!< Core clock frequency: 45000000Hz */

/* Clock outputs (values are in Hz): */
#define BOARD_BOOTCLOCKFRO48M_ADC_CLOCK               0UL            /* Clock consumers of ADC_clock output : ADC0, ADC1, ADC2, ADC3 */
#define BOARD_BOOTCLOCKFRO48M_BUS_CLOCK               22500000UL     /* Clock consumers of BUS_clock output : N/A */
#define BOARD_BOOTCLOCKFRO48M_CLK16K_0_CLOCK          0UL            /* Clock consumers of CLK16K_0_clock output : CMP0, LPTMR0, WAKETIMER0 */
#define BOARD_BOOTCLOCKFRO48M_CLK16K_1_CLOCK          0UL            /* Clock consumers of CLK16K_1_clock output : CMP1, CMP2, WAKETIMER0 */
...
#define BOARD_BOOTCLOCKFRO48M_CLK_45M_CLOCK           45000000UL     /* Clock consumers of CLK_45M_clock output : N/A */
#define BOARD_BOOTCLOCKFRO48M_CLK_IN_CLOCK            0UL            /* Clock consumers of CLK_IN_clock output : N/A */
#define BOARD_BOOTCLOCKFRO48M_CMP0_FUNC_DIV_CLOCK     0UL            /* Clock consumers of CMP0_FUNC_DIV_clock output : CMP0 */
#define BOARD_BOOTCLOCKFRO48M_CMP0_RR_DIV_CLOCK       0UL            /* Clock consumers of CMP0_RR_DIV_clock output : CMP0 */
#define BOARD_BOOTCLOCKFRO48M_CMP1_FUNC_DIV_CLOCK     0UL            /* Clock consumers of CMP1_FUNC_DIV_clock output : CMP1 */
#define BOARD_BOOTCLOCKFRO48M_CMP1_RR_DIV_CLOCK       0UL            /* Clock consumers of CMP1_RR_DIV_clock output : CMP1 */
#define BOARD_BOOTCLOCKFRO48M_CMP2_FUNC_DIV_CLOCK     0UL            /* Clock consumers of CMP2_FUNC_DIV_clock output : CMP2 */
#define BOARD_BOOTCLOCKFRO48M_CMP2_RR_DIV_CLOCK       0UL            /* Clock consumers of CMP2_RR_DIV_clock output : CMP2 */
#define BOARD_BOOTCLOCKFRO48M_CPU_CLOCK               45000000UL     /* Clock consumers of CPU_clock output : N/A */
...
#define BOARD_BOOTCLOCKFRO48M_FLEXCAN1_CLOCK          0UL            /* Clock consumers of FLEXCAN1_clock output : CAN1 */
#define BOARD_BOOTCLOCKFRO48M_FLEXIO0_CLOCK           0UL            /* Clock consumers of FLEXIO0_clock output : FLEXIO0 */
#define BOARD_BOOTCLOCKFRO48M_FREQME_REFERENCE_CLOCK  0UL            /* Clock consumers of FREQME_reference_clock output : N/A */
#define BOARD_BOOTCLOCKFRO48M_FREQME_TARGET_CLOCK     0UL            /* Clock consumers of FREQME_target_clock output : N/A */
#define BOARD_BOOTCLOCKFRO48M_FRO_12M_DIV_CLOCK       0UL            /* Clock consumers of FRO_12M_DIV_clock output : N/A */
#define BOARD_BOOTCLOCKFRO48M_FRO_12M_CLOCK           12000000UL     /* Clock consumers of FRO_12M_clock output : N/A */
#define BOARD_BOOTCLOCKFRO48M_FRO_HF_DIV_CLOCK        0UL            /* Clock consumers of FRO_HF_DIV_clock output : N/A */
#define BOARD_BOOTCLOCKFRO48M_FRO_HF_CLOCK            45000000UL     /* Clock consumers of FRO_HF_clock output : N/A */
...
#define BOARD_BOOTCLOCKFRO48M_LPUART5_CLOCK           0UL            /* Clock consumers of LPUART5_clock output : LPUART5 */
#define BOARD_BOOTCLOCKFRO48M_MAIN_CLOCK              45000000UL     /* Clock consumers of MAIN_clock output : FLEXPWM0, FLEXPWM1 */
#define BOARD_BOOTCLOCKFRO48M_OSTIMER0_CLOCK          0UL            /* Clock consumers of OSTIMER0_clock output : OSTIMER0 */
#define BOARD_BOOTCLOCKFRO48M_PLL1_DIV_CLOCK          0UL            /* Clock consumers of PLL1_DIV_clock output : N/A */
#define BOARD_BOOTCLOCKFRO48M_PLL1_CLOCK              0UL            /* Clock consumers of PLL1_clock output : N/A */
#define BOARD_BOOTCLOCKFRO48M_SYSTICK_CLOCK           0UL            /* Clock consumers of SYSTICK_clock output : N/A */
#define BOARD_BOOTCLOCKFRO48M_SLOW_CLOCK              7500000UL      /* Clock consumers of Slow_clock output : AOI0, AOI1, LPTMR0 */
#define BOARD_BOOTCLOCKFRO48M_SYSTEM_CLOCK            45000000UL     /* Clock consumers of System_clock output : ADC0, ADC1, ADC2, ADC3, CAN0, CAN1, CMP0, CMP1, CMP2, CTIMER0, CTIMER1, CTIMER2, CTIMER3, CTIMER4, DAC0, DMA0, EQDC0, EQDC1, FLEXIO0, FREQME0, GPIO0, GPIO1, GPIO2, GPIO3, GPIO4, I3C0, LPI2C0, LPI2C1, LPI2C2, LPI2C3, LPSPI0, LPSPI1, LPUART0, LPUART1, LPUART2, LPUART3, LPUART4, LPUART5, OSTIMER0, PORT0, PORT1, PORT2, PORT3, PORT4, USB0, UTICK0, WWDT0 */
#define BOARD_BOOTCLOCKFRO48M_TRACE_CLOCK             45000000UL     /* Clock consumers of TRACE_clock output : N/A */
#define BOARD_BOOTCLOCKFRO48M_USB0_CLOCK              0UL            /* Clock consumers of USB0_clock output : USB0 */
#define BOARD_BOOTCLOCKFRO48M_UTICK0_CLOCK            1000000UL      /* Clock consumers of UTICK0_clock output : UTICK0 */
 ...
 ******************************************************************************/
#define BOARD_BOOTCLOCKFRO64M_CORE_CLOCK           45000000U  /*!< Core clock frequency: 45000000Hz */

/* Clock outputs (values are in Hz): */
#define BOARD_BOOTCLOCKFRO64M_ADC_CLOCK               0UL            /* Clock consumers of ADC_clock output : ADC0, ADC1, ADC2, ADC3 */
#define BOARD_BOOTCLOCKFRO64M_BUS_CLOCK               22500000UL     /* Clock consumers of BUS_clock output : N/A */
#define BOARD_BOOTCLOCKFRO64M_CLK16K_0_CLOCK          0UL            /* Clock consumers of CLK16K_0_clock output : CMP0, LPTMR0, WAKETIMER0 */
#define BOARD_BOOTCLOCKFRO64M_CLK16K_1_CLOCK          0UL            /* Clock consumers of CLK16K_1_clock output : CMP1, CMP2, WAKETIMER0 */
...
#define BOARD_BOOTCLOCKFRO64M_CLK_45M_CLOCK           45000000UL     /* Clock consumers of CLK_45M_clock output : N/A */
#define BOARD_BOOTCLOCKFRO64M_CLK_IN_CLOCK            0UL            /* Clock consumers of CLK_IN_clock output : N/A */
#define BOARD_BOOTCLOCKFRO64M_CMP0_FUNC_DIV_CLOCK     0UL            /* Clock consumers of CMP0_FUNC_DIV_clock output : CMP0 */
#define BOARD_BOOTCLOCKFRO64M_CMP0_RR_DIV_CLOCK       0UL            /* Clock consumers of CMP0_RR_DIV_clock output : CMP0 */
#define BOARD_BOOTCLOCKFRO64M_CMP1_FUNC_DIV_CLOCK     0UL            /* Clock consumers of CMP1_FUNC_DIV_clock output : CMP1 */
#define BOARD_BOOTCLOCKFRO64M_CMP1_RR_DIV_CLOCK       0UL            /* Clock consumers of CMP1_RR_DIV_clock output : CMP1 */
#define BOARD_BOOTCLOCKFRO64M_CMP2_FUNC_DIV_CLOCK     0UL            /* Clock consumers of CMP2_FUNC_DIV_clock output : CMP2 */
#define BOARD_BOOTCLOCKFRO64M_CMP2_RR_DIV_CLOCK       0UL            /* Clock consumers of CMP2_RR_DIV_clock output : CMP2 */
#define BOARD_BOOTCLOCKFRO64M_CPU_CLOCK               45000000UL     /* Clock consumers of CPU_clock output : N/A */
...
#define BOARD_BOOTCLOCKFRO64M_FLEXCAN1_CLOCK          0UL            /* Clock consumers of FLEXCAN1_clock output : CAN1 */
#define BOARD_BOOTCLOCKFRO64M_FLEXIO0_CLOCK           0UL            /* Clock consumers of FLEXIO0_clock output : FLEXIO0 */
#define BOARD_BOOTCLOCKFRO64M_FREQME_REFERENCE_CLOCK  0UL            /* Clock consumers of FREQME_reference_clock output : N/A */
#define BOARD_BOOTCLOCKFRO64M_FREQME_TARGET_CLOCK     0UL            /* Clock consumers of FREQME_target_clock output : N/A */
#define BOARD_BOOTCLOCKFRO64M_FRO_12M_DIV_CLOCK       0UL            /* Clock consumers of FRO_12M_DIV_clock output : N/A */
#define BOARD_BOOTCLOCKFRO64M_FRO_12M_CLOCK           12000000UL     /* Clock consumers of FRO_12M_clock output : N/A */
#define BOARD_BOOTCLOCKFRO64M_FRO_HF_DIV_CLOCK        0UL            /* Clock consumers of FRO_HF_DIV_clock output : N/A */
#define BOARD_BOOTCLOCKFRO64M_FRO_HF_CLOCK            45000000UL     /* Clock consumers of FRO_HF_clock output : N/A */
...
#define BOARD_BOOTCLOCKFRO64M_LPUART5_CLOCK           0UL            /* Clock consumers of LPUART5_clock output : LPUART5 */
#define BOARD_BOOTCLOCKFRO64M_MAIN_CLOCK              45000000UL     /* Clock consumers of MAIN_clock output : FLEXPWM0, FLEXPWM1 */
#define BOARD_BOOTCLOCKFRO64M_OSTIMER0_CLOCK          0UL            /* Clock consumers of OSTIMER0_clock output : OSTIMER0 */
#define BOARD_BOOTCLOCKFRO64M_PLL1_DIV_CLOCK          0UL            /* Clock consumers of PLL1_DIV_clock output : N/A */
#define BOARD_BOOTCLOCKFRO64M_PLL1_CLOCK              0UL            /* Clock consumers of PLL1_clock output : N/A */
#define BOARD_BOOTCLOCKFRO64M_SYSTICK_CLOCK           0UL            /* Clock consumers of SYSTICK_clock output : N/A */
#define BOARD_BOOTCLOCKFRO64M_SLOW_CLOCK              7500000UL      /* Clock consumers of Slow_clock output : AOI0, AOI1, LPTMR0 */
#define BOARD_BOOTCLOCKFRO64M_SYSTEM_CLOCK            45000000UL     /* Clock consumers of System_clock output : ADC0, ADC1, ADC2, ADC3, CAN0, CAN1, CMP0, CMP1, CMP2, CTIMER0, CTIMER1, CTIMER2, CTIMER3, CTIMER4, DAC0, DMA0, EQDC0, EQDC1, FLEXIO0, FREQME0, GPIO0, GPIO1, GPIO2, GPIO3, GPIO4, I3C0, LPI2C0, LPI2C1, LPI2C2, LPI2C3, LPSPI0, LPSPI1, LPUART0, LPUART1, LPUART2, LPUART3, LPUART4, LPUART5, OSTIMER0, PORT0, PORT1, PORT2, PORT3, PORT4, USB0, UTICK0, WWDT0 */
#define BOARD_BOOTCLOCKFRO64M_TRACE_CLOCK             45000000UL     /* Clock consumers of TRACE_clock output : N/A */
#define BOARD_BOOTCLOCKFRO64M_USB0_CLOCK              0UL            /* Clock consumers of USB0_clock output : USB0 */
#define BOARD_BOOTCLOCKFRO64M_UTICK0_CLOCK            1000000UL      /* Clock consumers of UTICK0_clock output : UTICK0 */
 ...
 ******************************************************************************/
#define BOARD_BOOTCLOCKFRO96M_CORE_CLOCK           45000000U  /*!< Core clock frequency: 45000000Hz */

/* Clock outputs (values are in Hz): */
#define BOARD_BOOTCLOCKFRO96M_ADC_CLOCK               0UL            /* Clock consumers of ADC_clock output : ADC0, ADC1, ADC2, ADC3 */
#define BOARD_BOOTCLOCKFRO96M_BUS_CLOCK               22500000UL     /* Clock consumers of BUS_clock output : N/A */
#define BOARD_BOOTCLOCKFRO96M_CLK16K_0_CLOCK          0UL            /* Clock consumers of CLK16K_0_clock output : CMP0, LPTMR0, WAKETIMER0 */
#define BOARD_BOOTCLOCKFRO96M_CLK16K_1_CLOCK          0UL            /* Clock consumers of CLK16K_1_clock output : CMP1, CMP2, WAKETIMER0 */
...
#define BOARD_BOOTCLOCKFRO96M_CLK_45M_CLOCK           45000000UL     /* Clock consumers of CLK_45M_clock output : N/A */
#define BOARD_BOOTCLOCKFRO96M_CLK_IN_CLOCK            0UL            /* Clock consumers of CLK_IN_clock output : N/A */
#define BOARD_BOOTCLOCKFRO96M_CMP0_FUNC_DIV_CLOCK     0UL            /* Clock consumers of CMP0_FUNC_DIV_clock output : CMP0 */
#define BOARD_BOOTCLOCKFRO96M_CMP0_RR_DIV_CLOCK       0UL            /* Clock consumers of CMP0_RR_DIV_clock output : CMP0 */
#define BOARD_BOOTCLOCKFRO96M_CMP1_FUNC_DIV_CLOCK     0UL            /* Clock consumers of CMP1_FUNC_DIV_clock output : CMP1 */
#define BOARD_BOOTCLOCKFRO96M_CMP1_RR_DIV_CLOCK       0UL            /* Clock consumers of CMP1_RR_DIV_clock output : CMP1 */
#define BOARD_BOOTCLOCKFRO96M_CMP2_FUNC_DIV_CLOCK     0UL            /* Clock consumers of CMP2_FUNC_DIV_clock output : CMP2 */
#define BOARD_BOOTCLOCKFRO96M_CMP2_RR_DIV_CLOCK       0UL            /* Clock consumers of CMP2_RR_DIV_clock output : CMP2 */
#define BOARD_BOOTCLOCKFRO96M_CPU_CLOCK               45000000UL     /* Clock consumers of CPU_clock output : N/A */
...
#define BOARD_BOOTCLOCKFRO96M_FLEXCAN1_CLOCK          0UL            /* Clock consumers of FLEXCAN1_clock output : CAN1 */
#define BOARD_BOOTCLOCKFRO96M_FLEXIO0_CLOCK           0UL            /* Clock consumers of FLEXIO0_clock output : FLEXIO0 */
#define BOARD_BOOTCLOCKFRO96M_FREQME_REFERENCE_CLOCK  0UL            /* Clock consumers of FREQME_reference_clock output : N/A */
#define BOARD_BOOTCLOCKFRO96M_FREQME_TARGET_CLOCK     0UL            /* Clock consumers of FREQME_target_clock output : N/A */
#define BOARD_BOOTCLOCKFRO96M_FRO_12M_DIV_CLOCK       0UL            /* Clock consumers of FRO_12M_DIV_clock output : N/A */
#define BOARD_BOOTCLOCKFRO96M_FRO_12M_CLOCK           12000000UL     /* Clock consumers of FRO_12M_clock output : N/A */
#define BOARD_BOOTCLOCKFRO96M_FRO_HF_DIV_CLOCK        0UL            /* Clock consumers of FRO_HF_DIV_clock output : N/A */
#define BOARD_BOOTCLOCKFRO96M_FRO_HF_CLOCK            45000000UL     /* Clock consumers of FRO_HF_clock output : N/A */
...
#define BOARD_BOOTCLOCKFRO96M_LPUART5_CLOCK           0UL            /* Clock consumers of LPUART5_clock output : LPUART5 */
#define BOARD_BOOTCLOCKFRO96M_MAIN_CLOCK              45000000UL     /* Clock consumers of MAIN_clock output : FLEXPWM0, FLEXPWM1 */
#define BOARD_BOOTCLOCKFRO96M_OSTIMER0_CLOCK          0UL            /* Clock consumers of OSTIMER0_clock output : OSTIMER0 */
#define BOARD_BOOTCLOCKFRO96M_PLL1_DIV_CLOCK          0UL            /* Clock consumers of PLL1_DIV_clock output : N/A */
#define BOARD_BOOTCLOCKFRO96M_PLL1_CLOCK              0UL            /* Clock consumers of PLL1_clock output : N/A */
#define BOARD_BOOTCLOCKFRO96M_SYSTICK_CLOCK           0UL            /* Clock consumers of SYSTICK_clock output : N/A */
#define BOARD_BOOTCLOCKFRO96M_SLOW_CLOCK              7500000UL      /* Clock consumers of Slow_clock output : AOI0, AOI1, LPTMR0 */
#define BOARD_BOOTCLOCKFRO96M_SYSTEM_CLOCK            45000000UL     /* Clock consumers of System_clock output : ADC0, ADC1, ADC2, ADC3, CAN0, CAN1, CMP0, CMP1, CMP2, CTIMER0, CTIMER1, CTIMER2, CTIMER3, CTIMER4, DAC0, DMA0, EQDC0, EQDC1, FLEXIO0, FREQME0, GPIO0, GPIO1, GPIO2, GPIO3, GPIO4, I3C0, LPI2C0, LPI2C1, LPI2C2, LPI2C3, LPSPI0, LPSPI1, LPUART0, LPUART1, LPUART2, LPUART3, LPUART4, LPUART5, OSTIMER0, PORT0, PORT1, PORT2, PORT3, PORT4, USB0, UTICK0, WWDT0 */
#define BOARD_BOOTCLOCKFRO96M_TRACE_CLOCK             45000000UL     /* Clock consumers of TRACE_clock output : N/A */
#define BOARD_BOOTCLOCKFRO96M_USB0_CLOCK              0UL            /* Clock consumers of USB0_clock output : USB0 */
#define BOARD_BOOTCLOCKFRO96M_UTICK0_CLOCK            1000000UL      /* Clock consumers of UTICK0_clock output : UTICK0 */
...
#define BOARD_BOOTCLOCKFROHF45M_BUS_CLOCK             22500000UL     /* Clock consumers of BUS_clock output : N/A */
#define BOARD_BOOTCLOCKFROHF45M_CLK16K_0_CLOCK        0UL            /* Clock consumers of CLK16K_0_clock output : CMP0, LPTMR0, WAKETIMER0 */
...
#define BOARD_BOOTCLOCKFROHF45M_CLK_1M_CLOCK          1000000UL      /* Clock consumers of CLK_1M_clock output : N/A */
...
#define BOARD_BOOTCLOCKFROHF45M_SLOW_CLOCK            7500000UL      /* Clock consumers of Slow_clock output : AOI0, AOI1, LPTMR0 */
...
#define BOARD_BOOTCLOCKFROHF60M_BUS_CLOCK             30000000UL     /* Clock consumers of BUS_clock output : N/A */
#define BOARD_BOOTCLOCKFROHF60M_CLK16K_0_CLOCK        0UL            /* Clock consumers of CLK16K_0_clock output : CMP0, LPTMR0, WAKETIMER0 */
...
#define BOARD_BOOTCLOCKFROHF60M_CLK_1M_CLOCK          1000000UL      /* Clock consumers of CLK_1M_clock output : N/A */
...
#define BOARD_BOOTCLOCKFROHF60M_SLOW_CLOCK            10000000UL     /* Clock consumers of Slow_clock output : AOI0, AOI1, LPTMR0 */
...
#define BOARD_BOOTCLOCKFROHF90M_BUS_CLOCK             45000000UL     /* Clock consumers of BUS_clock output : N/A */
#define BOARD_BOOTCLOCKFROHF90M_CLK16K_0_CLOCK        0UL            /* Clock consumers of CLK16K_0_clock output : CMP0, LPTMR0, WAKETIMER0 */
...
#define BOARD_BOOTCLOCKFROHF90M_CLK_1M_CLOCK          1000000UL      /* Clock consumers of CLK_1M_clock output : N/A */
...
#define BOARD_BOOTCLOCKFROHF90M_SLOW_CLOCK            15000000UL     /* Clock consumers of Slow_clock output : AOI0, AOI1, LPTMR0 */
...
#define BOARD_BOOTCLOCKFROHF180M_BUS_CLOCK            90000000UL     /* Clock consumers of BUS_clock output : N/A */
#define BOARD_BOOTCLOCKFROHF180M_CLK16K_0_CLOCK       0UL            /* Clock consumers of CLK16K_0_clock output : CMP0, LPTMR0, WAKETIMER0 */
...
#define BOARD_BOOTCLOCKFROHF180M_CLK_1M_CLOCK         1000000UL      /* Clock consumers of CLK_1M_clock output : N/A */
...
#define BOARD_BOOTCLOCKFROHF180M_SLOW_CLOCK           30000000UL     /* Clock consumers of Slow_clock output : AOI0, AOI1, LPTMR0 */
#define BOARD_BOOTCLOCKFROHF180M_SYSTEM_CLOCK         180000000UL    /* Clock consumers of System_clock output : ADC0, ADC1, ADC2, ADC3, CAN0, CAN1, CMP0, CMP1, CMP2, CTIMER0, CTIMER1, CTIMER2, CTIMER3, CTIMER4, DAC0, DMA0, EQDC0, EQDC1, FLEXIO0, FREQME0, GPIO0, GPIO1, GPIO2, GPIO3, GPIO4, I3C0, LPI2C0, LPI2C1, LPI2C2, LPI2C3, LPSPI0, LPSPI1, LPUART0, LPUART1, LPUART2, LPUART3, LPUART4, LPUART5, OSTIMER0, PORT0, PORT1, PORT2, PORT3, PORT4, USB0, UTICK0, WWDT0 */
#define BOARD_BOOTCLOCKFROHF180M_TRACE_CLOCK          180000000UL    /* Clock consumers of TRACE_clock output : N/A */
...
#define BOARD_BOOTCLOCKPLL180M_BUS_CLOCK              90000000UL     /* Clock consumers of BUS_clock output : N/A */
#define BOARD_BOOTCLOCKPLL180M_CLK16K_0_CLOCK         0UL            /* Clock consumers of CLK16K_0_clock output : CMP0, LPTMR0, WAKETIMER0 */
...
#define BOARD_BOOTCLOCKPLL180M_CLK_1M_CLOCK           1000000UL      /* Clock consumers of CLK_1M_clock output : N/A */
...
#define BOARD_BOOTCLOCKPLL180M_SLOW_CLOCK             30000000UL     /* Clock consumers of Slow_clock output : AOI0, AOI1, LPTMR0 */
#define BOARD_BOOTCLOCKPLL180M_SYSTEM_CLOCK           180000000UL    /* Clock consumers of System_clock output : ADC0, ADC1, ADC2, ADC3, CAN0, CAN1, CMP0, CMP1, CMP2, CTIMER0, CTIMER1, CTIMER2, CTIMER3, CTIMER4, DAC0, DMA0, EQDC0, EQDC1, FLEXIO0, FREQME0, GPIO0, GPIO1, GPIO2, GPIO3, GPIO4, I3C0, LPI2C0, LPI2C1, LPI2C2, LPI2C3, LPSPI0, LPSPI1, LPUART0, LPUART1, LPUART2, LPUART3, LPUART4, LPUART5, OSTIMER0, PORT0, PORT1, PORT2, PORT3, PORT4, USB0, UTICK0, WWDT0 */
#define BOARD_BOOTCLOCKPLL180M_TRACE_CLOCK            180000000UL    /* Clock consumers of TRACE_clock output : N/A */
