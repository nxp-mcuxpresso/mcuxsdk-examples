...
#define APP_POWER_MODE_DESC                                                                                           \
    {                                                                                                                 \
        "Acitve: Core clock is 180MHz.", "Sleep: CPU clock is off, and the system clock and bus clock remain ON. ",    \
...
#define APP_SPC                                 SPC0
#define APP_SPC_WAKEUP_TIMER_ISO_VALUE          (0x4U) /* VDD_P3. */
#define APP_SPC_WAKEUP_TIMER_LPISO_VALUE        (0x4U) /* VDD_P3. */
#define APP_SPC_WAKEUP_TIMER_ISO_DOMAINS        "VDD_P3"

#define APP_SPC_WAKEUP_BUTTON_ISO_VALUE         (0x4U) /* VDD_P3. */
#define APP_SPC_WAKEUP_BUTTON_LPISO_VALUE       (0x4U) /* VDD_P3. */
#define APP_SPC_WAKEUP_BUTTON_ISO_DOMAINS       "VDD_P3."
...
#define APP_POST_INIT_CLOCK 1
#define APP_POST_INIT_CLOCK_FUNCTION() BOARD_BootClockFROHF180M()

/* LPUART RX */
#define APP_DEBUG_CONSOLE_RX_PORT   PORT2
#define APP_DEBUG_CONSOLE_RX_PIN    2U
/* LPUART TX */
#define APP_DEBUG_CONSOLE_TX_PORT   PORT2
#define APP_DEBUG_CONSOLE_TX_PIN    3U

#define APP_ACTIVE_CFG_LDO_VOLTAGE_LEVEL kSPC_CoreLDO_OverDriveVoltage
