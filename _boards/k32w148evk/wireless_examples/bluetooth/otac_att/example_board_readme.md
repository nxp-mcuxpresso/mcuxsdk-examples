...
- To update the K32W (radio) image, select it by pressing the “**Browse**” button in the M3 group. Then navigate to the `.bin` file.
...
1. Flash the OTAP Client ATT to the K32W148-EVK platform. The Kinetis Bluetooth LE Toolbox only supports the ATT OTAP Client.
