...
################################################################################
    ...
    - The command log:
		...
		********************
		...
		Success. (Master Boot Image: C:/_DDM/projects/mcu-sdk-2.0-k4w/boards/k32w148evk/tfm_examples/tfm_secureboot/scripts/spt_workspace/bootable_images/tfm_secureboot.bin created.)
		...
		ifr generate-binary -d k32w1xx -c "configs\romcfg.json" -o "configs\romcfg.bin"
		...
		blhost -p COM14,115200 -- fuse-program 0x1F {{650d8097079ff27a3e8a2da14781b922fd8295b6c00bfa067f00e87f1a16b8b3}}
		Response status = 0 (0x0) Success.
		Response word 1 = 32 (0x20)
		### Burn fuse: CUST_PROD_OEMFW_ENC_SK[0:255] ###
		blhost -p COM14,115200 -- fuse-program 0x20 {{7aa7ef9813b3561257b8837dab26225301df3511217f2733c71dadcd447722d1}}
		Response status = 0 (0x0) Success.
		Response word 1 = 32 (0x20)
...
################################################################################
    ...
    - The command log: [ Log has N in device Life Cycle step as the LC is already changed)
		...
		*********************
		...
		"C:\nxp\MCUX_Provi_v6\bin\tools\spsdk\nxpdebugmbox.exe" -p 2.1 auth -b 0 -c debug_auth\debug_auth_cert.dc" -k "keys\debug_authentication_key_ECC_384.pem"
		  #   Interface   Id              Description
		------------------------------------------------------------------------------------------------
		  0   PyOCD       0SQ0QQVUCW1AE   NXP Semiconductors MCU-LINK on-board (r0C3) CMSIS-DAP V2.250
		  #   Interface   Id              Description
		------------------------------------------------------------------------------------------------
		  0   PyOCD       0SQ0QQVUCW1AE   NXP Semiconductors MCU-LINK on-board (r0C3) CMSIS-DAP V2.250
...
- Useful documentation:
    ...
    - The K32W1480 Reference Manual, security chapters.
