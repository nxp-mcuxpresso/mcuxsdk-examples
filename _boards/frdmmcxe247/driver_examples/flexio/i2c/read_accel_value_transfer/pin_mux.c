...
- options: {callFromInitBoot: 'true', coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: '105', peripheral: FLEXIO, signal: 'D, 4', pin_signal: PTA2/FTM3_CH0/LPI2C0_SDA/EWM_OUT_b/FXIO_D4/LPUART0_RX/ADC1_SE0}
  - {pin_num: '104', peripheral: FLEXIO, signal: 'D, 5', pin_signal: PTA3/FTM3_CH1/LPI2C0_SCL/EWM_IN/FXIO_D5/LPUART0_TX/ADC1_SE1}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitFLEXIOPins(void)
{
    ...
    /* PORTA2 (pin 105) is configured as FXIO_D4 */
    PORT_SetPinMux(PORTA, 2U, kPORT_MuxAlt5);

    /* PORTA3 (pin 104) is configured as FXIO_D5 */
    PORT_SetPinMux(PORTA, 3U, kPORT_MuxAlt5);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
