...
- options: {callFromInitBoot: 'true', coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: '54', peripheral: LPI2C1, signal: SCL, pin_signal: PTD9/LPI2C1_SCL/FXIO_D0/MII_RXD2/FTM1_CH5/QSPI_B_IO4}
  - {pin_num: '55', peripheral: LPI2C1, signal: SDA, pin_signal: PTD8/LPI2C1_SDA/MII_RXD3/FTM2_FLT2/FXIO_D1/FTM1_CH4/QSPI_B_IO5}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitI2CPins(void)
{
    ...
    PORT_SetPinMux(BOARD_INITI2CPINS_I2C1_SDA_PORT, BOARD_INITI2CPINS_I2C1_SDA_PIN, kPORT_MuxAlt2);

    /* PORTD9 (pin 54) is configured as LPI2C1_SCL */
    PORT_SetPinMux(BOARD_INITI2CPINS_I2C1_SCL_PORT, BOARD_INITI2CPINS_I2C1_SCL_PIN, kPORT_MuxAlt2);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
