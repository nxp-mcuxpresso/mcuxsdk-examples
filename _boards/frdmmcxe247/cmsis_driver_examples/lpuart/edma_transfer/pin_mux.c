...
- options: {callFromInitBoot: 'false', coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: '25', peripheral: n/a, signal: disabled, pin_signal: PTD17/FTM0_FLT2/LPUART2_RX/FTM5_FLT1}
  - {pin_num: '23', peripheral: n/a, signal: disabled, pin_signal: PTE12/FTM0_FLT3/LPUART2_TX/FTM5_FLT0}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void LPUART2_DeinitPins(void)
{
    ...
    /* PORTD17 (pin 25) is disabled */
    PORT_SetPinMux(PORTD, 17U, kPORT_PinDisabledOrAnalog);

    /* PORTE12 (pin 23) is disabled */
