...
void BOARD_InitHardware(void)
{
    ...
    TRGMUX_SetTriggerSource(TRGMUX, kTRGMUX_Lpit0, kTRGMUX_TriggerInput0, kTRGMUX_SourceFtm0ExtTrg);
    /* ADC0 Channel A trigger input source: LPITCH0  */
    TRGMUX_SetTriggerSource(TRGMUX, kTRGMUX_Adc0, kTRGMUX_TriggerInput0, kTRGMUX_SourceLpitCh0);
