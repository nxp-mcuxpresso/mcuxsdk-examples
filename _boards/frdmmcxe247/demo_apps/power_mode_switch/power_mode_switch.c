...
void APP_PowerModeSwitch(smc_power_state_t curPowerState, app_power_mode_t targetPowerMode)
{
    switch (targetPowerMode)
    {
        ...
        case kAPP_PowerModeStop:
            ...
            SMC_SetPowerModeStop(SMC, kSMC_PartialStop1); /* STOP1 mode. */
