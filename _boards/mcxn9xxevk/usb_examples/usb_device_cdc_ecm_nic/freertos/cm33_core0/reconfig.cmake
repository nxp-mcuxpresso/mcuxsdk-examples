...
mcux_add_include(
  ...
  INCLUDES
    "${board_root}/${board}/usb_examples/usb_device_cdc_ecm_nic/freertos"
...
mcux_add_source(
  BASE_PATH "${SdkRootDirPath}"
  SOURCES
    "${board_root}/${board}/usb_examples/usb_device_cdc_ecm_nic/freertos/hardware_init.c"
    "${board_root}/${board}/usb_examples/usb_device_cdc_ecm_nic/freertos/pin_mux.c"
    "${board_root}/${board}/usb_examples/usb_device_cdc_ecm_nic/freertos/pin_mux.h"
