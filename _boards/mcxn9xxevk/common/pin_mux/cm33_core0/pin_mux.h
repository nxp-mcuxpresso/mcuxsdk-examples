...
/* Symbols to be used with PORT driver */
#define BOARD_INITI3CPINS_SW4_PORT PORT1                /*!<@brief PORT peripheral base pointer */
#define BOARD_INITI3CPINS_SW4_PIN 11U                   /*!<@brief PORT pin number */
#define BOARD_INITI3CPINS_SW4_PIN_MASK (1U << 11U)      /*!<@brief PORT pin mask */
                                                        /* @} */
