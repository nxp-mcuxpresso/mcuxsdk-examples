...
Then change DAC value, and measure the voltage of DACA output pin(TP9).
Use a multimeter to measure the voltage of TP9, then you will get the voltage of DAC output.
