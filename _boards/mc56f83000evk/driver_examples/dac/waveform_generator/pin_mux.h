...
/*! @name GPIOC5 (number 27), J4[3]/DACA_O
  @{ */
#define BOARD_DACA_O_GPIO GPIOC          /*!<@brief GPIO device name: GPIOC */
#define BOARD_DACA_O_PIN 5U              /*!<@brief GPIOC pin index: 5 */
#define BOARD_DACA_O_PIN_MASK kGPIO_Pin5 /*!<@brief PORT pin mask */
                                         /* @} */
