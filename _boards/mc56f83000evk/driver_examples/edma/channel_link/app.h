...
#define DEMO_EDMA_CHANNEL_0_IRQn DMA0_IRQn

#define DEMO_EDMA_CHANNEL_1      kEDMA_Channel1
#define DEMO_EDMA_CHANNEL_1_IRQn DMA1_IRQn
#define DEMO_EDMA_CHANNEL_2      kEDMA_Channel2
