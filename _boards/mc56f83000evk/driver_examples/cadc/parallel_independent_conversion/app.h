...
#define DEMO_CADC_SAMPLE8_CHANNEL_NAME kCADC_SingleEndANB0_DiffANB0pANB1n
...
#define DEMO_CADC_SAMPLE8_CHANNEL_MODE kCADC_ANB0_1_FullyDifferential
...
#define DEMO_ADC_CC1_IRQn ADC12_CC1_IRQn
/*${macro:end}*/
