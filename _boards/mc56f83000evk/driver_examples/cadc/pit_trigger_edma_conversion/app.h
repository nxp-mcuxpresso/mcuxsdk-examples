...
#define DEMO_XBARA_USER_CHANNEL_OUTPUT kXBARA_OutputAdcaSync
#define DEMO_XBARA_BASEADDR            XBARA

#define DEMO_PIT_BASEADDR        PIT0
#define PIT_CLOCK_SOURCE         kPIT_CountBusClock       /* 100M bus clock */
#define PIT_CLOCK_SOURCE_DIVIDER kPIT_PrescalerDivBy32768 /* divide source by 32768*/
