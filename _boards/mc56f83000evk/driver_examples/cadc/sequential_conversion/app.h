...
#define DEMO_CADC_SAMPLE2_CHANNEL_NAME kCADC_SingleEndANB0_DiffANB0pANB1n
#define DEMO_CADC_SAMPLE3_CHANNEL_NAME kCADC_SingleEndANB2_DiffANB2pANB3n
...
#define DEMO_CADC_SAMPLE2_CHANNEL_MODE kCADC_ANB0_1_FullyDifferential
#define DEMO_CADC_SAMPLE3_CHANNEL_MODE kCADC_ANB2_3_FullyDifferential

#define DEMO_CLOCK_IP_NAME kCLOCK_CYCADC

#define DEMO_ADC_CC0_IRQn ADC12_CC0_IRQn
/*${macro:end}*/
