...
- pin_list:
  ...
  - {pin_num: '64', peripheral: TMRA, signal: 'IN, 2', pin_signal: GPIOG8/PWMB_0X/PWMA_0X/TA2/XB_OUT10}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    GPIO_PinSetPeripheralMode(BOARD_XBAR_OUT10_GPIO, BOARD_XBAR_OUT10_PIN_MASK, kGPIO_ModePeripheral);
