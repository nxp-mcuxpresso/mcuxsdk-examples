...
/*! @name GPIOG8 (number 64), J4[7]/XBAR_OUT10
  @{ */
#define BOARD_XBAR_OUT10_GPIO GPIOG          /*!<@brief GPIO device name: GPIOG */
#define BOARD_XBAR_OUT10_PIN 8U              /*!<@brief GPIOG pin index: 8 */
#define BOARD_XBAR_OUT10_PIN_MASK kGPIO_Pin8 /*!<@brief PORT pin mask */
                                             /* @} */
