...
- name: BOARD_InitPeripherals
  UUID: 063ba1a6-cb60-45b0-bae9-58961d24dbf7
...
#ifdef TMRB_COMP10_INIT
  TMRB->CHANNEL[0].COMP1 = TMRB_COMP10_INIT;
#else
  TMRB->CHANNEL[0].COMP1 = 0x0U;
#endif /*TMRB_COMP10_INIT*/
#ifdef TMRB_COMP20_INIT
  TMRB->CHANNEL[0].COMP2 = TMRB_COMP20_INIT;
#else
  TMRB->CHANNEL[0].COMP2 = 0x0U;
#endif /*TMRB_COMP20_INIT */
#ifdef TMRB_LOAD0_INIT
  TMRB->CHANNEL[0].LOAD = TMRB_LOAD0_INIT;
#else
  TMRB->CHANNEL[0].LOAD = 0x0U;
#endif /*TMRB_LOAD0_INIT */
#ifdef TMRB_CNTR0_INIT
  TMRB->CHANNEL[0].CNTR = TMRB_CNTR0_INIT;
#else
  TMRB->CHANNEL[0].CNTR = 0x0U;
#endif /*TMRB_CNTR0_INIT */
#ifdef TMRB_SCTRL0_INIT
  TMRB->CHANNEL[0].SCTRL = TMRB_SCTRL0_INIT;
#else
  TMRB->CHANNEL[0].SCTRL = 0x0U;
#endif /*TMRB_SCTRL0_INIT */
#ifdef TMRB_CMPLD10_INIT
  TMRB->CHANNEL[0].CMPLD1 = TMRB_CMPLD10_INIT;
#else
  TMRB->CHANNEL[0].CMPLD1 = 0x0U;
#endif /*TMRB_CMPLD10_INIT */
#ifdef TMRB_CMPLD20_INIT
  TMRB->CHANNEL[0].CMPLD2 = TMRB_CMPLD20_INIT;
#else
  TMRB->CHANNEL[0].CMPLD2 = 0x0U;
#endif /*TMRB_CMPLD20_INIT */
#ifdef TMRB_CSCTRL0_INIT
  TMRB->CHANNEL[0].CSCTRL = TMRB_CSCTRL0_INIT;
#else
  TMRB->CHANNEL[0].CSCTRL = 0x0U;
#endif /*TMRB_CSCTRL0_INIT */
#ifdef TMRB_DMA0_INIT
  TMRB->CHANNEL[0].DMA = TMRB_DMA0_INIT;
#else
  TMRB->CHANNEL[0].DMA = 0x0U;
#endif /*TMRB_DMA0_INIT */
#ifdef TMRB_CTRL0_INIT
  TMRB->CHANNEL[0].CTRL = TMRB_CTRL0_INIT;
#else
  TMRB->CHANNEL[0].CTRL = 0x0U;
#endif /*TMRB_CTRL0_INIT */
/****************************************************************************/
/* Quad timer global initialization */
/****************************************************************************/
  /* Input filters configuration */
#ifdef TMRB_FILT0_INIT
  TMRB->CHANNEL[0].FILT = TMRB_FILT0_INIT;
#else
  TMRB->CHANNEL[0].FILT = 0x0U;
#endif /*TMRB_FILT0_INIT */
#ifdef TMRB_FILT1_INIT
  TMRB->CHANNEL[1].FILT = TMRB_FILT1_INIT;
#else
  TMRB->CHANNEL[1].FILT = 0x0U;
#endif /*TMRB_FILT1_INIT */
#ifdef TMRB_FILT2_INIT
  TMRB->CHANNEL[2].FILT = TMRB_FILT2_INIT;
#else
  TMRB->CHANNEL[2].FILT = 0x0U;
#endif /*TMRB_FILT2_INIT */
#ifdef TMRB_FILT3_INIT
  TMRB->CHANNEL[3].FILT = TMRB_FILT3_INIT;
#else
  TMRB->CHANNEL[3].FILT = 0x0U;
#endif /*TMRB_FILT3_INIT */
  /* Synchronous start of all channels */
#if defined(TMRB_ENBL_INIT)
   TMRB->CHANNEL[0].ENBL = (TMRB->CHANNEL[0].ENBL & (~TMRB_ENBL_INIT_MASK)) | (TMRB_ENBL_INIT & TMRB_ENBL_INIT_MASK);
#endif /*TMRB_TMRB_ENBL_INIT */
}
    ...
    - generalConfig:
      ...
      - recorders:
        - 0:
          - recID:
            - enableCustomID: 'true'
            - customID: 'FreeMASTER_Recorder_FL'
          - nameRec: 'Fast Loop recorder'
          - recBuff:
            - customBuffer: 'false'
            - bufferAddress: ''
            - bufferExternDef: ''
...
FMSTR_REC_BUFF FreeMASTER_Recorder_FL = {
  .name = "Fast Loop recorder",
...
static void FreeMASTER_init(void) {
  ...
  FMSTR_RecorderCreate(0, &FreeMASTER_Recorder_FL);
}
