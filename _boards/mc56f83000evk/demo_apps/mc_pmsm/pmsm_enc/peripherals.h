...
#define GPIOF_INT_VECT_IRQN kGPIOF_VECTORn
/* INTC interrupt priority register (interrupt priority register/bitfield index). */
#define GPIOF_INT_VECT_IRQ GPIOF_IRQn
/* INTC interrupt handler identifier. */
#define GPIOF_INT_VECT_IRQHANDLER ivINT_GPIOF
...
/* PWMA_SM0TCTRL: PWAOT0=0, PWBOT1=0, TRGFRQ=0, OUT_TRIG_EN=16 */
...
/* PWMA_SM2TCTRL: PWAOT0=0, PWBOT1=0, TRGFRQ=0, OUT_TRIG_EN=0 */
...
/* Definition of peripheral ID */
#define TMRB_PERIPHERAL TMRB
/* Definition of the timer channel 0 clock source frequency. */
#define TMRB_CHANNEL_0_CLOCK_SOURCE 0UL
/* Definition of the timer enable mask for all channels. */
#define TMRB_ENBL_INIT_MASK TMR_ENBL_ENBL_MASK
/* TMRB_COMP10: COMPARISON_1=0 */
#define TMRB_COMP10_INIT 0x0U
/* TMRB_COMP20: COMPARISON_2=0 */
#define TMRB_COMP20_INIT 0x0U
/* TMRB_LOAD0: LOAD=0 */
#define TMRB_LOAD0_INIT 0x0U
/* TMRB_CNTR0: COUNTER=0 */
#define TMRB_CNTR0_INIT 0x0U
/* TMRB_CTRL0: CM=4, PCS=0, SCS=1, ONCE=0, LENGTH=1, DIR=0, COINIT=0, OUTMODE=0 */
#define TMRB_CTRL0_INIT 0x80A0U
/* TMRB_SCTRL0: TCFIE=0, TOFIE=0, IEFIE=0, IPS=0, CAPTURE_MODE=3, MSTR=0, EEOF=0, VAL=0, FORCE=0, OPS=0, OEN=0 */
#define TMRB_SCTRL0_INIT 0xC0U
/* TMRB_CMPLD10: COMPARATOR_LOAD_1=0 */
#define TMRB_CMPLD10_INIT 0x0U
/* TMRB_CMPLD20: COMPARATOR_LOAD_2=0 */
#define TMRB_CMPLD20_INIT 0x0U
/* TMRB_CSCTRL0: DBG_EN=0, FAULT=0, ALT_LOAD=0, ROC=0, TCI=1, TCF2EN=0, TCF1EN=0, CL2=0, CL1=0 */
#define TMRB_CSCTRL0_INIT 0x400U
/* TMRB_FILT0: FILT_CNT=0, FILT_PER=0 */
#define TMRB_FILT0_INIT 0x0U
/* TMRB_DMA0: CMPLD2DE=0, CMPLD1DE=0, IEFDE=0 */
#define TMRB_DMA0_INIT 0x0U
/* TMRB_ENBL: ENBL=1 */
#define TMRB_ENBL_INIT 0x1U
/* TMRB_FILT1: FILT_CNT=0, FILT_PER=0 */
#define TMRB_FILT1_INIT 0x0U
/* TMRB_FILT2: FILT_CNT=0, FILT_PER=0 */
#define TMRB_FILT2_INIT 0x0U
/* TMRB_FILT3: FILT_CNT=0, FILT_PER=0 */
#define TMRB_FILT3_INIT 0x0U
/* FreeMASTER_Recorder_FL's buffer size definition */
