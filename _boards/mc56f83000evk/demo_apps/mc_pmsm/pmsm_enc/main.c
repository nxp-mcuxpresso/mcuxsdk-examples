...
void GPIOF_INT_VECT_IRQHANDLER(void);
...
app_ver_t g_sAppIdFM = {
	"../boards/mc56f83000evk/mc_pmsm/pmsm_enc",                       /* User Path 1- the highest priority */
	"../../../boards/mc56f83000evk/demo_apps/mc_pmsm/pmsm_enc",       /* User Path 2 */
    "mc56f83000evk",    /* board id */
    "pmsm_enc", 	/* example id */
...
#pragma interrupt alignsp saveall
void GPIOF_INT_VECT_IRQHANDLER(void) {
	/* clear interrupt flags - SW5 GF15*/
	GPIO_PinClearEdgeDetectedStatusFlags(BOARD_INITPINS_SW2_GPIO, BOARD_INITPINS_SW2_PIN_MASK);
