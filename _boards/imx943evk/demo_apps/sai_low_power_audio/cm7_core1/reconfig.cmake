...
mcux_add_source(
    ...
    SOURCES ${board_root}/${board}/cm7_core1/app_srtm.c
            ${board_root}/${board}/cm7_core1/app_srtm.h
            ${board_root}/${board}/demo_apps/sai_low_power_audio/cm7_core1/rpmsg_config.h
            ...
            ${board_root}/${board}/demo_apps/sai_low_power_audio/cm7_core1/srtm_config.h
)
...
mcux_add_armgcc_linker_script(
        TARGETS debug release
        BASE_PATH ${SdkRootDirPath}
        LINKER ${board_root}/imx943evk/demo_apps/sai_low_power_audio/cm7_core1/linker/MIMX94398_cm7_core1_lpa_ram.ld
)

mcux_add_iar_linker_script(
        TARGETS debug release
        BASE_PATH ${SdkRootDirPath}
        LINKER ${board_root}/imx943evk/demo_apps/sai_low_power_audio/cm7_core1/linker/MIMX94398_cm7_core1_lpa_ram.icf
