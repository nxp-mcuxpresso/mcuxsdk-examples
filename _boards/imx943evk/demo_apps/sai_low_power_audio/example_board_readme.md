...
2.  Connect a USB Type-C cable between the host PC and the J15(FTDI_DEBUG) USB port on the target board.
3.  Open a serial terminal with the following settings:
    ...
    - One stop bit
    - No flow control
4.  Load flash.bin file with sm as rpmsg config before starting the demo to ensure that the permissions of Mcore involved in the demo are allowed.
...
6.  Boot Linux BSP to u-boot, and load M core image from SD card to run. (Put the image into SD card device before)
    ...
    6.2 Mcore run in CM7_CORE1
      load mmc 1:1 0x90400000 sai_low_power_audio_rtos_imx943_cm7_core1.bin; cp.b 0x90400000 0x202c0000 0x40000; bootaux 0x00000000 7;
******************
NOTE
******************
...
When recording sound by pdm hardware, could use command:
       arecord -Dhw:0,0 -c2 -r48000 -fS32_LE test.wav
4. you can use below command to run record and play at the same time by one wm8962 codec.
...
####################  LOW POWER AUDIO TASK ####################
    ...
    Build Time: Feb 6 2025--15:11:38
