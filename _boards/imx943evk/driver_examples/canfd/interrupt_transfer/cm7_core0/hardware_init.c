...
void BOARD_InitHardware(void)
{
    ...
    PCA6416A_SetDirection(&handle, (1 << BOARD_PCA6416A_CAN2_EN), kPCA6416A_Output);
    PCA6416A_SetDirection(&handle, (1 << BOARD_PCA6416A_CAN2_STBY_B), kPCA6416A_Output);

    /* Initialize TJA1463AT with normal mode */
    /* Clear CAN STBY_N and EN signal of TJA1463AT */
    PCA6416A_ClearPins(&handle, (1 << BOARD_PCA6416A_CAN2_STBY_B) | (1 << BOARD_PCA6416A_CAN2_EN));
    SDK_DelayAtLeastUs(100U, SystemCoreClock);

    /* Setup CAN EN and STBY_N signal of TJA1436AT */
    PCA6416A_SetPins(&handle, (1 << BOARD_PCA6416A_CAN2_STBY_B) | (1 << BOARD_PCA6416A_CAN2_EN));
}
/*${function:end}*/
