...
- J64-2(CANH) node A, J65-2(CANH) node B
- J64-3(CANL) node A, J65-3(CANL) node B

Prepare the Demo
================
1.  Connect 12V~20V power supply and JLink Plus to the board, switch SW11 to power on the board
2.  Connect a micro USB cable between the host PC and the J30 USB MICRO B port on the target board.
