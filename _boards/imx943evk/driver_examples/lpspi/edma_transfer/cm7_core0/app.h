...
#define EXAMPLE_LPSPI_MASTER_DMA_BASE (EDMA4_BASE)
#define EXAMPLE_LPSPI_MASTER_DMA_RX_CHANNEL 1U
#define EXAMPLE_LPSPI_MASTER_DMA_TX_CHANNEL 2U
#define EXAMPLE_LPSPI_MASTER_DMA_RX_REQ kDma4RequestMuxLpspi8Rx
#define EXAMPLE_LPSPI_MASTER_DMA_TX_REQ kDma4RequestMuxLpspi8Tx
...
#define EXAMPLE_LPSPI_SLAVE_DMA_BASE (EDMA2_BASE)
#define EXAMPLE_LPSPI_SLAVE_DMA_RX_CHANNEL 3U
#define EXAMPLE_LPSPI_SLAVE_DMA_TX_CHANNEL 4U
#define EXAMPLE_LPSPI_SLAVE_DMA_RX_REQ kDma2RequestMuxLpspi3Rx
#define EXAMPLE_LPSPI_SLAVE_DMA_TX_REQ kDma2RequestMuxLpspi3Tx
...
#define EXAMPLE_LPSPI_MASTER_CLOCK_FREQ                                        \
  CLOCK_GetRate(EXAMPLE_LPSPI_MASTER_CLK_ID)
#define EXAMPLE_LPSPI_SLAVE_CLOCK_FREQ                                         \
  CLOCK_GetRate(EXAMPLE_LPSPI_SLAVE_CLK_ID)
