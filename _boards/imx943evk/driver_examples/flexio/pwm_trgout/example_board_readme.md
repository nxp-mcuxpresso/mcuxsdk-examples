...
Board settings
============
Connect J43-12 to Oscilloscope or Logic Analyzer.
...
Running the demo
================
When the example runs successfully, if the input duty cycle range is 0~100, the trigger signal can be captured on OSC.
