...
#if 0
    /* Clock enable for GPIO1 */
    CLOCK_EnableClock(kCLOCK_Gpio1);
    /* GPIO1 pin 04, output mode */
    GPIO1->PDDR                     = GPIO_PDDR_PDD4(1);
#endif
...
#if 0
        /* GPIO1 pin 04, Set output value, go to "H", code performance measurement start pulse */
        GPIO1->PSOR                     = GPIO_PSOR_PTSO4(1);
#endif
        /* main calculation (FFT, scaling, averaging) */
        METERLIBFFT3PH_CalcMain(&ui); 
#if 0
        /* GPIO1 pin 04, Clear output value, go to "L", code performance measurement stop pulse */
        GPIO1->PCOR                     = GPIO_PCOR_PTCO4(1);
#endif
