...
void BOARD_InitPins(void)
{
    ...
    /* PORT4_15 is configured as ADC0_A1 */
    PORT_SetPinConfig(PORT4, 6U, &port4_23_pinU12_config);
    
    /* PORT4_16 is configured as ADC0_A2 */
    PORT_SetPinConfig(PORT4, 15U, &port4_23_pinU12_config);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
