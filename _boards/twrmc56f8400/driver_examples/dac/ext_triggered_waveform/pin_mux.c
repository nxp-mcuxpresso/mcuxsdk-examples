...
- pin_list:
  ...
  - {pin_num: '27', peripheral: DAC, signal: OUT, pin_signal: GPIOC5/DACO/XB_IN7}
  - {pin_num: '5', peripheral: XBARA, signal: 'IN, 2', pin_signal: GPIOC2/TXD0/TB0/XB_IN2/CLKO0}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    GPIO_PinSetPeripheralMode(BOARD_BUTTON_SW1_GPIO, BOARD_BUTTON_SW1_PIN_MASK, kGPIO_ModePeripheral);
    ...
    GPIO_PinSetPeripheralMux(kGPIO_Peri_C5_DACO);
