...
- pin_list:
  ...
  - {pin_num: '60', peripheral: I2C1, signal: SCL, pin_signal: GPIOF2/SCL1/XB_OUT6, open_drain: enable}
  - {pin_num: '61', peripheral: I2C1, signal: SDA, pin_signal: GPIOF3/SDA1/XB_OUT7, open_drain: enable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
