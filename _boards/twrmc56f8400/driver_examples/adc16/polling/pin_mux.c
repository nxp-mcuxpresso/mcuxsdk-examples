...
- pin_list:
  ...
  - {pin_num: '14', peripheral: SADC, signal: 'ANC, 17', pin_signal: GPIOA9/ANC17/CMPD_IN2}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    /* Enable peripheral functionality on pin GPIOA9 (pin 14) */
    GPIO_PinSetPeripheralMode(GPIOA, kGPIO_Pin9, kGPIO_ModePeripheral);
