...
#else
/* Without the X:flash support, the TSA tables go to RAM. We can afford some Active Content, but not all. */
...
#define FMSTR_CAN_DRV           FMSTR_CAN_MCUX_DSCFLEXCAN // Use DSC FlexCAN device

//! Define communication interface base address or leave undefined for runtime setting
// #undef FMSTR_CAN_BASE   // CAN base will be assigned in runtime
