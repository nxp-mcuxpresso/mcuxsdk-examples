...
##
##  5. To use .p_FlexRAM memory segment, when code are compiled in LDM mode, please uncheck below setting:
##     Project Properties -> C/C++ Build -> Settings -> Tool Settings -> DSC Compiler -> Processor -> Globals Live Lower Memory.
##
##  6. To use flexnvm.data section, when code are compiled in LDM mode, please uncheck below setting:
##     Project Properties -> C/C++ Build -> Settings -> Tool Settings -> DSC Compiler -> Processor -> Globals Live Lower Memory.
##
##    ***************************************************************
