...
void BOARD_BootClockFRO96M_InitClockModule(clock_module_t module)
{
    ...
    switch(module) {
        case kClockModule_CoreSupplyModes:
        ...
        case kClockModule_ROOT_AUX_CLK_SEL:
            ...
            /* !< Enable the ROOT_AUX_CLK clock for CGU */
            CLOCK_EnableClock(kCLOCK_GateAonRootAux);
            break;
...
void BOARD_BootClockFRO96M(void)
{
    ...
    BOARD_BootClockFRO96M_InitClockModule(kClockModule_CoreSupplyModes);
