...
void APP_SetTrdcGlobalConfig(void)
{
    ...
    *(volatile uint32_t *)0x4008E04C = 0x00000000;
    ...
    TRDC_MbcSetMemoryAccessConfig(EXAMPLE_TRDC_INSTANCE, &memAccessConfig, 0U,
                                  EXAMPLE_TRDC_MBC_ACCESS_CONTROL_POLICY_INDEX);
    ...
    TRDC_MbcSetMemoryAccessConfig(EXAMPLE_TRDC_INSTANCE, &memAccessConfig, 0U,
                                  EXAMPLE_TRDC_MBC_ACCESS_CONTROL_POLICY_INDEX_NO_ACCESS);
