...
#define DEMO_LPADC_TEMP_PARAMETER_A      TEMP_PARAMETER_A
#define DEMO_LPADC_TEMP_PARAMETER_B      TEMP_PARAMETER_B
#define DEMO_LPADC_TEMP_PARAMETER_ALPHA  TEMP_PARAMETER_ALPHA
