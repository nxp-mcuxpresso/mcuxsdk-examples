...
/* Array of function pointers for callback for each used channel */
ctimer_callback_t ctimer_callback_table[] = {ctimer_match0_callback, ctimer_match1_callback, NULL, NULL, NULL, NULL, NULL, NULL};
/*${prototype:end}*/
