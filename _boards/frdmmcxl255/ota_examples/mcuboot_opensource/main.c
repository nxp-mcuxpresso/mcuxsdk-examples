...
struct mbc_conf mbc_config_sbl[] =
{
    ...
    {.addr = 0x10000, .size = 0x28000, .glbac = MBC_GLBAC_RW}, /* app primary           R/W */
    {.addr = 0x38000, .size = 0x28000, .glbac = MBC_GLBAC_RW}, /* app secondary         R/W */
};
...
{
    {.addr = 0x0,     .size = 0x10000, .glbac = MBC_GLBAC_RX}, /* bootloader            R/X */
    {.addr = 0x10000, .size = 0x28000, .glbac = MBC_GLBAC_RX}, /* app primary           R/X */
    {.addr = 0x36000, .size = 0x2000,  .glbac = MBC_GLBAC_RW}, /* app primary trailer   R/W */
    {.addr = 0x38000, .size = 0x28000, .glbac = MBC_GLBAC_RW}, /* app secondary         R/W */
};
...
int main(void)
{
    ...
    /* IMPORTANT:
       ...
       MCX L255 uses MBC IP to control flash access.
       ...
       In case of MCX L255 the MBC uses 8kB blocks.

       See configuration of *mbc_config_sbl* and *mbc_config_app* structures for details.
