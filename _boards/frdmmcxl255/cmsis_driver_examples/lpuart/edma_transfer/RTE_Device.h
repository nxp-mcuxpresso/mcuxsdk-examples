...
extern void LPUART2_InitPins_deinit();
...
#define RTE_USART2_PIN_DEINIT      LPUART2_InitPins_deinit
#define RTE_USART2_DMA_TX_CH       0
#define RTE_USART2_DMA_TX_PERI_SEL (uint16_t) kDma0RequestLPUART2Tx
#define RTE_USART2_DMA_TX_DMA_BASE DMA0
#define RTE_USART2_DMA_RX_CH       1
#define RTE_USART2_DMA_RX_PERI_SEL (uint16_t) kDma0RequestLPUART2Rx
