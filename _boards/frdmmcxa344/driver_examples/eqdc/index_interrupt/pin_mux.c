...
- pin_list:
  ...
  - {pin_num: '48', peripheral: INPUTMUX0, signal: 'TRIG_IN, 10', pin_signal: P3_31/LPTMR0_ALT2/TRIG_IN10/LPI2C1_SDAS/CT0_MAT3/PWM1_B0/SMARTDMA_PIO31/ADC1_A20, slew_rate: fast,
    open_drain: disable, drive_strength: low, pull_select: down, pull_enable: disable, input_buffer: enable, invert_input: normal}
  - {pin_num: '21', peripheral: INPUTMUX0, signal: 'TRIG_IN, 5', pin_signal: P4_7/TRIG_IN5/LPUART3_RTS_B/CT_INP7/PWM0_B0/SMARTDMA_PIO27, slew_rate: fast, open_drain: disable,
...
void BOARD_InitPins(void)
{
    ...
    const port_pin_config_t port4_7_pin21_config = {/* Internal pull-up/down resistor is disabled */
                                                    ...
                                                    /* Pin Control Register fields [15:0] are not locked */
                                                    .lockRegister = kPORT_UnlockRegister};
    /* PORT4_7 (pin 21) is configured as TRIG_IN5 */
