...
- pin_list:
  ...
  - {pin_num: '57', peripheral: GPIO3, signal: 'GPIO, 18', pin_signal: P3_18/CT2_MAT0/PWM0_X0/PWM1_X0/SMARTDMA_PIO18, slew_rate: fast, open_drain: disable, drive_strength: low,
...
void BOARD_InitPins(void)
{
    ...
    const port_pin_config_t port3_18_pin57_config = {/* Internal pull-up/down resistor is disabled */
                                                     .pullSelect = kPORT_PullDisable,
                                                     /* Low internal pull resistor value is selected. */
                                                     .pullValueSelect = kPORT_LowPullResistor,
                                                     /* Fast slew rate is configured */
    ...
    PORT_SetPinConfig(PORT3, 18U, &port3_18_pin57_config);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
