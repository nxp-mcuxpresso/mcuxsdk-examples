...
CREATE_LIB_PROJECT_CMD = "ruby ethermind_example_btdm_lib_evkmimxrt685.rb"

IAR_PATH = 'C:\\Program Files\\IAR Systems\\Embedded Workbench 9.1\\common\\bin'
...
#Change LIBRARY_OUTPUT_PATH to "middleware/wireless/ethermind/bluetooth/private/lib/mcux/default/btdm/cm33/gcc" in armgcc "CMakeLists.txt" file.
def ChangeCMakelistOutputPath():
    ...
    expectedLibOutputPath = "LIBRARY_OUTPUT_PATH ${ProjDirPath}/${CMAKE_BUILD_TYPE}/../../../../../../../../middleware/wireless/ethermind/bluetooth/private/lib/mcux/default/btdm/cm33/gcc"
