...
CREATE_LIB_PROJECT_CMD = "ruby ethermind_example_br_only_evkmimxrt685.rb"

IAR_PATH = 'C:\\Program Files (x86)\\IAR Systems\\Embedded Workbench 8.4\\common\\bin'
...
#Change LIBRARY_OUTPUT_PATH to "middleware/wireless/ethermind/bluetooth/private/lib/mcux/default/br/cm33/gcc" in armgcc "CMakeLists.txt" file.
def ChangeCMakelistOutputPath():
    ...
    expectedLibOutputPath = "LIBRARY_OUTPUT_PATH ${ProjDirPath}/${CMAKE_BUILD_TYPE}/../../../../../../../../middleware/wireless/ethermind/bluetooth/private/lib/mcux/default/br/cm33/gcc"
