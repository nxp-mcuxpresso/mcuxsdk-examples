...
CREATE_LIB_PROJECT_CMD = "ruby ethermind_example_ble_only_evkmimxrt685.rb "
...
#Change LIBRARY_OUTPUT_PATH to "middleware/wireless/ethermind/bluetooth/private/lib/mcux/default/ble/cm33/gcc" in armgcc "CMakeLists.txt" file.
def ChangeCMakelistOutputPath():
    ...
    expectedLibOutputPath = "LIBRARY_OUTPUT_PATH ${ProjDirPath}/${CMAKE_BUILD_TYPE}/../../../../../../../../middleware/wireless/ethermind/bluetooth/private/lib/mcux/default/ble/cm33/gcc"
