...
mcux_add_source(
    ...
    SOURCES
        ...
        examples/_boards/${board}/wifi_examples/common/cm33/hardware_init.c
        examples/_boards/${board}/wifi_examples/common/cm33/app.h
)
mcux_add_include(
    BASE_PATH ${SdkRootDirPath}
    INCLUDES
        examples/_boards/${board}
        examples/_boards/${board}/wifi_examples/common/cm33
)
