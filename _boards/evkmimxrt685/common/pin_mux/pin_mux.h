...
/*! @name FLEXSPI0B_DATA4 (coord U1), U19[D5]
  @{ */
/* Routed pin properties */
#define BOARD_INITFLASHPINS_QSPI_B_DATA4_PERIPHERAL FLEXSPI       /*!<@brief Peripheral name */
#define BOARD_INITFLASHPINS_QSPI_B_DATA4_SIGNAL FLEXSPI_B_DATA4   /*!<@brief Signal name */
                                                                  /* @} */

/*! @name FLEXSPI0B_DATA5 (coord R2), U19[E3]
  @{ */
/* Routed pin properties */
#define BOARD_INITFLASHPINS_QSPI_B_DATA5_PERIPHERAL FLEXSPI       /*!<@brief Peripheral name */
#define BOARD_INITFLASHPINS_QSPI_B_DATA5_SIGNAL FLEXSPI_B_DATA5   /*!<@brief Signal name */
                                                                  /* @} */

/*! @name FLEXSPI0B_DATA6 (coord P3), U19[E2]
  @{ */
/* Routed pin properties */
#define BOARD_INITFLASHPINS_QSPI_B_DATA6_PERIPHERAL FLEXSPI       /*!<@brief Peripheral name */
#define BOARD_INITFLASHPINS_QSPI_B_DATA6_SIGNAL FLEXSPI_B_DATA6   /*!<@brief Signal name */
                                                                  /* @} */

/*! @name FLEXSPI0B_DATA7 (coord P5), U19[E1]
  @{ */
/* Routed pin properties */
#define BOARD_INITFLASHPINS_QSPI_B_DATA7_PERIPHERAL FLEXSPI       /*!<@brief Peripheral name */
#define BOARD_INITFLASHPINS_QSPI_B_DATA7_SIGNAL FLEXSPI_B_DATA7   /*!<@brief Signal name */
                                                                  /* @} */
