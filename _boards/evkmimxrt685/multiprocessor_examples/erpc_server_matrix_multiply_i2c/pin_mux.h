...
#define BOARD_INITPINS_GPIO_HANDSHAKE_PERIPHERAL GPIO
/*!
 * @brief Signal name */
#define BOARD_INITPINS_GPIO_HANDSHAKE_SIGNAL PIO1
/*!
 * @brief Signal channel */
#define BOARD_INITPINS_GPIO_HANDSHAKE_CHANNEL 16

/* Symbols to be used with GPIO driver */
/*!
 * @brief GPIO peripheral base pointer */
#define BOARD_INITPINS_GPIO_HANDSHAKE_GPIO GPIO
/*!
 * @brief GPIO pin mask */
#define BOARD_INITPINS_GPIO_HANDSHAKE_GPIO_PIN_MASK (1U << 16U)
/*!
 * @brief PORT peripheral base pointer */
#define BOARD_INITPINS_GPIO_HANDSHAKE_PORT 1U
/*!
 * @brief PORT pin number */
#define BOARD_INITPINS_GPIO_HANDSHAKE_PIN 16U
/*!
 * @brief PORT pin mask */
#define BOARD_INITPINS_GPIO_HANDSHAKE_PIN_MASK (1U << 16U)
/* @} */
