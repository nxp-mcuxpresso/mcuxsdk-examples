...
- pin_list:
  ...
  - {pin_num: '9', peripheral: SPDIF, signal: spdif_in, pin_signal: GPIO_04, software_input_on: Disable, open_drain: Disable}
  - {pin_num: '8', peripheral: SPDIF, signal: spdif_out, pin_signal: GPIO_05, software_input_on: Disable, open_drain: Disable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
void BOARD_InitPins(void) {
  ...
  IOMUXC_SetPinMux(IOMUXC_GPIO_04_SPDIF_IN, 0U); 
  IOMUXC_SetPinMux(IOMUXC_GPIO_05_SPDIF_OUT, 0U); 
  IOMUXC_SetPinMux(IOMUXC_GPIO_09_LPUART1_RXD, 0U); 
  IOMUXC_SetPinMux(IOMUXC_GPIO_10_LPUART1_TXD, 0U); 
  IOMUXC_SetPinConfig(IOMUXC_GPIO_04_SPDIF_IN, 0x10A0U); 
  IOMUXC_SetPinConfig(IOMUXC_GPIO_05_SPDIF_OUT, 0x10A0U); 
