...
mcux_add_include(
  BASE_PATH "${SdkRootDirPath}"
  INCLUDES "middleware/usb/example/boards/${board}/usb_device_composite_hid_audio_unified_lite/bm"
)
...
mcux_add_source(
  BASE_PATH "${SdkRootDirPath}"
  SOURCES
    "middleware/usb/example/boards/${board}/usb_device_composite_hid_audio_unified_lite/bm/app.h"
    "middleware/usb/example/boards/${board}/usb_device_composite_hid_audio_unified_lite/bm/hardware_init.c"
    "middleware/usb/example/boards/${board}/usb_device_composite_hid_audio_unified_lite/bm/pin_mux.c"
    "middleware/usb/example/boards/${board}/usb_device_composite_hid_audio_unified_lite/bm/pin_mux.h"
    "middleware/usb/example/boards/${board}/usb_device_composite_hid_audio_unified_lite/bm/usb_audio_config.h"
)
