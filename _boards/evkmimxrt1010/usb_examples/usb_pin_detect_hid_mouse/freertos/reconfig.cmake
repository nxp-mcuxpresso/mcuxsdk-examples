...
mcux_add_include(
  BASE_PATH "${SdkRootDirPath}"
  INCLUDES "middleware/usb/example/boards/${board}/usb_pin_detect_hid_mouse/freertos"
)
...
mcux_add_source(
  BASE_PATH "${SdkRootDirPath}"
  SOURCES
    "middleware/usb/example/boards/${board}/usb_pin_detect_hid_mouse/freertos/hardware_init.c"
    "middleware/usb/example/boards/${board}/usb_pin_detect_hid_mouse/freertos/pin_mux.c"
    "middleware/usb/example/boards/${board}/usb_pin_detect_hid_mouse/freertos/pin_mux.h"
)
