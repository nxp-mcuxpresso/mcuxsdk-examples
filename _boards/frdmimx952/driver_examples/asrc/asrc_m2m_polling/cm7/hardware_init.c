...
wm8962_config_t wm8962Config = {
    ...
    .bus          = kWM8962_BusI2S,
    .format       = {.sampleRate = kWM8962_AudioSampleRate32KHz, .bitWidth = kWM8962_AudioBitWidth16bit},
    .fllClock =
        {
            .fllClockSource        = kWM8962_FLLClkSourceMCLK,
            .fllReferenceClockFreq = 24576000U,
            .fllOutputFreq         = 24576000U,
        },
...
void BOARD_InitHardware(void)
{
    ...
    clk_t saiCLKCfg = {
        ...
        .rate = 24576000UL, // output 24576000 Hz
        //.enable_clk = true,
        .clkRoundOpt = SCMI_CLOCK_ROUND_AUTO,
    };
    ...
    clk_t asrcCLKCfg = {
        .clkId = kCLOCK_asrc1,
        .pclkId = kCLOCK_audiopll1, // select audiopll1out source(393216000 Hz)
        .rate = 196608000, // output 196608000 Hz
        //.enable_clk = true,
        .clkRoundOpt = SCMI_CLOCK_ROUND_AUTO,
    };
    ...
    CLOCK_SetParent(&asrcCLKCfg);
    CLOCK_SetRate(&asrcCLKCfg);
    CLOCK_EnableClock(asrcCLKCfg.clkId);
