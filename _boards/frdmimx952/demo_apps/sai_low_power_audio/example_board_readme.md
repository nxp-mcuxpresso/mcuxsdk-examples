...
3.  Open a serial terminal with the following settings:
    ...
    - One stop bit
    - No flow control
4.  Load flash.bin file with sm rpmsg config before starting the demo to ensure that the permissions of M7 involved in the demo are allowed.
4.  Make sure the FDT file and key bootargs are correctly set before booting the linux kernel. Following is the example commands on A core U-Boot console:
    =>setenv fdtfile imx952-evk-rpmsg.dtb
...
5.  Boot Linux BSP to u-boot, and load M core image from SD card to run. (Put the image into SD card device before)
    load mmc 1:1 0x90400000 imx952-19x19-evk_m7_TCM_sai_low_power_audio.bin; cp.b 0x90400000 0x203c0000 0x40000; bootaux 0x00000000 1;
******************
NOTE
******************
