...
void BOARD_InitHardware(void)
{
    ...
    registerValue = FXLS8974CF_CONFIG4_PP_OD_OPEN_DRAIN << FXLS8974CF_CONFIG4_PP_OD_POS;
    BOARD_I2cWriteFunc(FXLS8974CF_I2C_ADDR, FXLS8974CF_CONFIG4_REG_ADDR, &registerValue, sizeof(registerValue));
    registerValue = FXPQ3115BVT1_CTRL_REG3_PP_OD_OPEN_DRAIN << FXPQ3115BVT1_CTRL_REG3_PP_OD_POS;
    BOARD_I2cWriteFunc(FXPQ3115BVT1_I2C_ADDR, FXPQ3115BVT1_CTRL_REG3_ADDR, &registerValue, sizeof(registerValue));
}
/*${function:end}*/
