...
- pin_list:
  ...
  - {pin_num: '63', peripheral: GPIOJ, signal: 'GPIO, 4', pin_signal: PTJ4/LPUART0_CTS_b, direction: OUTPUT, gpio_init_state: 'true', slew_rate: slow, open_drain: disable,
    pull_select: down, pull_enable: disable}
...
- options: {callFromInitBoot: 'false', prefix: BOARD_, coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: '85', peripheral: OSC, signal: XTAL, pin_signal: XTAL0/PTE3/EWM_OUT_b/AFE_CLK/I2C1_SCL, slew_rate: no_init, open_drain: no_init, pull_select: no_init,
    pull_enable: no_init, digital_filter: no_init}
  - {pin_num: '84', peripheral: OSC, signal: EXTAL, pin_signal: EXTAL0/PTE2/EWM_IN/XBAR_IN6/I2C1_SDA, slew_rate: no_init, open_drain: no_init, pull_select: no_init,
    pull_enable: no_init, digital_filter: no_init}
...
void BOARD_InitINFRA_REDPins(void)
{
    ...
    SIM->MISC_CTL = ((SIM->MISC_CTL &
                     ...
                     | SIM_MISC_CTL_UARTMODTYPE(MISC_CTL_UARTMODTYPE_TypeB)
                     ...
                     | SIM_MISC_CTL_UART0IRSEL(MISC_CTL_UART0IRSEL_IRDA));
...
- pin_list:
  ...
  - {pin_num: '24', peripheral: LCD, signal: 'P, 36', pin_signal: LCD_P36/PTB5, slew_rate: fast, open_drain: disable, pull_select: down, pull_enable: disable}
  - {pin_num: '22', peripheral: LCD, signal: 'P, 34', pin_signal: LCD_P34/PTB3, slew_rate: fast, open_drain: disable, pull_select: down, pull_enable: disable}
  ...
  - {pin_num: '23', peripheral: LCD, signal: 'P, 35', pin_signal: LCD_P35/PTB4, slew_rate: fast, open_drain: disable, pull_select: down, pull_enable: disable}
  - {pin_num: '21', peripheral: LCD, signal: 'P, 33', pin_signal: LCD_P33/PTB2, slew_rate: fast, open_drain: disable, pull_select: down, pull_enable: disable}
  ...
  - {pin_num: '122', peripheral: LCD, signal: 'P, 19', pin_signal: LCD_P19/PTH4, slew_rate: fast, open_drain: disable, pull_select: down, pull_enable: disable}
  ...
  - {pin_num: '123', peripheral: LCD, signal: 'P, 20', pin_signal: LCD_P20/PTH5, slew_rate: fast, open_drain: disable, pull_select: down, pull_enable: disable}
  - {pin_num: '117', peripheral: LCD, signal: 'P, 14', pin_signal: LCD_P14/PTG7, slew_rate: fast, open_drain: disable, pull_select: down, pull_enable: disable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
