...
#define DEMO_LCD_RST_PIN  3U
#define DEMO_LCD_CS_GPIO  GPIO3
#define DEMO_LCD_CS_PIN   16U
#define DEMO_LCD_RS_GPIO  GPIO4
#define DEMO_LCD_RS_PIN   1U
...
#define DEMO_FLEXIO_WR_PIN           7U
#define DEMO_FLEXIO_RD_PIN           8U
