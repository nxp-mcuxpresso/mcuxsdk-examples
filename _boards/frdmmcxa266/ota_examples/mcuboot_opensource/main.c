...
{
    {.addr = 0x0,     .size = 0x0C000, .glbac = MBC_GLBAC_RX}, /* bootloader            R/X */
    {.addr = 0x0C000, .size = 0x72000, .glbac = MBC_GLBAC_RW}, /* app primary           R/W */
    {.addr = 0x7E000, .size = 0x72000, .glbac = MBC_GLBAC_RW}, /* app secondary         R/W */
    //{.addr = 0xF0000, .size = 0x10000, .glbac = MBC_GLBAC_RX}, /* SI+CMPA (reserved)  R/X */
};
...
{
    {.addr = 0x0,     .size = 0x0C000, .glbac = MBC_GLBAC_RX}, /* bootloader            R/X */
    {.addr = 0x0C000, .size = 0x70000, .glbac = MBC_GLBAC_RX}, /* app primary           R/X */
    {.addr = 0x7C000, .size = 0x02000, .glbac = MBC_GLBAC_RW}, /* app primary trailer   R/W */
    {.addr = 0x7E000, .size = 0x70000, .glbac = MBC_GLBAC_RW}, /* app secondary         R/W */
    //{.addr = 0xF0000, .size = 0x10000, .glbac = MBC_GLBAC_RX}, /* SI+CMPA (reserved)  R/X */
};
...
int main(void)
{
    ...
    /* IMPORTANT:
       ...
       Sector   0  -   5;  Bootloader   ;  R/X
       Sector   6  -  62;  App Primary  ;  R/W before boot; R/X after boot
       Sector  63  - 119;  App Secondary;  R/W
       Sector 120  - 126;  Secure installer (reserved)
       Sector 127       ;  CMPA (reserved)

       In case of MCX A266 the MBC uses 8kB blocks.
