...
- pin_list:
  ...
  - {pin_num: '23', peripheral: SAI3, signal: sai_tx_data, pin_signal: GPIO_SD_B1_08, software_input_on: Disable}
  - {pin_num: '24', peripheral: SAI3, signal: sai_tx_sync, pin_signal: GPIO_SD_B1_07, software_input_on: Enable, open_drain: Disable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
