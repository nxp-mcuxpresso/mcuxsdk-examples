...
board: FRDM-K32L2A4S
pin_labels:
- {pin_num: '85', pin_signal: PTC13/LPI2C1_SDAS/TPM1_CLKIN, label: 'J1[16]/D7', identifier: WIFI_RST}
...
- pin_list:
  ...
  - {pin_num: '85', peripheral: GPIOC, signal: 'GPIO, 13', pin_signal: PTC13/LPI2C1_SDAS/TPM1_CLKIN, direction: OUTPUT}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    GPIO_PinInit(BOARD_WIFI_RST_GPIO, BOARD_WIFI_RST_PIN, &WIFI_RST_config);
    ...
    PORT_SetPinMux(BOARD_WIFI_RST_PORT, BOARD_WIFI_RST_PIN, kPORT_MuxAsGpio);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
