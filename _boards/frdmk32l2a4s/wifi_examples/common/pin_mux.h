...
/*! @name PORTC13 (number 85), J1[16]/D7
  @{ */

/* Symbols to be used with GPIO driver */
#define BOARD_WIFI_RST_GPIO GPIOC                /*!<@brief GPIO peripheral base pointer */
#define BOARD_WIFI_RST_GPIO_PIN_MASK (1U << 13U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_WIFI_RST_PORT PORTC                /*!<@brief PORT peripheral base pointer */
#define BOARD_WIFI_RST_PIN 13U                   /*!<@brief PORT pin number */
#define BOARD_WIFI_RST_PIN_MASK (1U << 13U)      /*!<@brief PORT pin mask */
                                                 /* @} */
