...
void LPSPI1_InitPins(void)
{
    ...
    /* PORTD4 (pin 97) is configured as LPSPI1_PCS0 */
    PORT_SetPinMux(PORTD, 4U, kPORT_MuxAlt2);

    /* PORTD5 (pin 98) is configured as LPSPI1_SCK */
    PORT_SetPinMux(PORTD, 5U, kPORT_MuxAlt2);

    /* PORTD6 (pin 99) is configured as LPSPI1_SOUT */
    PORT_SetPinMux(PORTD, 6U, kPORT_MuxAlt2);

    /* PORTD7 (pin 100) is configured as LPSPI1_SIN */
