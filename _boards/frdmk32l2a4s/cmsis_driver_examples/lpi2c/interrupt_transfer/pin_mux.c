...
- options: {coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: '42', peripheral: n/a, signal: disabled, pin_signal: PTA12/TPM1_CH0/LPI2C2_SCL}
  - {pin_num: '43', peripheral: n/a, signal: disabled, pin_signal: PTA13/LLWU_P4/TPM1_CH1/LPI2C2_SDA}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void LPI2C2_DeinitPins(void)
{
    ...
    /* PORTA12 (pin 42) is disabled */
    PORT_SetPinMux(PORTA, 12U, kPORT_PinDisabledOrAnalog);

    /* PORTA13 (pin 43) is disabled */
