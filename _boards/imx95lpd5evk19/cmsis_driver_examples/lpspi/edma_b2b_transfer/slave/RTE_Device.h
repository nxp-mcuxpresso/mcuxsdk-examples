...
#define RTE_SPI1_DMA_TX_CH              Dma3RequestMuxLPSPI1Tx
#define RTE_SPI1_DMA_TX_PERI_SEL        (uint8_t) Dma3RequestMuxLPSPI1Tx
#define RTE_SPI1_DMA_TX_DMA_BASE        DMA3
#define RTE_SPI1_DMA_RX_CH              Dma3RequestMuxLPSPI1Rx
#define RTE_SPI1_DMA_RX_PERI_SEL        (uint8_t) Dma3RequestMuxLPSPI1Rx
#define RTE_SPI1_DMA_RX_DMA_BASE        DMA3
