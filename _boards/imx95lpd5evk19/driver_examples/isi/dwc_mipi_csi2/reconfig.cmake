  ...
  if(CONFIG_TOOLCHAIN STREQUAL "armgcc")
    ...
    mcux_add_custom_command(
      ...
      BUILD_COMMAND ${CMAKE_COMMAND}
        ...
        -P ${SdkRootDirPath}/${board_root}/imx95lpd5evk19/driver_examples/isi/dwc_mipi_csi2/ap1302_embed_objcopy.cmake
    )
  ...
  elseif(CONFIG_TOOLCHAIN STREQUAL "iar")
    ...
    mcux_add_custom_command(
      ...
      BUILD_COMMAND ${CMAKE_COMMAND}
        ...
        -P ${SdkRootDirPath}/${board_root}/imx95lpd5evk19/driver_examples/isi/dwc_mipi_csi2/ap1302_bin2iar_s.cmake
    )
