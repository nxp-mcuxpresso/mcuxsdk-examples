...
#define DSP_IMAGE_RESET_SIZE \
    (uint32_t) __section_end("__dsp_reset_section") - (uint32_t)__section_begin("__dsp_reset_section");
...
extern const char dsp_reset_image_start[];
extern unsigned int dsp_reset_image_size;
extern const char dsp_text_image_start[];
extern unsigned int dsp_text_image_size;
extern const char dsp_data_image_start[];
extern unsigned int dsp_data_image_size;
#define DSP_IMAGE_RESET_START ((uint32_t *)dsp_reset_image_start)
#define DSP_IMAGE_RESET_SIZE  ((uint32_t)dsp_reset_image_size)
#define DSP_IMAGE_TEXT_START  ((uint32_t *)dsp_text_image_start)
