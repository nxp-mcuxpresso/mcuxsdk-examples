...
#define GPIOE_INT_VECT_IRQN kGPIOE_VECTORn
/* INTC interrupt priority register (interrupt priority register/bitfield index). */
#define GPIOE_INT_VECT_IRQ GPIOE_IRQn
/* INTC interrupt handler identifier. */
#define GPIOE_INT_VECT_IRQHANDLER ivINT_GPIOE
...
/* PIT0_CTRL: SLAVE=0, CLKSEL=0, PRESET_POLARITY=0, PRESCALER=9, PRIE=1, CNT_EN=1 */
#define PIT0_CTRL_INIT 0x4BU
/* PIT0_MOD_L: MODULO_VALUE=195 */
#define PIT0_MOD_L_INIT 0xC3U
/* PIT0_MOD_H: MODULO_VALUE=0 */
#define PIT0_MOD_H_INIT 0x0U
/* PIT0_FILT: PRSC=0, CS=0, CNT=0, PER=1 */
#define PIT0_FILT_INIT 0x1U
/* PIT0_CTRL2: SYNC_OUT_SEL=0, STRETCH_COUNT=0 */
#define PIT0_CTRL2_INIT 0x0U
...
/* CMPC_CR0: FILTER_CNT=1, HYSTCTR=0 */
#define CMPC_CR0_INIT 0x10U
/* CMPC_CR1: SE=0, WE=0, PMODE=1, INV=0, COS=0, OPE=0, EN=1 */
#define CMPC_CR1_INIT 0x11U
/* CMPC_FPR: FILT_PER=1 */
#define CMPC_FPR_INIT 0x1U
/* CMPC_SCR: DMAEN=0, IER=0, IEF=0 */
#define CMPC_SCR_INIT 0x0U
/* CMPC_DACCR: VOSEL=191 */
#define CMPC_DACCR_INIT 0xBFU
/* CMPC_MUXCR: DACEN=1, VRSEL=0, PSEL=3, MSEL=7 */
#define CMPC_MUXCR_INIT 0x9FU
...
/* ADC_CTRL2: DMAEN1=0, STOP1=0, START1=0, SYNC1=1, CHNCFG_H=0, SIMULT=1, DIV0=7 */
#define ADC_CTRL2_INIT 0x1047U
...
/* ADC_CLIST1: SAMPLE3=3, SAMPLE2=1, SAMPLE1=2, SAMPLE0=0 */
#define ADC_CLIST1_INIT 0x3120U
/* ADC_CLIST2: SAMPLE7=7, SAMPLE6=6, SAMPLE5=5, SAMPLE4=4 */
#define ADC_CLIST2_INIT 0x7654U
/* ADC_CLIST3: SAMPLE11=11, SAMPLE10=10, SAMPLE9=11, SAMPLE8=8 */
#define ADC_CLIST3_INIT 0xBAB8U
...
/* ADC_EXPCFG: MUXSCTR4B=0, MUXSCTR4A=0, MUXBRST=0, MUXARST=0, MUXBIE=0, MUXAIE=0 */
#define ADC_EXPCFG_INIT 0x0U
/* ADC_EXPAUX4A: AUXSEL7=0, AUXSEL6=0, AUXSEL5=0, AUXSEL4=0, AUXSEL3=0, AUXSEL2=0, AUXSEL1=0, AUXSEL0=0 */
#define ADC_EXPAUX4A_INIT 0x0U
/* ADC_EXPAUX4B: AUXSEL7=0, AUXSEL6=0, AUXSEL5=0, AUXSEL4=0, AUXSEL3=0, AUXSEL2=0, AUXSEL1=0, AUXSEL0=0 */
#define ADC_EXPAUX4B_INIT 0x0U
/* ADC_EXPMUX4A0: MSDIS3=0, MUXSEL3=0, MSDIS2=0, MUXSEL2=0, MSDIS1=0, MUXSEL1=0, MSDIS0=0, MUXSEL0=0 */
#define ADC_EXPMUX4A0_INIT 0x0U
/* ADC_EXPMUX4A1: MSDIS7=0, MUXSEL7=0, MSDIS6=0, MUXSEL6=0, MSDIS5=0, MUXSEL5=0, MSDIS4=0, MUXSEL4=0 */
#define ADC_EXPMUX4A1_INIT 0x0U
/* ADC_EXPMUX4B0: MSDIS3=0, MUXSEL3=0, MSDIS2=0, MUXSEL2=0, MSDIS1=0, MUXSEL1=0, MSDIS0=0, MUXSEL0=0 */
#define ADC_EXPMUX4B0_INIT 0x0U
/* ADC_EXPMUX4B1: MSDIS7=0, MUXSEL7=0, MSDIS6=0, MUXSEL6=0, MSDIS5=0, MUXSEL5=0, MSDIS4=0, MUXSEL4=0 */
#define ADC_EXPMUX4B1_INIT 0x0U
/* Definition of peripheral ID */
...
/* PWMA_SM0STS: REF=0, RF=0, CFX1=0, CFX0=0, CMPF=0 */
#define PWMA_SM0STS_INIT 0x0U
/* PWMA_SM0INTEN: REIE=0, RIE=0, CX1IE=0, CX0IE=0, CMPIE=0 */
#define PWMA_SM0INTEN_INIT 0x0U
/* PWMA_SM0TCTRL: TRGFRQ=0, OUT_TRIG_EN=16 */
...
/* PWMA_SM1STS: REF=0, RF=0, CFX1=0, CFX0=0, CMPF=0 */
#define PWMA_SM1STS_INIT 0x0U
/* PWMA_SM1INTEN: REIE=0, RIE=0, CX1IE=0, CX0IE=0, CMPIE=0 */
#define PWMA_SM1INTEN_INIT 0x0U
/* PWMA_SM1TCTRL: TRGFRQ=0, OUT_TRIG_EN=0 */
...
/* PWMA_SM2STS: REF=0, RF=0, CFX1=0, CFX0=0, CMPF=0 */
#define PWMA_SM2STS_INIT 0x0U
/* PWMA_SM2INTEN: REIE=0, RIE=0, CX1IE=0, CX0IE=0, CMPIE=0 */
#define PWMA_SM2INTEN_INIT 0x0U
/* PWMA_SM2TCTRL: TRGFRQ=0, OUT_TRIG_EN=0 */
...
/* PWMA_MCTRL: IPOL=0, RUN=0, LDOK=7 */
#define PWMA_MCTRL_INIT 0x7U
/* PWMA_MCTRL2: STRETCH_CNT_PRSC=0, MONPLL=0 */
...
/* PWMA_FFILT0: GSTR=0, FILT_CNT=7, FILT_PER=20 */
#define PWMA_FFILT0_INIT 0x714U
/* PWMA_FTST0: FTEST=0 */
...
extern qsci_config_t FreeMASTER_serial_config;
