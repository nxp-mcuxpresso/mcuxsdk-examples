...
SECTIONS {
  ...
  .RamCode : AT(_RamCode_storage_start_addr)
  {
	...
	# OBJECT(FivINT_ADC_CC0, main_c.obj) # compatible with codewarrior GUI build
	# OBJECT(FMCS_PMSMFocCtrl, pmsm_control_c.obj) # compatible with codewarrior GUI build
	# OBJECT(FM1_StateRunFast, m1_sm_snsless_c.obj) # compatible with codewarrior GUI build
