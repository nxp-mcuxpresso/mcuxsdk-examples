...
##
##  4. To use .x_FlashData memory segment, since MC56F80xxx flash mapping address in x space is 0x4000-0xBFFF(word address).
##     - SDM is supported by default when data allocation only range in x space address 0x4000-0x7FFF.
##     - SDM is supported when compiler supports __has_feature(FE_POINTER_MODIFIERS) for case that data allocation range
##       in x space address 0x8000-0xBFFF.
##
##    ***************************************************************
