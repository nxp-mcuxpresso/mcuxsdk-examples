...
- pin_list:
  ...
  - {pin_num: '12', peripheral: ADC, signal: 'ANA, 40', pin_signal: GPIOA4/ANA40/CMPA_IN4}
  - {pin_num: '11', peripheral: ADC, signal: 'ANA, 5', pin_signal: GPIOA5/ANA5/CMPB_IN4}
  ...
  - {pin_num: '21', peripheral: ADC, signal: 'ANB, 40', pin_signal: GPIOB4/ANB40/CMPC_IN1}
