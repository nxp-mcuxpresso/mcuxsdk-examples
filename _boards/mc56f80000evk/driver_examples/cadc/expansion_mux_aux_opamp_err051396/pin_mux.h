...
/*! @name GPIOA1 (number 14), J15[1]/J20[2]/OPA_P
  @{ */
#define BOARD_OPA_P_GPIO GPIOA          /*!<@brief GPIO device name: GPIOA */
#define BOARD_OPA_P_PIN 1U              /*!<@brief GPIOA pin index: 1 */
#define BOARD_OPA_P_PIN_MASK kGPIO_Pin1 /*!<@brief PORT pin mask */
                                        /* @} */

/*! @name GPIOC4 (number 8), J1[10]/J16[2]/J23[2]/OPA_OUT
  @{ */
#define BOARD_OPA_OUT_GPIO GPIOC          /*!<@brief GPIO device name: GPIOC */
#define BOARD_OPA_OUT_PIN 4U              /*!<@brief GPIOC pin index: 4 */
#define BOARD_OPA_OUT_PIN_MASK kGPIO_Pin4 /*!<@brief PORT pin mask */
                                          /* @} */
/*! @name GPIOF0 (number 36), OPB_OUT
  @{ */
#define BOARD_OPB_OUT_GPIO GPIOF          /*!<@brief GPIO device name: GPIOF */
#define BOARD_OPB_OUT_PIN 0U              /*!<@brief GPIOF pin index: 0 */
#define BOARD_OPB_OUT_PIN_MASK kGPIO_Pin0 /*!<@brief PORT pin mask */
                                          /* @} */
