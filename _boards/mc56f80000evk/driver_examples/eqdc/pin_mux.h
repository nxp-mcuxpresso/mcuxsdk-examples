...
/*! @name GPIOF1 (number 50), J3[1]/ENC_B
  @{ */
#define BOARD_ENC_B_GPIO GPIOF          /*!<@brief GPIO device name: GPIOF */
#define BOARD_ENC_B_PIN 1U              /*!<@brief GPIOF pin index: 1 */
#define BOARD_ENC_B_PIN_MASK kGPIO_Pin1 /*!<@brief PORT pin mask */
                                        /* @} */
