...
/*! @name GPIOB1 (number 25), OPB_P
  @{ */
#define BOARD_OPB_P_GPIO GPIOB          /*!<@brief GPIO device name: GPIOB */
#define BOARD_OPB_P_PIN 1U              /*!<@brief GPIOB pin index: 1 */
#define BOARD_OPB_P_PIN_MASK kGPIO_Pin1 /*!<@brief PORT pin mask */
                                        /* @} */
