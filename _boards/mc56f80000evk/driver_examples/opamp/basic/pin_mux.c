...
- pin_list:
  ...
  - {pin_num: '25', peripheral: OPAMPB, signal: 'IN, 0', pin_signal: GPIOB1/ANB1/CMPB_IN0/OPAMPB_IN0}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    GPIO_PinSetPeripheralMode(BOARD_OPB_P_GPIO, BOARD_OPB_P_PIN_MASK, kGPIO_ModePeripheral);
