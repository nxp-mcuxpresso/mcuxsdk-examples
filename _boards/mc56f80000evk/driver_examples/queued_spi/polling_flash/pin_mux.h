...
/*! @name GPIOC7 (number 32), J1[14]/U13[1]/SS0
  @{ */
#define BOARD_MISO_GPIO GPIOC          /*!<@brief GPIO device name: GPIOC */
#define BOARD_MISO_PIN 12U              /*!<@brief GPIOC pin index: 7 */
#define BOARD_MISO_PIN_MASK kGPIO_Pin12 /*!<@brief PORT pin mask */
                                      /* @} */

/*! @name GPIOC7 (number 32), J1[14]/U13[1]/SS0
  @{ */
#define BOARD_MOSI_GPIO GPIOC          /*!<@brief GPIO device name: GPIOC */
#define BOARD_MOSI_PIN 11U              /*!<@brief GPIOC pin index: 7 */
#define BOARD_MOSI_PIN_MASK kGPIO_Pin11 /*!<@brief PORT pin mask */
                                      /* @} */

/*! @name GPIOC7 (number 32), J1[14]/U13[1]/SS0
  @{ */
#define BOARD_SCLK_GPIO GPIOC          /*!<@brief GPIO device name: GPIOC */
#define BOARD_SCLK_PIN 15U              /*!<@brief GPIOC pin index: 7 */
#define BOARD_SCLK_PIN_MASK kGPIO_Pin15 /*!<@brief PORT pin mask */
                                      /* @} */
