...
#define ACCEL_I2C_BASE          LPI2C0
#define ACCEL_I2C_DEVICE_ADDR   0x18U
#define ACCEL_SENSOR_DESIGNATOR "U18"
#define ACCEL_SCL_PORT          GPIOF
#define ACCEL_SCL_PIN           kGPIO_Pin3
#define ACCEL_SDA_PORT          GPIOF
#define ACCEL_SDA_PIN           kGPIO_Pin2
