...
#define DEMO_ADC0_CH0_CONTROL_GROUP 0
/* Channel 1 (SE.26) conversion control group. */
#define DEMO_ADC0_CH1_CONTROL_GROUP 1
...
/* Channel 0 (SE.9) conversion control group. */
#define DEMO_ADC1_CH0_CONTROL_GROUP 0
/* Channel 1 (SE.8) conversion control group. */
#define DEMO_ADC1_CH1_CONTROL_GROUP 1
...
#define DEMO_FTM_CLOCK_SOURCE 40000000UL
/* Definition of the clock source frequency */
#define DEMO_FTM_TIMER_MODULO_VALUE 2499
/* Definition of FTM0 channel/pair number 0/1 on Combined PWM */
#define DEMO_FTM_PWM_CHANNEL kFTM_Chnl_0
