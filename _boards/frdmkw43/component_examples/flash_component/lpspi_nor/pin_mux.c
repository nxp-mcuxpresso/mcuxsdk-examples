...
pin_labels:
- {pin_num: '46', pin_signal: ADC0_A9/PTB0/LPSPI1_PCS0/TPM0_CH3, label: LPSPI1_PCS0, identifier: LPSPI1_PCS0}
...
- pin_list:
  ...
  - {pin_num: '46', peripheral: GPIO_B, signal: 'GPIO, 0', pin_signal: ADC0_A9/PTB0/LPSPI1_PCS0/TPM0_CH3, direction: OUTPUT, gpio_init_state: 'false', pull_select: down,
  ...
  - {pin_num: '47', peripheral: LPSPI_1, signal: IN, pin_signal: ADC0_A10/PTB1/LPSPI1_SIN/TPM0_CH4, pull_select: up, pull_enable: enable, slew_rate: fast, open_drain: disable,
    drive_strength: high, invert_input: disable}
