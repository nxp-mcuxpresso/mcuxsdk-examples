...
- pin_list:
  ...
  - {pin_num: '40', peripheral: LPUART_1, signal: TX, pin_signal: PTC3/LPSPI1_SCK/LPUART1_TX/LPI2C1_SDAS/TPM0_CLKIN, pull_select: down, pull_enable: disable, slew_rate: fast,
    open_drain: disable, drive_strength: low, invert_input: disable}
  - {pin_num: '47', peripheral: TPM_0, signal: 'CH, 4', pin_signal: ADC0_A10/PTB1/LPSPI1_SIN/TPM0_CH4, pull_select: down, pull_enable: disable, slew_rate: fast, open_drain: disable,
    drive_strength: low, invert_input: disable}
  - {pin_num: '48', peripheral: TPM_0, signal: 'CH, 5', pin_signal: ADC0_A11/PTB2/LPSPI1_SCK/LPUART1_TX/TPM0_CH5, pull_select: down, pull_enable: disable, slew_rate: fast,
    open_drain: disable, drive_strength: low, invert_input: disable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    /* PORT_B1 (pin 47) is configured as TPM0_CH4 */
    ...
    const port_pin_config_t port_b2_pin48_config = {/* Internal pull-up/down resistor is disabled */
                                                    ...
                                                    /* Pin Control Register fields [15:0] are not locked */
                                                    .lockRegister = (uint16_t)kPORT_UnlockRegister};
    /* PORT_B2 (pin 48) is configured as TPM0_CH5 */
