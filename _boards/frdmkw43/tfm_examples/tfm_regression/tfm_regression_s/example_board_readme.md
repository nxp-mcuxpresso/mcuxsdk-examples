...
Note: Refering to the "Getting started with MCUXpresso SDK for FRDMKW43" documentation for more information
...
> Executing 'TFM_NS_IPC_TEST_1018'
  Description: 'Testing Refused connection'
  TEST: TFM_NS_IPC_TEST_1018 - PASSED!
TESTSUITE PASSED!
