...
- pin_list:
  ...
  - {pin_num: '13', peripheral: LPI2C0, signal: SDA, pin_signal: CMP1_IN1/PTA18/WUU0_P20/LPSPI0_SOUT/LPUART0_CTS_b/LPI2C0_SDA/TPM0_CH3/RF_GPO_0/LPUART0_RX, pull_select: up,
    pull_enable: enable, pull_value: low, slew_rate: fast, passive_filter: disable, open_drain: disable, drive_strength: low, drive_strength_1: normal, invert_input: disable}
  - {pin_num: '14', peripheral: LPI2C0, signal: SCL, pin_signal: CMP1_IN0/PTA19/WUU0_P4/LPSPI0_SCK/LPUART0_RTS_b/LPI2C0_SCL/TPM0_CH2/RF_GPO_1, pull_select: up, pull_enable: enable,
    pull_value: low, slew_rate: fast, passive_filter: disable, open_drain: disable, drive_strength: low, drive_strength_1: normal, invert_input: disable}
...
void BOARD_InitPins(void)
{
    ...
    /* PORTA18 (pin 13) is configured as LPI2C0_SDA */
    ...
    const port_pin_config_t porta19_pin14_config = {/* Internal pull-up resistor is enabled */
                                                    ...
                                                    /* Pin Control Register fields [15:0] are not locked */
                                                    .lockRegister = (uint16_t)kPORT_UnlockRegister};
    /* PORTA19 (pin 14) is configured as LPI2C0_SCL */
