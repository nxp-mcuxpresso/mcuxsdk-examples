...
- pin_list:
  - {pin_num: '37', peripheral: FLEXIO0, signal: 'D, 16', pin_signal: PTC0/WUU0_P7/LPSPI1_PCS2/CAN0_TX/I3C0_SDA/TPM1_CH0/LPI2C1_SCL/FLEXIO0_D16, pull_select: down,
  ...
  - {pin_num: '38', peripheral: FLEXIO0, signal: 'D, 17', pin_signal: PTC1/WUU0_P8/LPSPI1_PCS3/CAN0_RX/I3C0_SCL/TPM1_CH1/LPI2C1_SDA/FLEXIO0_D17, pull_select: down,
...
void BOARD_InitPins(void)
{
    ...
    /* PORTC0 (pin 37) is configured as FLEXIO0_D16 */
    ...
    const port_pin_config_t portc1_pin38_config = {/* Internal pull-up/down resistor is disabled */
                                                   ...
                                                   /* Pin Control Register fields [15:0] are not locked */
                                                   (uint16_t)kPORT_UnlockRegister};
    /* PORTC1 (pin 38) is configured as FLEXIO0_D17 */
