...
da7212_config_t da7212Config = {
    ...
    .format       = {.mclk_HZ = 4800000, .sampleRate = DEMO_AUDIO_SAMPLE_RATE, .bitWidth = DEMO_AUDIO_BIT_WIDTH},
    .pll          = &pllConfig,
...
void BOARD_InitHardware(void)
{
    ...
    /* Set PLL1CLK0DIV divider to value 5, PLL1_CLK0 = 24.576MHz */
    CLOCK_SetClkDiv(kCLOCK_DivPLL1Clk0, 5U);

    /* attach PLL1_CLK0 to PDM, PDM_CLK = 24.576MHz */
