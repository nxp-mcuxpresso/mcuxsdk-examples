...
#define EXAMPLE_CAN_CLOCK_SOURCE              kFLEXCAN_ClkSrcOsc
#define EXAMPLE_CAN_CLOCK_FREQUENCY           CLOCK_GetFlexcanClkFreq()
...
static void init_freemaster_can(void)
{
    ...
    flexcanConfig.clkSrc   = EXAMPLE_CAN_CLOCK_SOURCE;
