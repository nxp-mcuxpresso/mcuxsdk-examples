...
- {id: SCGSCS_CLKSEL.sel, value: FRO_12M_CLKEN}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS **********/
/* clang-format on */
...
- {id: FROHFDIV_SYSCON_FROHFDIV_HALT, value: RUN}
- {id: FROLFDIV_SYSCON_FROLFDIV_HALT, value: RUN}
- {id: MDIV.scale, value: '30', locked: true}
- {id: NDIV.scale, value: '1', locked: true}
- {id: PLL1CLKDIV.scale, value: '4', locked: true}
- {id: PLL1CLKDIV_SYSCON_PLL1CLKDIV_HALT, value: RUN}
- {id: PLL1_CLKSEL.sel, value: FRO_12M_CLKEN}
- {id: PLL_P_DIV.scale, value: '1', locked: true}
- {id: SCGSCS_CLKSEL.sel, value: PLL1_CLKEN}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS **********/
/* clang-format on */
...
void BOARD_BootClockPLL180M(void)
{
    ...
    CLOCK_SetClockDiv(kCLOCK_DivAHBCLK, 1U);               /* !< Set AHBCLKDIV divider to value 1 */
    CLOCK_SetClockDiv(kCLOCK_DivFRO_LF, 1U);               /* !< Set FROLFDIV divider to value 1 */
    CLOCK_SetClockDiv(kCLOCK_DivPLL1CLK, 4U);              /* !< Set PLL1CLKDIV divider to value 4 */
    CLOCK_SetClockDiv(kCLOCK_DivWWDT0, 1U);                /* !< Set WWDT0_CLKDIV divider to value 1 */
    CLOCK_SetClockDiv(kCLOCK_DivTRACE, 1U);                /* !< Set TRACE_CLKDIV divider to value 1 */
