...
- pin_list:
  ...
  - {pin_num: '1', peripheral: CTIMER0, signal: 'CAPTURE, 0', pin_signal: P1_8/WUU0_IN10/FREQME_CLK_IN0/LPUART1_RXD/LPI2C2_SDA/CT_INP8/CT0_MAT2/EZH_PIO4, slew_rate: fast,
    ...
    invert_input: normal}
  - {pin_num: '2', peripheral: GPIO1, signal: 'GPIO, 9', pin_signal: P1_9/FREQME_CLK_IN1/LPUART1_TXD/LPI2C2_SCL/CT_INP9/CT0_MAT3/EZH_PIO5, direction: OUTPUT, slew_rate: fast,
