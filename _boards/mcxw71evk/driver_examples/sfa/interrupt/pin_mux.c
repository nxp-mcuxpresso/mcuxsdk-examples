...
- pin_list:
  - {pin_num: '45', peripheral: SFA0, signal: SFA_CLK, pin_signal: PTC7/WUU0_P12/NMI_b/RF_NOT_ALLOWED/TRGMUX0_IN3/TRGMUX0_OUT3/SFA0_CLK/TPM1_CLKIN/TPM2_CLKIN/CLKOUT/FLEXIO0_D23,
...
void BOARD_InitPins(void)
{
    ...
    const port_pin_config_t portc7_pin45_config = {/* Internal pull-up/down resistor is disabled */
                                                   ...
                                                   /* Normal drive strength is configured */
                                                   (uint16_t)kPORT_NormalDriveStrength,
                                                   /* Pin is configured as SFA0_CLK */
                                                   (uint16_t)kPORT_MuxAlt4,
                                                   /* Pin Control Register fields [15:0] are not locked */
                                                   (uint16_t)kPORT_UnlockRegister};
    /* PORTC7 (pin 45) is configured as SFA0_CLK */
