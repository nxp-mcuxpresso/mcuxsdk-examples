...
#define RGB_LED_BLUE_OFF()    GPIO_PortSet(BOARD_RGB_LED_BLUE_GPIO, BOARD_RGB_LED_BLUE_GPIO_PORT, 1U << BOARD_RGB_LED_BLUE_GPIO_PIN)
#define RGB_LED_BLUE_ON()     GPIO_PortClear(BOARD_RGB_LED_BLUE_GPIO, BOARD_RGB_LED_BLUE_GPIO_PORT, 1U << BOARD_RGB_LED_BLUE_GPIO_PIN)
#define RGB_LED_BLUE_TOGGLE() GPIO_PortToggle(BOARD_RGB_LED_BLUE_GPIO, BOARD_RGB_LED_BLUE_GPIO_PORT, 1U << BOARD_RGB_LED_BLUE_GPIO_PIN)
...
#define RGB_LED_RED_OFF()    GPIO_PortSet(BOARD_RGB_LED_RED_GPIO, BOARD_RGB_LED_RED_GPIO_PORT, 1U << BOARD_RGB_LED_RED_GPIO_PIN)
#define RGB_LED_RED_ON()     GPIO_PortClear(BOARD_RGB_LED_RED_GPIO, BOARD_RGB_LED_RED_GPIO_PORT, 1U << BOARD_RGB_LED_RED_GPIO_PIN)
#define RGB_LED_RED_TOGGLE() GPIO_PortToggle(BOARD_RGB_LED_RED_GPIO, BOARD_RGB_LED_RED_GPIO_PORT, 1U << BOARD_RGB_LED_RED_GPIO_PIN)
...
#define RGB_LED_GREEN_OFF()    GPIO_PortSet(BOARD_RGB_LED_GREEN_GPIO, BOARD_RGB_LED_GREEN_GPIO_PORT, 1U << BOARD_RGB_LED_GREEN_GPIO_PIN)
#define RGB_LED_GREEN_ON()     GPIO_PortClear(BOARD_RGB_LED_GREEN_GPIO, BOARD_RGB_LED_GREEN_GPIO_PORT, 1U << BOARD_RGB_LED_GREEN_GPIO_PIN)
#define RGB_LED_GREEN_TOGGLE() GPIO_PortToggle(BOARD_RGB_LED_GREEN_GPIO, BOARD_RGB_LED_GREEN_GPIO_PORT, 1U << BOARD_RGB_LED_GREEN_GPIO_PIN)
