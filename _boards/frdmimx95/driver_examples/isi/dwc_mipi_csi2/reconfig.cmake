...
mcux_add_configuration(
	CC "-DSDK_I2C_BASED_COMPONENT_USED=1 -DBOARD_USE_PCAL6524=1 -DBOARD_USE_PCAL6408=1"
)
...
mcux_add_armgcc_linker_script(
        TARGETS debug release
        BASE_PATH ${SdkRootDirPath}
        LINKER ${board_root}/frdmimx95/driver_examples/isi/dwc_mipi_csi2/linker/MIMX9596_cm7_isi_ram.ld
)
...
mcux_add_iar_linker_script(
        TARGETS debug release
        BASE_PATH ${SdkRootDirPath}
        LINKER ${board_root}/frdmimx95/driver_examples/isi/dwc_mipi_csi2/linker/MIMX9596_cm7_isi_ram.icf
)

# include ISI example file
include(${SdkRootDirPath}/${board_root}/frdmimx95/driver_examples/isi/reconfig.cmake)
