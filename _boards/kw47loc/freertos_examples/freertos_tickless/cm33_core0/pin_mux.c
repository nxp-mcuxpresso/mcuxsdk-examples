...
pin_labels:
- {pin_num: '45', pin_signal: PTC7/WUU0_P12/RF_NOT_ALLOWED/TRGMUX0_IN3/TRGMUX0_OUT3/SFA0_CLK/TPM1_CLKIN/TPM2_CLKIN/CLKOUT/FLEXIO0_D23/NMI_b, label: SW_3, identifier: SW_3}
...
void BOARD_InitPins(void)
{
    ...
    const port_pin_config_t SW_3 = {/* Internal pull-up resistor is enabled */
    ...
    PORT_SetPinConfig(BOARD_INITPINS_SW_3_PORT, BOARD_INITPINS_SW_3_PIN, &SW_3);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
