...
void BOARD_InitPinLED1(void)
{
    ...
    const port_pin_config_t LED1_B = {/* Internal pull-up/down resistor is disabled */
    ...
    PORT_SetPinConfig(BOARD_INITPINLED1_LED1_PORT, BOARD_INITPINLED1_LED1_PIN, &LED1_B);
}
...
void BOARD_InitPinLED2(void)
{
    ...
    const port_pin_config_t LED2_G = {/* Internal pull-up/down resistor is disabled */
                                     (uint16_t)kPORT_PullDisable,
                                     /* Low internal pull resistor value is selected. */
                                     (uint16_t)kPORT_LowPullResistor,
                                     /* Slow slew rate is configured */
    ...
    PORT_SetPinConfig(BOARD_INITPINLED2_LED2_G_PORT, BOARD_INITPINLED2_LED2_G_PIN, &LED2_G);
}
 ...
 * TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
BOARD_UnInitPinLED1:
- options: {callFromInitBoot: 'false', prefix: BOARD_UNINITPINLED1_, coreID: cm33_core0, enableClock: 'true'}
- pin_list:
...
void BOARD_UnInitPinLED1(void)
{
    ...
    PORT_SetPinMux(BOARD_UNINITPINLED1_LED1_B_PORT, BOARD_UNINITPINLED1_LED1_B_PIN, kPORT_PinDisabledOrAnalog);
}
 ...
 * TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
BOARD_UnInitPinLED2:
- options: {callFromInitBoot: 'false', prefix: BOARD_UNINITPINLED2_, coreID: cm33_core0, enableClock: 'true'}
- pin_list:
...
void BOARD_UnInitPinLED2(void)
{
    ...
    /* PORTC6 (pin 44) is configured as ADC0_A8 */
    PORT_SetPinMux(BOARD_UNINITPINLED2_LED2_G_PORT, BOARD_UNINITPINLED2_LED2_G_PIN, kPORT_PinDisabledOrAnalog);
}
 ...
 * TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
BOARD_UnInitPinLED3:
- options: {callFromInitBoot: 'false', prefix: BOARD_UNINITPINLED3_, coreID: cm33_core0, enableClock: 'true'}
- pin_list: []
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
 ...
 * TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
BOARD_UnInitPinLED4:
- options: {callFromInitBoot: 'false', prefix: BOARD_UNINITPINLED4_, coreID: cm33_core0, enableClock: 'true'}
- pin_list: []
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
{
    /* This API is the basic setting for the KW47-LOC device.
 ...
 * TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
BOARD_InitPins:
- options: {callFromInitBoot: 'yes', coreID: cm33_core0, enableClock: 'true'}
- pin_list:
  - {pin_num: '10', peripheral: GPIOA, signal: 'GPIO, 4', pin_signal: ADC0_A10/CMP0_IN0/PTA4/WUU0_P2/RF_XTAL_OUT_ENABLE/RF_GPO_9/TPM0_CLKIN/TRACE_SWO/FLEXIO0_D4/BOOT_CONFIG,
    pull_select: up, pull_enable: enable, slew_rate: slow, open_drain: enable, drive_strength: low}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
