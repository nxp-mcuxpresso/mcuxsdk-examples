...
outputs:
- {id: CAN_clock.outFreq, value: 30 MHz}
- {id: FRO_12MHz_clock.outFreq, value: 12 MHz}
...
- {id: SYSCON.CANCLKDIV.scale, value: '5', locked: true}
...
void BOARD_BootClockPLL150M(void)
{
    ...
    CLOCK_SetClkDiv(kCLOCK_DivCanClk, 5U, false);           /*!< Set CANCLKDIV divider to value 5 */
