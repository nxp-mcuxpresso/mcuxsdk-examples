...
/*!
 * @brief PORT pin number */
#define BOARD_INITSWD_DEBUGPINS_DEBUG_SWD_SWDCLK_PIN 0U
/*!
 * @brief PORT pin mask */
#define BOARD_INITSWD_DEBUGPINS_DEBUG_SWD_SWDCLK_PIN_MASK (1U << 0U)
/* @} */
...
/*!
 * @brief PORT pin number */
#define BOARD_INITSWD_DEBUGPINS_DEBUG_SWD_SWO_PIN 18U
/*!
 * @brief PORT pin mask */
#define BOARD_INITSWD_DEBUGPINS_DEBUG_SWD_SWO_PIN_MASK (1U << 18U)
/* @} */
/*!
 * @brief Configures pin routing and optionally pin electrical features.
 *
...
#define BOARD_INITBUTTONSPINS_SW3_GPIO_PIN_MASK (1U << 17U) /*!<@brief GPIO pin mask */
#define BOARD_INITBUTTONSPINS_SW3_PORT 0U                   /*!<@brief PORT peripheral base pointer */
#define BOARD_INITBUTTONSPINS_SW3_PIN 17U                   /*!<@brief PORT pin number */
#define BOARD_INITBUTTONSPINS_SW3_PIN_MASK (1U << 17U)      /*!<@brief PORT pin mask */
                                                            /* @} */
...
#define BOARD_INITBUTTONSPINS_SW1_GPIO_PIN_MASK (1U << 18U) /*!<@brief GPIO pin mask */
#define BOARD_INITBUTTONSPINS_SW1_PORT 1U                   /*!<@brief PORT peripheral base pointer */
#define BOARD_INITBUTTONSPINS_SW1_PIN 18U                   /*!<@brief PORT pin number */
#define BOARD_INITBUTTONSPINS_SW1_PIN_MASK (1U << 18U)      /*!<@brief PORT pin mask */
                                                            /* @} */
/*!
 * @brief Configures pin routing and optionally pin electrical features.
 *
...
#define BOARD_INITCANPINS_CAN_RXD_PIN 3U                   /*!<@brief PORT pin number */
#define BOARD_INITCANPINS_CAN_RXD_PIN_MASK (1U << 3U)      /*!<@brief PORT pin mask */
                                                           /* @} */
...
#define BOARD_INITCANPINS_CAN_TXD_PIN 2U                   /*!<@brief PORT pin number */
#define BOARD_INITCANPINS_CAN_TXD_PIN_MASK (1U << 2U)      /*!<@brief PORT pin mask */
                                                           /* @} */
/*!
 * @brief Configures pin routing and optionally pin electrical features.
 *
