...
void BOARD_InitBUTTONsPins(void) { /* Function assigned for the Cortex-M0P */
  ...
  gpio_pin_config_t SW3_io_config = {                        /* PORT0 PIN4 (number: 38) GPIO configuration structure */
    .pinDirection = kGPIO_DigitalInput,
    .outputLogic = 0U
  };
  GPIO_PinInit(BOARD_SW3_GPIO, BOARD_SW3_PORT, BOARD_SW3_PIN, &SW3_io_config); /* Initialize GPIO functionality on pin PIO0_4 (number: 38) */
