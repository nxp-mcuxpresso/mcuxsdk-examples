...
#define BOARD_SW2_IRQ         GPIOA_INT0_IRQn
#define BOARD_SW2_IRQ_HANDLER GPIOA_INT0_IRQHandler

#define BOARD_SW3_NAME        "SW3"
#define BOARD_SW3_GPIO        GPIOD
#define BOARD_SW3_GPIO_PIN    1U
#define BOARD_SW3_IRQ         GPIOD_INT0_IRQn
#define BOARD_SW3_IRQ_HANDLER GPIOD_INT0_IRQHandler

#define BOARD_SW4_NAME        "SW4"
#define BOARD_SW4_GPIO        GPIOA
#define BOARD_SW4_GPIO_PIN    0U
#define BOARD_SW4_IRQ         GPIOA_INT0_IRQn
#define BOARD_SW4_IRQ_HANDLER GPIOA_INT0_IRQHandler

#define BOARD_ACCEL_I2C_BASEADDR LPI2C_1
