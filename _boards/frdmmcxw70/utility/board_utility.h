...
/*! @brief ADC reference voltage, VDD_ANA (kLPADC_ReferenceVoltageAlt3) is selected by default. */
#define LPADC_VOLTAGE_REFERENCE 3.3f
...
#define LPADC_REFERENCE_BATTERY kLPADC_ReferenceVoltageAlt3
