 ...
 ******************************************************************************/
/*${macro:start}*/
#define EXAMPLE_I2C_MASTER_BASE          LPI2C_1
#define LPI2C_MASTER_CLOCK               kCLOCK_Lpi2c1
#define LPI2C_MASTER_CLOCK_FREQUENCY     (CLOCK_GetIpFreq(kCLOCK_Lpi2c1))
#define DEMO_LPI2C_TRANSMIT_EDMA_CHANNEL kDmaRequestLPI2C1Tx
#define DEMO_LPI2C_RECEIVE_EDMA_CHANNEL  kDmaRequestLPI2C1Rx
