...
#define DEMO_FREQ_TAR_CLOCK_SOURCE_NAME  {"FRO_12M", "FREQME_CLK_IN0"}
#define DEMO_PULSE_TAR_CLOCK_SOURCE_NAME {"FRO_12M", "FRO_HF_DIV"}

#define DEMO_PULSE_TAR_CLOCK_SOURCE_SIGNAL \
    {                                      \
        kINPUTMUX_Froosc12MToFreqmeastar,  \
        kINPUTMUX_FrohfdivToFreqmeastar,   \
    }

#define DEMO_FREQ_TAR_CLOCK_SOURCE_SIGNAL    \
    {                                        \
        kINPUTMUX_Froosc12MToFreqmeastar,    \
        kINPUTMUX_Freqmeclkin0ToFreqmeastar, \
    }
