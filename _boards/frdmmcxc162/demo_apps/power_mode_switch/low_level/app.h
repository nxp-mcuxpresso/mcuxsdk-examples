...
#define APP_POWER_MODE_DESC                                                                                           \
    {                                                                                                                 \
        "Acitve: Core clock is 72MHz.", "Sleep: CPU clock is off, and the system clock and bus clock remain ON. ",    \
...
#define APP_WAKETIMER_IRQN LPTMR0_IRQn
