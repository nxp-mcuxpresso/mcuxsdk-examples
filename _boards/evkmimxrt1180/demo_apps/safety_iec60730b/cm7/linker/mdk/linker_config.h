...
#define ROM_interrupts_start 0x00002000 /* IVT in ROM */
#define ROM_interrupts_end   ROM_interrupts_start + __vector_table_size__

#define m_flash_config_start 0x00000000
...
#define ROM_end   0x00040000     /* Real ROM_end is 0x303FFFFF, it is shortened due to generated image size. */
