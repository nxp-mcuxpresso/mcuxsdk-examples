...
#define GPT_SRC_24M 1U /* Value from ref. manual */
...
#define CLOCK_GPT1_FREQ ((CLOCK_GPT1_SRC == GPT_SRC_32K ? 32768.F : 240000000.F) / CLOCK_GPT1_DIV)
#define CLOCK_GPT2_FREQ ((CLOCK_GPT2_SRC == GPT_SRC_32K ? 32768.F : 240000000.F) / CLOCK_GPT2_DIV)

#define SYSTICK_FREQ 792000000 /* 792MHz */
#define SYSTICK_RELOAD_VALUE 792000 /* 792MHz/792kHz = 1ms period */
...
/********* Watchdog *********/
#define WDOG_REF_TIMER_BASE GPT2
#define RESET_DETECT_REGISTER &(SRC_GENERAL_REG->SRSR)
#define RESET_DETECT_MASK SRC_GENERAL_SRSR_WDOG3_RST_B_MASK
...
#define WD_GPT2_SRC                  GPT_SRC_24M /* Clock source */
#define WD_GPT2_DIV                  24U         /* 24MHz/div = 1MHz */
#define WD_GPT2_CMP                  0xFFFFFFFFU

#define WD_RUN_TEST_CONDITION   (0xFFFFFFFFU ^ (SRC_GENERAL_SRSR_WDOG3_RST_B_MASK))
#define WD_CHECK_TEST_CONDITION (SRC_GENERAL_SRSR_WDOG3_RST_B_MASK)
/********* Watchdog END *********/

#define PC_TEST_PATTERN 0x2003FF00 /* Test address for Program counter test */
