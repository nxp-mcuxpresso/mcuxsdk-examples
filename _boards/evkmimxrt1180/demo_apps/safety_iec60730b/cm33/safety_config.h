...
#define SYSTICK_FREQ 240000000 /* 240MHz */
#define SYSTICK_RELOAD_VALUE 240000 /* 240MHz/240kHz = 1ms period */
...
#define PC_TEST_PATTERN 0x30500000 /* Test address for Program counter test */
