...
#ifdef EEPROM_I2C_EMULATOR
#define I2C_SLAVE_DEV ((LPI2C_Type *)LPI2C2_BASE)
#define I2C_SLAVE_CLOCK_FREQUENCY (CLOCK_GetRootClockFreq(kCLOCK_Root_Lpi2c0102))
...
uint8_t esc_eeprom_cache_default[] = {
  0x80, 0x0c, 0x84, 0xee, 0x00, 0x0a, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x2a, 0x00, 0xc2, 0x0c, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
