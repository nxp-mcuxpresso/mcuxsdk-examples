...
#define BOARD_INITPINS_SD1_CD_B_INIT_GPIO_VALUE                               0U   /*!< GPIO output initial state */
...
#define BOARD_INITPINS_SD_VSELECT_INIT_GPIO_VALUE                             0U   /*!< GPIO output initial state */
