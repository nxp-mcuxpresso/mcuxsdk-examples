...
void BOARD_WIFI_BT_Enable(bool enable)
{
    if (enable)
    {
        ...
        /* Set SDIO_RST to 1 */
        RGPIO_PinWrite(BOARD_INITPINSM2_SDIO_RST_GPIO, BOARD_INITPINSM2_SDIO_RST_GPIO_PIN, 1U);
        vTaskDelay(pdMS_TO_TICKS(100));

        /* Set WL_RST to 1 */
        RGPIO_PinWrite(BOARD_INITPINSM2_WL_RST_GPIO, BOARD_INITPINSM2_WL_RST_GPIO_PIN, 1U);
        vTaskDelay(pdMS_TO_TICKS(100));
    }
    else
    {
        ...
        /* Set WL_RST to 0 */
        RGPIO_PinWrite(BOARD_INITPINSM2_WL_RST_GPIO, BOARD_INITPINSM2_WL_RST_GPIO_PIN, 0U);
        /* Set SDIO_RST to 0 */
        RGPIO_PinWrite(BOARD_INITPINSM2_SDIO_RST_GPIO, BOARD_INITPINSM2_SDIO_RST_GPIO_PIN, 0U);
