...
- pin_list:
  ...
  - {pin_num: '33', peripheral: FTM2, signal: CH0, pin_signal: PTD5/ADC0_SE9/FTM2_CH3/LPTMR0_ALT2/FXIO_D3/PWT_IN2/TRGMUX_IN7/LPUART2_CTS}
  - {pin_num: '36', peripheral: FTM2, signal: CH2, pin_signal: PTD10/FTM2_CH0}
  - {pin_num: '34', peripheral: FTM2, signal: CH3, pin_signal: PTD12/FTM2_CH2/LPI2C1_HREQ/LPUART2_RTS}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    /* PORTD5  (pin 33) is configured as FTM2_CH0 */
    PORT_SetPinMux(PORTD, 5U , kPORT_MuxAlt2);
    
    /* PORTD10 (pin 36) is configured as FTM2_CH2 */
    PORT_SetPinMux(PORTD, 10U, kPORT_MuxAlt2);
    
    /* PORTD12 (pin 34) is configured as FTM2_CH3 */
