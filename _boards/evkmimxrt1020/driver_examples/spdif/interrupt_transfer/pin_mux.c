...
void BOARD_InitPins(void) {
  ...
  IOMUXC_SetPinMux(IOMUXC_GPIO_EMC_04_SPDIF_OUT, 0U); 
  IOMUXC_SetPinMux(IOMUXC_GPIO_EMC_05_SPDIF_IN, 0U); 
  IOMUXC_SetPinConfig(IOMUXC_GPIO_AD_B0_06_LPUART1_TX, 0x10B0U); 
  IOMUXC_SetPinConfig(IOMUXC_GPIO_AD_B0_07_LPUART1_RX, 0x10B0U); 
  IOMUXC_SetPinConfig(IOMUXC_GPIO_EMC_04_SPDIF_OUT, 0x10B0U); 
  IOMUXC_SetPinConfig(IOMUXC_GPIO_EMC_05_SPDIF_IN, 0x10B0U); 
}
