...
/* Routed pin properties */
#define BOARD_INITNETPINS_ENET_INT_PERIPHERAL                              GPIO1   /*!< Peripheral name */
#define BOARD_INITNETPINS_ENET_INT_SIGNAL                                gpio_io   /*!< Signal name */
#define BOARD_INITNETPINS_ENET_INT_CHANNEL                                   22U   /*!< Signal channel */

/* Symbols to be used with GPIO driver */
#define BOARD_INITNETPINS_ENET_INT_GPIO                                    GPIO1   /*!< GPIO peripheral base pointer */
#define BOARD_INITNETPINS_ENET_INT_GPIO_PIN                                  22U   /*!< GPIO pin number */
#define BOARD_INITNETPINS_ENET_INT_GPIO_PIN_MASK                     (1U << 22U)   /*!< GPIO pin mask */
#define BOARD_INITNETPINS_ENET_INT_PORT                                    GPIO1   /*!< PORT peripheral base pointer */
#define BOARD_INITNETPINS_ENET_INT_PIN                                       22U   /*!< PORT pin number */
#define BOARD_INITNETPINS_ENET_INT_PIN_MASK                          (1U << 22U)   /*!< PORT pin mask */

/* GPIO_AD_B0_04 (number 107), JTAG_TDO/J16[13]/ENET_RST/U11[32] */
/* Routed pin properties */
#define BOARD_INITNETPINS_ENET_RST_PERIPHERAL                              GPIO1   /*!< Peripheral name */
#define BOARD_INITNETPINS_ENET_RST_SIGNAL                                gpio_io   /*!< Signal name */
#define BOARD_INITNETPINS_ENET_RST_CHANNEL                                    4U   /*!< Signal channel */

/* Symbols to be used with GPIO driver */
#define BOARD_INITNETPINS_ENET_RST_GPIO                                    GPIO1   /*!< GPIO peripheral base pointer */
#define BOARD_INITNETPINS_ENET_RST_GPIO_PIN                                   4U   /*!< GPIO pin number */
#define BOARD_INITNETPINS_ENET_RST_GPIO_PIN_MASK                      (1U << 4U)   /*!< GPIO pin mask */
#define BOARD_INITNETPINS_ENET_RST_PORT                                    GPIO1   /*!< PORT peripheral base pointer */
#define BOARD_INITNETPINS_ENET_RST_PIN                                        4U   /*!< PORT pin number */
#define BOARD_INITNETPINS_ENET_RST_PIN_MASK                           (1U << 4U)   /*!< PORT pin mask */

/* GPIO_AD_B0_08 (number 100), ENET_TX_CLK/U11[9] */
/* Routed pin properties */
#define BOARD_INITNETPINS_ENET_TX_CLK_PERIPHERAL                            ENET   /*!< Peripheral name */
#define BOARD_INITNETPINS_ENET_TX_CLK_SIGNAL                         enet_tx_clk   /*!< Signal name */
...
/* Routed pin properties */
#define BOARD_INITSDHCPINS_SD_CD_SW_PERIPHERAL                             GPIO3   /*!< Peripheral name */
#define BOARD_INITSDHCPINS_SD_CD_SW_SIGNAL                               gpio_io   /*!< Signal name */
#define BOARD_INITSDHCPINS_SD_CD_SW_CHANNEL                                  19U   /*!< Signal channel */

/* Symbols to be used with GPIO driver */
#define BOARD_INITSDHCPINS_SD_CD_SW_GPIO                                   GPIO3   /*!< GPIO peripheral base pointer */
#define BOARD_INITSDHCPINS_SD_CD_SW_GPIO_PIN                                 19U   /*!< GPIO pin number */
#define BOARD_INITSDHCPINS_SD_CD_SW_GPIO_PIN_MASK                    (1U << 19U)   /*!< GPIO pin mask */
#define BOARD_INITSDHCPINS_SD_CD_SW_PORT                                   GPIO3   /*!< PORT peripheral base pointer */
#define BOARD_INITSDHCPINS_SD_CD_SW_PIN                                      19U   /*!< PORT pin number */
#define BOARD_INITSDHCPINS_SD_CD_SW_PIN_MASK                         (1U << 19U)   /*!< PORT pin mask */
