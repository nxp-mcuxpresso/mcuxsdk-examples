...
2.  Connect a USB cable between the host PC and the Debug port on the board (Refer "Getting Started with MCUXpresso SDK for FRDM-IMX937.pdf" for debug port information).
3.  Open a serial terminal with the following settings:
    ...
    - One stop bit
    - No flow control
4.  Download the program to the target board (Please refer "Getting Started with MCUXpresso SDK for FRDM-IMX937.pdf" for how to run different targets).
