...
/* Select primary csi interface as default */
#define APP_MIPI_CSI2_PRIMARY_BASE              CAMERA__CSI_COMPLEX__PRIMARY_CSI2_CONTROLLER_BASE
#define APP_MIPI_CSI2_PRIMARY                   ((CSI2_CONTROLLER_Type  *)APP_MIPI_CSI2_PRIMARY_BASE)
#define APP_MIPI_CSI2_SECONDARY_BASE            CAMERA__CSI_COMPLEX__SECONDARY_CSI2_CONTROLLER_BASE
#define APP_MIPI_CSI2_SECONDARY                 ((CSI2_CONTROLLER_Type  *)APP_MIPI_CSI2_SECONDARY_BASE)
#define APP_MIPI_CSI2_PHY              		((CAMERA_PHY_CSR_Type *)CAMERA__PHY_CSR_BASE)
   
#define APP_CAMERA_I2C_BASEADDR         LPI2C2
...
#define APP_ISI_IRQn                    ISI_0_IRQn
