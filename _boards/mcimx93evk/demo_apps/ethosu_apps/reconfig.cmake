...
mcux_add_include(
    ...
    INCLUDES middleware/ethos-u-core-software/include
             middleware/ethos-u-core-software/boards/mcimx93evk
             middleware/ethos-u-core-software/examples/ethosu_apps
             middleware/ethos-u-core-software/board/mcimx93evk
)
...
mcux_add_iar_linker_script(
    BASE_PATH ${SdkRootDirPath}
    TARGETS debug release
    LINKER middleware/ethos-u-core-software/boards/${board}/MIMX9352_cm33_ram.icf
)
mcux_add_armgcc_linker_script(
    BASE_PATH ${SdkRootDirPath}
    TARGETS debug release
    LINKER middleware/ethos-u-core-software/boards/${board}/MIMX9352_cm33_ram.ld
)
