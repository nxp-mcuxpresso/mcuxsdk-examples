...
1. Build secure binary and non-secure binary. For example (if west build is used),
   west build -p -b mcimx93evk examples/trustzone_examples/secure_faults_trdc_s -Dcore_id=cm33 -d secure_faults_trdc_s
   west build -p -b mcimx93evk examples/trustzone_examples/secure_faults_trdc_ns -Dcore_id=cm33 -d secure_faults_trdc_ns
