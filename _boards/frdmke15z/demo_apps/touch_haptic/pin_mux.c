...
void BOARD_InitPins(void) {
  ...
  /* Haptic PWM pins */
  PORT_SetPinMux(PORTA, PIN15_IDX, kPORT_MuxAlt2);           /* PORTA15 (pin 83) is configured as FTM1_CH2 */
  PORT_SetPinMux(PORTA, PIN17_IDX, kPORT_MuxAlt2);           /* PORTA17 (pin 62) is configured as FTM0_CH6 */
  
  /* Haptic audio pins */
  PORT_SetPinMux(PORTA, PIN16_IDX, kPORT_MuxAlt2);           /* PORTA16 (pin 82) is configured as FTM1_CH3 */
  PORT_SetPinMux(PORTC, PIN5_IDX,  kPORT_MuxAlt2);           /* PORTC5  (pin 95) is configured as FTM2_CH0 */
}
