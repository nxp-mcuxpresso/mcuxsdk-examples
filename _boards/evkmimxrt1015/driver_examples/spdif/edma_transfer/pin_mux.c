...
- pin_list:
  ...
  - {pin_num: '6', peripheral: SPDIF, signal: spdif_in, pin_signal: GPIO_EMC_05, software_input_on: Disable, open_drain: Disable}
  - {pin_num: '7', peripheral: SPDIF, signal: spdif_out, pin_signal: GPIO_EMC_04, software_input_on: Disable, open_drain: Disable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
