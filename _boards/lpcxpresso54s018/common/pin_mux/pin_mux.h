...
/*! @name PIO4_8 (coord B14), U12[17]/JP11[1]/P4_8-ENET_TXD0
  @{ */
#define BOARD_INITENETPINS_ENET_TXD0_PORT 4U                  /*!<@brief PORT peripheral base pointer */
#define BOARD_INITENETPINS_ENET_TXD0_PIN 8U                   /*!<@brief PORT pin number */
#define BOARD_INITENETPINS_ENET_TXD0_PIN_MASK (1U << 8U)      /*!<@brief PORT pin mask */
                                                              /* @} */
...
/*! @name PIO4_11 (coord A9), U12[8]/JP12[1]/J3[4]/JP12[3]/P4_11-USB0_ID/P4_11-ENET_RXD0
  @{ */
#define BOARD_INITENETPINS_ENET_RXD0_PORT 4U                   /*!<@brief PORT peripheral base pointer */
#define BOARD_INITENETPINS_ENET_RXD0_PIN 11U                   /*!<@brief PORT pin number */
#define BOARD_INITENETPINS_ENET_RXD0_PIN_MASK (1U << 11U)      /*!<@brief PORT pin mask */
                                                               /* @} */
...
/*! @name PIO4_10 (coord B9), U12[11]/P4_10-ENET_CRS_DV
  @{ */
#define BOARD_INITENETPINS_ENET_CRS_DV_PORT 4U                   /*!<@brief PORT peripheral base pointer */
#define BOARD_INITENETPINS_ENET_CRS_DV_PIN 10U                   /*!<@brief PORT pin number */
#define BOARD_INITENETPINS_ENET_CRS_DV_PIN_MASK (1U << 10U)      /*!<@brief PORT pin mask */
                                                                 /* @} */
...
/* Symbols to be used with GPIO driver */
#define BOARD_INITENETPINS_ENET_PHY_RSTn_GPIO GPIO                 /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITENETPINS_ENET_PHY_RSTn_GPIO_PIN_MASK (1U << 26U) /*!<@brief GPIO pin mask */
#define BOARD_INITENETPINS_ENET_PHY_RSTn_PORT 2U                   /*!<@brief PORT peripheral base pointer */
#define BOARD_INITENETPINS_ENET_PHY_RSTn_PIN 26U                   /*!<@brief PORT pin number */
#define BOARD_INITENETPINS_ENET_PHY_RSTn_PIN_MASK (1U << 26U)      /*!<@brief PORT pin mask */
                                                                   /* @} */

/*! @name PIO4_14 (coord B5), JS18[2]/P4_14-ENET_RX_CLK
  @{ */
#define BOARD_INITENETPINS_ENET_RX_CLK_PORT 4U                   /*!<@brief PORT peripheral base pointer */
#define BOARD_INITENETPINS_ENET_RX_CLK_PIN 14U                   /*!<@brief PORT pin number */
#define BOARD_INITENETPINS_ENET_RX_CLK_PIN_MASK (1U << 14U)      /*!<@brief PORT pin mask */
                                                                 /* @} */
