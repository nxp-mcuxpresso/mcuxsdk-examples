...
- {id: MCAN0_clock.outFreq, value: 30 MHz}
...
- {id: SYSCON.CAN0CLKDIV.scale, value: '6', locked: true}
...
void BOARD_BootClockPLL180M(void)
{
    ...
    CLOCK_SetClkDiv(kCLOCK_DivCan0Clk, 6U, false);                  /*!< Set CAN0CLKDIV divider to value 6 */
