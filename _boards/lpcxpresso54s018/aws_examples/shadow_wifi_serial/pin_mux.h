...
/*! @name PIO1_0 (coord N3), J12[6]/P0_31-ADC0IN5
  @{ */

/* Symbols to be used with GPIO driver */
#define BOARD_WIFI_RST_GPIO GPIO                /*!<@brief GPIO peripheral base pointer */
#define BOARD_WIFI_RST_GPIO_PIN_MASK (1U << 0U) /*!<@brief GPIO pin mask */
#define BOARD_WIFI_RST_PORT 1U                  /*!<@brief PORT peripheral base pointer */
#define BOARD_WIFI_RST_PIN 0U                   /*!<@brief PORT pin number */
#define BOARD_WIFI_RST_PIN_MASK (1U << 0U)      /*!<@brief PORT pin mask */
                                                /* @} */
