...
status_t BOARD_PCA6416A_I2C_Send(void *base,
                                 ...
                                 uint32_t flags)
{
    return BOARD_I2C_Send(base, deviceAddress, subAddress, subAddressSize, (uint8_t *)txBuff,
                            txBuffSize);
}
...
status_t BOARD_PCA6416A_I2C_Receive(void *base,
                                    ...
                                    uint32_t flags)
{
    return BOARD_I2C_Receive(base, deviceAddress, subAddress, subAddressSize, rxBuff, 
                             rxBuffSize);
}
