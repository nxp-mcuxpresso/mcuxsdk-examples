...
1. Build secure binary and non-secure binary. For example (if west build is used),
   west build -p -b mcimx93autoevk examples/trustzone_examples/secure_faults_trdc_s -Dcore_id=cm33 -d secure_faults_trdc_s
   west build -p -b mcimx93autoevk examples/trustzone_examples/secure_faults_trdc_ns -Dcore_id=cm33 -d secure_faults_trdc_ns
2. Create m33_image.bin
   dd if=secure_faults_trdc_ns/secure_faults_trdc_ns_cm33.bin of=secure_faults_trdc_s/secure_faults_trdc_s_cm33.bin bs=1 count=`ls -l secure_faults_trdc_ns/secure_faults_trdc_ns_cm33.bin | awk '{print $5}'` seek=65536
   Rename secure_faults_trdc_s/secure_faults_trdc_s_cm33.bin to m33_image.bin
