mcux_add_source(
  ...
  SOURCES
    ...
    middleware/edgefast_bluetooth/boards/${board}/edgefast_bluetooth_examples/broadcast_audio_sink/${core_id}/hardware_init.c
    middleware/edgefast_bluetooth/boards/${board}/edgefast_bluetooth_examples/broadcast_audio_sink/${core_id}/pin_mux.c
    middleware/edgefast_bluetooth/boards/${board}/edgefast_bluetooth_examples/broadcast_audio_sink/${core_id}/pin_mux.h
    middleware/edgefast_bluetooth/boards/${board}/edgefast_bluetooth_examples/configs/FreeRTOSConfig.h
    middleware/edgefast_bluetooth/examples/broadcast_audio_sink/broadcast_audio_sink.c
    middleware/edgefast_bluetooth/examples/broadcast_audio_sink/broadcast_audio_sink.h
...
mcux_add_include(
  ...
  INCLUDES
    ...
    middleware/edgefast_bluetooth/boards/${board}/edgefast_bluetooth_examples/broadcast_audio_sink/${core_id}
    middleware/edgefast_bluetooth/boards/${board}/edgefast_bluetooth_examples/configs
    middleware/edgefast_bluetooth/examples/broadcast_audio_sink
...
mcux_add_iar_linker_script(
  BASE_PATH ${SdkRootDirPath}
  LINKER middleware/edgefast_bluetooth/boards/${board}/edgefast_bluetooth_examples/broadcast_audio_sink/linker/iar/MIMXRT1176xxxxx_cm7_flexspi_nor.icf
  TARGETS
    flexspi_nor_debug
    flexspi_nor_release
)
mcux_add_mdk_linker_script(
  BASE_PATH ${SdkRootDirPath}
  LINKER middleware/edgefast_bluetooth/boards/${board}/edgefast_bluetooth_examples/broadcast_audio_sink/linker/arm/MIMXRT1176xxxxx_cm7_flexspi_nor.scf
  TARGETS
    flexspi_nor_debug
    flexspi_nor_release
)
mcux_add_armgcc_linker_script(
  BASE_PATH ${SdkRootDirPath}
  LINKER middleware/edgefast_bluetooth/boards/${board}/edgefast_bluetooth_examples/broadcast_audio_sink/linker/gcc/MIMXRT1176xxxxx_cm7_flexspi_nor.ld
  TARGETS
    flexspi_nor_debug
    flexspi_nor_release
)
