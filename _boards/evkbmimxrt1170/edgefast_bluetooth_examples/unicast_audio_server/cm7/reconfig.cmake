mcux_add_source(
  ...
  SOURCES
    ...
    middleware/edgefast_bluetooth/boards/${board}/edgefast_bluetooth_examples/unicast_audio_server/${core_id}/hardware_init.c
    middleware/edgefast_bluetooth/boards/${board}/edgefast_bluetooth_examples/unicast_audio_server/${core_id}/pin_mux.c
    middleware/edgefast_bluetooth/boards/${board}/edgefast_bluetooth_examples/unicast_audio_server/${core_id}/pin_mux.h
    middleware/edgefast_bluetooth/examples/unicast_audio_server/unicast_audio_server.c
    middleware/edgefast_bluetooth/examples/unicast_audio_server/unicast_audio_server.h
...
mcux_add_include(
  ...
  INCLUDES
    ...
    middleware/edgefast_bluetooth/boards/${board}/edgefast_bluetooth_examples/unicast_audio_server/${core_id}
    middleware/edgefast_bluetooth/examples/unicast_audio_server
...
mcux_add_iar_linker_script(
  BASE_PATH ${SdkRootDirPath}
  LINKER middleware/edgefast_bluetooth/boards/${board}/edgefast_bluetooth_examples/unicast_audio_server/linker/iar/MIMXRT1176xxxxx_cm7_flexspi_nor.icf
  TARGETS
    flexspi_nor_debug
    flexspi_nor_release
)
mcux_add_mdk_linker_script(
  BASE_PATH ${SdkRootDirPath}
  LINKER middleware/edgefast_bluetooth/boards/${board}/edgefast_bluetooth_examples/unicast_audio_server/linker/arm/MIMXRT1176xxxxx_cm7_flexspi_nor.scf
  TARGETS
    flexspi_nor_debug
    flexspi_nor_release
)
mcux_add_armgcc_linker_script(
  BASE_PATH ${SdkRootDirPath}
  LINKER middleware/edgefast_bluetooth/boards/${board}/edgefast_bluetooth_examples/unicast_audio_server/linker/gcc/MIMXRT1176xxxxx_cm7_flexspi_nor.ld
  TARGETS
    flexspi_nor_debug
    flexspi_nor_release
)
