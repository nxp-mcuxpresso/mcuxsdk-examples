mcux_add_source(
  ...
  SOURCES
    ...
    examples/_boards/${board}/edgefast_bluetooth_examples/bmr_4bis/${core_id}/hardware_init.c
    examples/_boards/${board}/edgefast_bluetooth_examples/bmr_4bis/${core_id}/pin_mux.c
    examples/_boards/${board}/edgefast_bluetooth_examples/bmr_4bis/${core_id}/pin_mux.h
...
mcux_add_include(
  ...
  INCLUDES
    ...
    ${board_root}/${board}
    examples/_boards/${board}/edgefast_bluetooth_examples/bmr_4bis/${core_id}
...
mcux_add_iar_linker_script(
  BASE_PATH ${SdkRootDirPath}
  LINKER examples/_boards/${board}/edgefast_bluetooth_examples/bmr_4bis/linker/iar/MIMXRT1176xxxxx_cm7_flexspi_nor.icf
  TARGETS
    flexspi_nor_debug
    flexspi_nor_release
)
mcux_add_mdk_linker_script(
  BASE_PATH ${SdkRootDirPath}
  LINKER examples/_boards/${board}/edgefast_bluetooth_examples/bmr_4bis/linker/arm/${core_id}_flexspi.scf
  TARGETS
    flexspi_nor_debug
    flexspi_nor_release
)
mcux_add_armgcc_linker_script(
  BASE_PATH ${SdkRootDirPath}
  LINKER examples/_boards/${board}/edgefast_bluetooth_examples/bmr_4bis/linker/gcc/${core_id}.ld
  TARGETS
    flexspi_nor_debug
    flexspi_nor_release
)
