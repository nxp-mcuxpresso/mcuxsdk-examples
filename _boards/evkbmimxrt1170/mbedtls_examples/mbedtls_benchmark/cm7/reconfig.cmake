...
mcux_add_iar_linker_script(
    BASE_PATH ${SdkRootDirPath}
    TARGETS debug release
    LINKER examples/_boards/${board}/mbedtls_examples/linker/MIMXRT1176xxxxx_cm7_ram_ocram.icf
)
mcux_add_iar_linker_script(
    BASE_PATH ${SdkRootDirPath}
    TARGETS flexspi_nor_debug flexspi_nor_release
    LINKER examples/_boards/${board}/mbedtls_examples/linker/MIMXRT1176xxxxx_cm7_flexspi_nor_ocram.icf
)
mcux_add_mdk_linker_script(
    BASE_PATH ${SdkRootDirPath}
    TARGETS debug release
    LINKER examples/_boards/${board}/mbedtls_examples/linker/MIMXRT1176xxxxx_cm7_ram_ocram.scf
)
mcux_add_mdk_linker_script(
    BASE_PATH ${SdkRootDirPath}
    TARGETS flexspi_nor_debug flexspi_nor_release
    LINKER examples/_boards/${board}/mbedtls_examples/linker/MIMXRT1176xxxxx_cm7_flexspi_nor_ocram.scf
)
mcux_add_armgcc_linker_script(
    BASE_PATH ${SdkRootDirPath}
    TARGETS debug release
    LINKER examples/_boards/${board}/mbedtls_examples/linker/MIMXRT1176xxxxx_cm7_ram_ocram.ld
)
mcux_add_armgcc_linker_script(
    BASE_PATH ${SdkRootDirPath}
    TARGETS flexspi_nor_debug flexspi_nor_release
    LINKER examples/_boards/${board}/mbedtls_examples/linker/MIMXRT1176xxxxx_cm7_flexspi_nor_ocram.ld
)
