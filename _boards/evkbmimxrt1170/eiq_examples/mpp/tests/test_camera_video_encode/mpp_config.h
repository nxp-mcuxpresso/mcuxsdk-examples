...
#define HAL_ENABLE_H264_ENCODER
#define HAL_ENABLE_NETWORK

#define CONFIG_MPP_RC_TASK_STACK_SIZE 4096

/**
 * This is the inference HAL configuration
 */

/* enable RTSP sink decoder */
#define HAL_ENABLE_RTSP_SINK                  1
...
#define APP_RC_CYCLE_INC 1
#define APP_RC_CYCLE_MIN 1
