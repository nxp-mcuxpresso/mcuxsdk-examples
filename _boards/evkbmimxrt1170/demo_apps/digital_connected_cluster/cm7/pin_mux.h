...
#define BOARD_INITMURATAMODULEM2PINS_WL_RST_PERIPHERAL                     GPIO9   /*!< Peripheral name */
#define BOARD_INITMURATAMODULEM2PINS_WL_RST_SIGNAL                       gpio_io   /*!< Signal name */
#define BOARD_INITMURATAMODULEM2PINS_WL_RST_CHANNEL                          30U   /*!< Signal channel */
#define BOARD_INITMURATAMODULEM2PINS_WL_RST_GPIO                           GPIO9   /*!< GPIO peripheral base pointer */
#define BOARD_INITMURATAMODULEM2PINS_WL_RST_GPIO_PIN                         30U   /*!< GPIO pin number */
#define BOARD_INITMURATAMODULEM2PINS_WL_RST_GPIO_PIN_MASK            (1U << 30U)   /*!< GPIO pin mask */
void BOARD_InitMurataModuleM2Pins(void);      /* Function assigned for the Cortex-M7F */
