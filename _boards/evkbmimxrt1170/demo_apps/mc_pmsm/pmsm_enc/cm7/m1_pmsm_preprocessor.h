...
#define M1_FAULT_DURATION (ParametersFaultDuration / SpeedLoopSampleTime)			
#define M1_FREEWHEEL_DURATION (ParametersFreewheelDuration / SpeedLoopSampleTime)	
#define M1_SCALAR_UQ_MIN (ParametersScalarUqMin)									
#define M1_ALIGN_VOLTAGE (ParametersAlignVoltage)									
#define M1_ALIGN_DURATION (ParametersAlignDuration / CurrentLoopSampleTime)			
