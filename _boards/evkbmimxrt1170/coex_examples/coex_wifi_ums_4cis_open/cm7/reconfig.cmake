...
mcux_add_source(
  ...
  SOURCES
    ...
    middleware/edgefast_open/examples/_boards/${board}/ums_4cis/${core_id}/hardware_init.c
    ...
    # BT sources (from edgefast_open ums_4cis board reconfig)
    middleware/edgefast_open/examples/_boards/${board}/configs/freertos/FreeRTOSConfig.h
    middleware/edgefast_open/examples/_boards/${board}/ums_4cis/${core_id}/pin_mux.c
    middleware/edgefast_open/examples/_boards/${board}/ums_4cis/${core_id}/pin_mux.h
...
mcux_add_source(
    ...
    CONFIG True
    PREINCLUDE TRUE
    SOURCES ${board_root}/${board}/coex_examples/coex_wifi_ums_4cis_open/cm7/app_config.h
)
...
mcux_add_include(
    ...
    INCLUDES ${board_root}/${board}
             ${board_root}/${board}/coex_examples/coex_wifi_ums_4cis_open/cm7
             ...
             # BT includes (from edgefast_open ums_4cis board reconfig)
             middleware/edgefast_open/examples/_boards/${board}/configs/freertos
             middleware/edgefast_open/examples/_boards/${board}/ums_4cis/${core_id}
...
mcux_add_armgcc_linker_script(
  BASE_PATH ${SdkRootDirPath}
  LINKER examples/_boards/${board}/coex_examples/coex_wifi_ums_4cis_open/linker/gcc/${core_id}.ld
  TARGETS
    flexspi_nor_debug
    flexspi_nor_release
)
...
mcux_add_iar_linker_script(
  BASE_PATH ${SdkRootDirPath}
  LINKER middleware/edgefast_open/examples/_boards/${board}/ums_4cis/linker/iar/MIMXRT1176xxxxx_cm7_flexspi_nor.icf
  TARGETS
    flexspi_nor_debug
    flexspi_nor_release
)
mcux_add_mdk_linker_script(
  BASE_PATH ${SdkRootDirPath}
  LINKER middleware/edgefast_open/examples/_boards/${board}/ums_4cis/linker/arm/${core_id}_flexspi.scf
  TARGETS
    flexspi_nor_debug
    flexspi_nor_release
)
