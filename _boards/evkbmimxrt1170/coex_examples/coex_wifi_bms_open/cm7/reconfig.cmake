...
mcux_add_source(
  ...
  SOURCES
    ...
    middleware/edgefast_open/examples/_boards/${board}/broadcast_media_sender/${core_id}/hardware_init.c
    ...
    # BT sources (from edgefast_open broadcast_media_sender board reconfig)
    middleware/edgefast_open/examples/_boards/${board}/configs/freertos/FreeRTOSConfig.h
    middleware/edgefast_open/examples/_boards/${board}/broadcast_media_sender/${core_id}/pin_mux.c
    middleware/edgefast_open/examples/_boards/${board}/broadcast_media_sender/${core_id}/pin_mux.h
    ...
    # FatFS config
    middleware/edgefast_open/examples/broadcast_media_sender/modules/ffconf.h
)
...
mcux_add_source(
    ...
    CONFIG True
    PREINCLUDE TRUE
    SOURCES ${board_root}/${board}/coex_examples/coex_wifi_bms_open/cm7/app_config.h
)
...
mcux_add_include(
    ...
    INCLUDES ${board_root}/${board}
             ${board_root}/${board}/coex_examples/coex_wifi_bms_open/cm7
             ...
             # BT includes (from edgefast_open broadcast_media_sender board reconfig)
             middleware/edgefast_open/examples/_boards/${board}/configs/freertos
             middleware/edgefast_open/examples/_boards/${board}/broadcast_media_sender/${core_id}
             ...
             # FatFS config
             middleware/edgefast_open/examples/broadcast_media_sender/modules
)
...
mcux_add_armgcc_linker_script(
  BASE_PATH ${SdkRootDirPath}
  LINKER examples/_boards/${board}/coex_examples/coex_wifi_bms_open/linker/gcc/${core_id}.ld
  TARGETS
    flexspi_nor_debug
    flexspi_nor_release
)
...
mcux_add_iar_linker_script(
  BASE_PATH ${SdkRootDirPath}
  LINKER middleware/edgefast_open/examples/_boards/${board}/broadcast_media_sender/linker/iar/MIMXRT1176xxxxx_cm7_flexspi_nor.icf
  TARGETS
    flexspi_nor_debug
    flexspi_nor_release
)
mcux_add_mdk_linker_script(
  BASE_PATH ${SdkRootDirPath}
  LINKER middleware/edgefast_open/examples/_boards/${board}/broadcast_media_sender/linker/arm/${core_id}_flexspi.scf
  TARGETS
    flexspi_nor_debug
    flexspi_nor_release
)
