...
Before building the example application define Wi-Fi module in the `_boards/evkbmimxrt1170/coex_examples/coex_wifi_peripheral_ht/cm7/prj.conf`.
...
```bash
$ cd <sdk root>
$ west build -b evkbmimxrt1170 examples/coex_examples/coex_wifi_peripheral_ht --toolchain armgcc --config=flexspi_nor_debug -Dcore_id=cm7 -d coex_wifi_peripheral_ht
```

> flexspi_nor_release:
```bash
$ cd <sdk root>
$ west build -b evkbmimxrt1170 examples/coex_examples/coex_wifi_peripheral_ht --toolchain armgcc --config=flexspi_nor_release -Dcore_id=cm7 -d coex_wifi_peripheral_ht
```

**NOTE:**

> 1. ```-d coex_wifi_peripheral_ht``` -> Specify the generated project path. Can name it as needed.
> 2. Find coex_wifi_peripheral_ht_cm7.elf/coex_wifi_peripheral_ht_cm7.bin in coex_wifi_peripheral_ht folder.
...
J-Link> loadbin C:\xxx\coex_wifi_peripheral_ht_cm7.bin, 0x30000400
```
