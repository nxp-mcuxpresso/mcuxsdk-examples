...
mcux_add_source(
  ...
  SOURCES
    ...
    middleware/edgefast_open/examples/_boards/${board}/unicast_media_receiver/${core_id}/hardware_init.c
    ...
    # BT sources (from edgefast_open unicast_media_receiver board reconfig)
    middleware/edgefast_open/examples/_boards/${board}/configs/freertos/FreeRTOSConfig.h
    middleware/edgefast_open/examples/_boards/${board}/unicast_media_receiver/${core_id}/pin_mux.c
    middleware/edgefast_open/examples/_boards/${board}/unicast_media_receiver/${core_id}/pin_mux.h
...
mcux_add_source(
    ...
    CONFIG True
    PREINCLUDE TRUE
    SOURCES ${board_root}/${board}/coex_examples/coex_wifi_umr_open/cm7/app_config.h
)
...
mcux_add_include(
    ...
    INCLUDES ${board_root}/${board}
             ${board_root}/${board}/coex_examples/coex_wifi_umr_open/cm7
             ...
             # BT includes (from edgefast_open unicast_media_receiver board reconfig)
             middleware/edgefast_open/examples/_boards/${board}/configs/freertos
             middleware/edgefast_open/examples/_boards/${board}/unicast_media_receiver/${core_id}
...
mcux_add_armgcc_linker_script(
  BASE_PATH ${SdkRootDirPath}
  LINKER examples/_boards/${board}/coex_examples/coex_wifi_umr_open/linker/gcc/${core_id}.ld
  TARGETS
    flexspi_nor_debug
    flexspi_nor_release
)
