...
void BOARD_InitHardware(void)
{
    ...
    /* PHY reset */
    BOARD_EXPANDER_SetPinAsOutput(BOARD_PCAL6524_I2C3_ID, ETH0_RST_B);
    BOARD_EXPANDER_SetPinAsOutput(BOARD_PCAL6524_I2C3_ID, ETH1_RST_B);
    BOARD_EXPANDER_SetPinAsOutput(BOARD_PCAL6524_I2C3_ID, ETH2_RST_B);
    BOARD_EXPANDER_SetPinAsOutput(BOARD_PCAL6524_I2C3_ID, ETH3_RST_B);

    BOARD_EXPANDER_SetPinToLow(BOARD_PCAL6524_I2C3_ID, ETH0_RST_B);
    SDK_DelayAtLeastUs(20000, SDK_DEVICE_MAXIMUM_CPU_CLOCK_FREQUENCY);
    BOARD_EXPANDER_SetPinToHigh(BOARD_PCAL6524_I2C3_ID, ETH0_RST_B);
    SDK_DelayAtLeastUs(100000, SDK_DEVICE_MAXIMUM_CPU_CLOCK_FREQUENCY);

    BOARD_EXPANDER_SetPinToLow(BOARD_PCAL6524_I2C3_ID, ETH1_RST_B);
    SDK_DelayAtLeastUs(20000, SDK_DEVICE_MAXIMUM_CPU_CLOCK_FREQUENCY);
    BOARD_EXPANDER_SetPinToHigh(BOARD_PCAL6524_I2C3_ID, ETH1_RST_B);
    SDK_DelayAtLeastUs(100000, SDK_DEVICE_MAXIMUM_CPU_CLOCK_FREQUENCY);

    BOARD_EXPANDER_SetPinToLow(BOARD_PCAL6524_I2C3_ID, ETH2_RST_B);
    SDK_DelayAtLeastUs(20000, SDK_DEVICE_MAXIMUM_CPU_CLOCK_FREQUENCY);
    BOARD_EXPANDER_SetPinToHigh(BOARD_PCAL6524_I2C3_ID, ETH2_RST_B);
    SDK_DelayAtLeastUs(100000, SDK_DEVICE_MAXIMUM_CPU_CLOCK_FREQUENCY);

    BOARD_EXPANDER_SetPinToLow(BOARD_PCAL6524_I2C3_ID, ETH3_RST_B);
    SDK_DelayAtLeastUs(20000, SDK_DEVICE_MAXIMUM_CPU_CLOCK_FREQUENCY);
    BOARD_EXPANDER_SetPinToHigh(BOARD_PCAL6524_I2C3_ID, ETH3_RST_B);
    SDK_DelayAtLeastUs(100000, SDK_DEVICE_MAXIMUM_CPU_CLOCK_FREQUENCY);
...
void APP_LOW_POWER_MODE(void)
{
    ...
    ret = SCMI_CpuPdLpmConfigSet(SCMI_A2P, SYSTEM_PLATFORM_M33S_ID, 1U, lpmConfig);
    if (ret != 0)
    {
