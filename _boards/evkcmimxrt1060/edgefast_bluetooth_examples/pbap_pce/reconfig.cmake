...
#           examples/_boards/${board}/edgefast_bluetooth_examples/pbap_pce/app_bluetooth_config.h
            ${board_root}/${board}/sdmmc_config.c
            ${board_root}/${board}/sdmmc_config.h
            ${board_root}/${board}/wifi_bt_config.c
            ${board_root}/${board}/wifi_bt_config.h
            examples/_boards/${board}/edgefast_bluetooth_examples/pbap_pce/hardware_init.c
            examples/_boards/${board}/edgefast_bluetooth_examples/pbap_pce/pin_mux.c
            examples/_boards/${board}/edgefast_bluetooth_examples/pbap_pce/pin_mux.h
...
mcux_add_include(
    ...
    INCLUDES examples/_boards/${board}/edgefast_bluetooth_examples/configs
             examples/_boards/${board}/edgefast_bluetooth_examples/pbap_pce
...
mcux_add_iar_linker_script(
    BASE_PATH ${SdkRootDirPath}
    TARGETS flexspi_nor_debug flexspi_nor_release
    LINKER examples/_boards/${board}/edgefast_bluetooth_examples/pbap_pce/linker/iar/MIMXRT1062xxxxx_flexspi_nor.icf
)
mcux_add_mdk_linker_script(
    BASE_PATH ${SdkRootDirPath}
    TARGETS flexspi_nor_debug flexspi_nor_release
    LINKER examples/_boards/${board}/edgefast_bluetooth_examples/pbap_pce/linker/arm/MIMXRT1062xxxxx_flexspi_nor.scf
)
mcux_add_armgcc_linker_script(
    BASE_PATH ${SdkRootDirPath}
    TARGETS flexspi_nor_debug flexspi_nor_release
    LINKER examples/_boards/${board}/edgefast_bluetooth_examples/pbap_pce/linker/gcc/MIMXRT1062xxxxx_flexspi_nor.ld
)
