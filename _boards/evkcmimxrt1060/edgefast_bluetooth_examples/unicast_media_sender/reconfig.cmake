mcux_add_source(
  ...
  SOURCES
    ...
    examples/_boards/${board}/edgefast_bluetooth_examples/unicast_media_sender/board.c
    examples/_boards/${board}/edgefast_bluetooth_examples/unicast_media_sender/board.h
...
mcux_add_source(
  BASE_PATH ${SdkRootDirPath}
  SOURCES examples/_boards/${board}/edgefast_bluetooth_examples/unicast_media_sender/startup/iar/startup_MIMXRT1062.s
  TOOLCHAINS iar
)

mcux_add_source(
  BASE_PATH ${SdkRootDirPath}
  SOURCES examples/_boards/${board}/edgefast_bluetooth_examples/unicast_media_sender/startup/gcc/startup_MIMXRT1062.S
  TOOLCHAINS armgcc
)

mcux_add_source(
  BASE_PATH ${SdkRootDirPath}
  SOURCES examples/_boards/${board}/edgefast_bluetooth_examples/unicast_media_sender/startup/arm/startup_MIMXRT1062.S
  TOOLCHAINS mdk
)
mcux_add_include(
  BASE_PATH ${SdkRootDirPath}
  INCLUDES
    ...
    examples/_boards/${board}/edgefast_bluetooth_examples/unicast_media_sender
...
mcux_add_iar_linker_script(
  BASE_PATH ${SdkRootDirPath}
  LINKER examples/_boards/${board}/edgefast_bluetooth_examples/unicast_media_sender/linker/iar/MIMXRT1062xxxxx_flexspi_nor.icf
  TARGETS
    flexspi_nor_debug
    flexspi_nor_release
)
mcux_add_mdk_linker_script(
  BASE_PATH ${SdkRootDirPath}
  LINKER examples/_boards/${board}/edgefast_bluetooth_examples/unicast_media_sender/linker/arm/MIMXRT1062xxxxx_flexspi_nor.scf
  TARGETS
    flexspi_nor_debug
    flexspi_nor_release
)
mcux_add_armgcc_linker_script(
  BASE_PATH ${SdkRootDirPath}
  LINKER examples/_boards/${board}/edgefast_bluetooth_examples/unicast_media_sender/linker/gcc/MIMXRT1062xxxxx_flexspi_nor.ld
  TARGETS
    flexspi_nor_debug
    flexspi_nor_release
)
