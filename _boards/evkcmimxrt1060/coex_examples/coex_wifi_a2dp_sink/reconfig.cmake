...
mcux_add_source(
    ...
    SOURCES components/wifi_bt_module/incl/wifi_bt_module_config.h
            ...
            ${board_root}/${board}/coex_examples/coex_wifi_a2dp_sink/hardware_init.c
            ${board_root}/${board}/coex_examples/coex_wifi_a2dp_sink/pin_mux.c
            ${board_root}/${board}/coex_examples/coex_wifi_a2dp_sink/pin_mux.h
...
mcux_add_source(
    ...
    CONFIG True
    PREINCLUDE TRUE
    SOURCES ${board_root}/${board}/coex_examples/coex_wifi_a2dp_sink/app_config.h
)
...
mcux_add_include(
    ...
    INCLUDES ${board_root}/${board}
             ...
             ${board_root}/${board}/coex_examples/coex_wifi_a2dp_sink
             ...
             examples/coex_examples/coex_wifi_a2dp_sink
