...
mcux_add_source(
    ...
    SOURCES components/wifi_bt_module/incl/wifi_bt_module_config.h
            ...
            ${board_root}/${board}/coex_examples/coex_wifi_a2dp_source/pin_mux.c
            ${board_root}/${board}/coex_examples/coex_wifi_a2dp_source/pin_mux.h
...
mcux_add_include(
    ...
    INCLUDES ${board_root}/${board}
             ...
             ${board_root}/${board}/coex_examples/coex_wifi_a2dp_source
