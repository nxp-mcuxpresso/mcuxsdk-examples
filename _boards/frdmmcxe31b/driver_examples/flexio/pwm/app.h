...
#define DEMO_FLEXIO_OUTPUTPIN                 (6U) /* Select FXIO_D6 as PWM output */
#define DEMO_FLEXIO_TIMER_CH                  (0U) /* Flexio timer0 used */

#define DEMO_FLEXIO_CLOCK_FREQUENCY CLOCK_GetFreq(kCLOCK_FlexioClk)
/* FLEXIO output PWM frequency */
#define DEMO_FLEXIO_FREQUENCY (480000U)
/*${macro:end}*/
