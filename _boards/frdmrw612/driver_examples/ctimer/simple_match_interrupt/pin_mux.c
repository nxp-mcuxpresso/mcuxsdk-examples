...
- pin_list:
  ...
  - {pin_num: N2, peripheral: CTIMER0, signal: 'MATCH, 1', pin_signal: GPIO_1}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    /* Initialize CT0_MAT1_OUT functionality on pin GPIO_1 (pin N2) */
    IO_MUX_SetPinMux(IO_MUX_CT0_MAT1_OUT);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
