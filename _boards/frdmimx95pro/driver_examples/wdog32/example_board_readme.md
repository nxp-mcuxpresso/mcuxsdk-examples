...
1.  Build the project and generate the flash.bin file of single boot or low power boot.
    Refer to the 'Getting Started with MCUXpresso SDK for FRDM-IMX95.pdf'.
...
3.  Download flash.bin into sd/emmc/flash with uuu.
    Refer to 'Getting Started with MCUXpresso SDK for FRDM-IMX95.pdf'
4.  Open a serial terminal with the following settings:
    ...
    - One stop bit
    - No flow control
5.  Switch the SW4 to re-power the board.
