...
#define BOARD_DEBUG_UART_INSTANCE 7

#define BOARD_DEBUG_UART_INSTANCE_FOR_CM7_WITH_SM 7U
#define BOARD_DEBUG_UART_CLOCK_ROOT_FOR_CM7_WITH_SM hal_clock_lpuart7
#define BOARD_DEBUG_UART_CLK_FREQ_FOR_CM7_WITH_SM   HAL_ClockGetRate(BOARD_DEBUG_UART_CLOCK_ROOT_FOR_CM7_WITH_SM)

#define BOARD_DEBUG_UART_INSTANCE_FOR_CM7_WITHOUT_SM 7U
#define BOARD_DEBUG_UART_CLOCK_ROOT_FOR_CM7_WITHOUT_SM hal_clock_lpuart7
#define BOARD_DEBUG_UART_CLK_FREQ_FOR_CM7_WITHOUT_SM   HAL_ClockGetRate(BOARD_DEBUG_UART_CLOCK_ROOT_FOR_CM7_WITHOUT_SM)

#define BOARD_DEBUG_UART_INSTANCE_FOR_CM33_WITHOUT_SM 7U
#define BOARD_DEBUG_UART_CLOCK_ROOT_FOR_CM33_WITHOUT_SM hal_clock_lpuart7
#define BOARD_DEBUG_UART_CLK_FREQ_FOR_CM33_WITHOUT_SM   HAL_ClockGetRate(BOARD_DEBUG_UART_CLOCK_ROOT_FOR_CM33_WITHOUT_SM)

#define BOARD_DEBUG_UART_CLOCK_ROOT hal_clock_lpuart7
...
#define BOARD_PCAL6524_CH_SPI_SEL     (0x2U)
#define BOARD_PCAL6524_CAN_STBY       (0x7U)
#define BOARD_PCAL6524_CH_CAN_SEL     (0x4U)
#define BOARD_PCAL6524_EXT_5V0_PWR_EN (0x8U + 0x4U)
