...
mcux_add_include(
    BASE_PATH ${SdkRootDirPath}
    INCLUDES ${board_root}/imx95verdinevk
             middleware/multicore/remoteproc
	     ${board_root}/imx95verdinevk/cm7
             ${board_root}/imx95verdinevk/multicore_examples/rpmsg_lite_str_echo_rtos
             ${board_root}/imx95verdinevk/multicore_examples/rpmsg_lite_str_echo_rtos/remote
	     ${board_root}/imx95verdinevk/multicore_examples/rpmsg_lite_str_echo_rtos/remote/cm7
)
