...
- options: {callFromInitBoot: 'false', coreID: cm7}
- pin_list:
  - {pin_num: K52, peripheral: GPIO2, signal: 'gpio_io_bit, 3', pin_signal: GPIO_IO03, DSE: X4}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
- options: {callFromInitBoot: 'false', coreID: cm7}
- pin_list:
  - {pin_num: N49, peripheral: FLEXIO1, signal: 'flexio_flexio_bit, 13', pin_signal: GPIO_IO13, OD: ENABLED, PD: DISABLED, DSE: X4}
  - {pin_num: P52, peripheral: FLEXIO1, signal: 'flexio_flexio_bit, 18', pin_signal: GPIO_IO18, OD: ENABLED, PD: DISABLED}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
void BOARD_InitFLEXIOPins(void) {                          /*!< Function assigned for the core: Cortex-M7F[cm7] */
    HAL_PinctrlSetPinMux(HAL_PINCTRL_PLATFORM_IOMUXC_PAD_GPIO_IO13__FLEXIO1_FLEXIO_BIT13, 0U);
    HAL_PinctrlSetPinCfg(HAL_PINCTRL_PLATFORM_IOMUXC_PAD_GPIO_IO13__FLEXIO1_FLEXIO_BIT13, 
                        HAL_PINCTRL_PLATFORM_IOMUXC_PAD_DSE(15U) |
                        HAL_PINCTRL_PLATFORM_IOMUXC_PAD_FSEL1(2U) |
                        HAL_PINCTRL_PLATFORM_IOMUXC_PAD_OD_MASK);
    HAL_PinctrlSetPinMux(HAL_PINCTRL_PLATFORM_IOMUXC_PAD_GPIO_IO18__FLEXIO1_FLEXIO_BIT18, 0U);
