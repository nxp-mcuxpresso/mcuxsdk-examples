...
- pin_list:
  ...
  - {pin_num: R13, peripheral: CTIMER7, signal: 'MATCH, 0', pin_signal: PIO8_31/LP_FLEXCOMM20_P1/CTIMER7_MAT0}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t port8_pin31_config = (/* Pin is configured as CTIMER7_MAT0 */
                                         IOPCTL_PIO_FUNC2 |
                                         /* Disable pull-up / pull-down function */
                                         IOPCTL_PIO_PUPD_DI |
                                         /* Enable pull-down function */
                                         ...
                                         /* Input function is not inverted */
                                         IOPCTL_PIO_INV_DI);
    /* PORT8 PIN31 (coords: R13) is configured as CTIMER7_MAT0 */
    IOPCTL_PinMuxSet(8U, 31U, port8_pin31_config);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
