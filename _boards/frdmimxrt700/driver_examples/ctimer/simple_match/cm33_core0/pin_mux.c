...
- pin_list:
  - {pin_num: R3, peripheral: CTIMER2, signal: 'MATCH, 3', pin_signal: PIO1_13/LP_FLEXCOMM2_P4/UTICK0_CAP1/CTIMER2_MAT3/SWD_TRACEDATA2/32KHZ_CLKOUT}
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t port1_pin13_config = (/* Pin is configured as CTIMER2_MAT3 */
                                         ...
                                         /* Selects transmitter current drive 100ohm */
                                         IOPCTL_PIO_DRIVE_100OHM);
    /* PORT1 PIN13 (coords: R3) is configured as CTIMER2_MAT3 */
