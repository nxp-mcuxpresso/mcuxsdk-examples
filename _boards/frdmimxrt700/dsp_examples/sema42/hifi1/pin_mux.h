...
/*! @name PIO8_6 (coord T13), PWM_RED_LED
  @{ */
/* Routed pin properties */
#define BOARD_INITPINS_LED_RED_PERIPHERAL GPIO8         /*!<@brief Peripheral name */
#define BOARD_INITPINS_LED_RED_SIGNAL IO                /*!<@brief Signal name */
#define BOARD_INITPINS_LED_RED_CHANNEL 6                /*!<@brief Signal channel */
#define BOARD_INITPINS_LED_RED_PORT 8U                  /*!<@brief PORT peripheral base pointer */
