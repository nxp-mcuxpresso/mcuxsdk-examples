...
#define DSP_IMAGE_LITERAL_SIZE \
    (uint32_t) __section_end("__dsp_literal_section") - (uint32_t)__section_begin("__dsp_literal_section");
#define DSP_IMAGE_VECTOR_START (uint32_t *)__section_begin("__dsp_vector_section")
#define DSP_IMAGE_VECTOR_SIZE \
    (uint32_t) __section_end("__dsp_vector_section") - (uint32_t)__section_begin("__dsp_vector_section");
#define DSP_IMAGE_TEXT_START (uint32_t *)__section_begin("__dsp_text_section")
#define DSP_IMAGE_TEXT_SIZE \
    (uint32_t) __section_end("__dsp_text_section") - (uint32_t)__section_begin("__dsp_text_section");
#define DSP_IMAGE_DATA_START (uint32_t *)__section_begin("__dsp_data_section")
#define DSP_IMAGE_DATA_SIZE \
    (uint32_t) __section_end("__dsp_data_section") - (uint32_t)__section_begin("__dsp_data_section");
#ifdef DSP_NCACHE
#define DSP_IMAGE_NCACHE_START (uint32_t *)__section_begin("__dsp_ncache_section")
#define DSP_IMAGE_NCACHE_SIZE \
    (uint32_t) __section_end("__dsp_ncache_section") - (uint32_t)__section_begin("__dsp_ncache_section");
#endif
...
#define DSP_IMAGE_VECTOR_START  ((uint32_t *)dsp_vector_image_start)
#define DSP_IMAGE_VECTOR_SIZE   ((uint32_t)dsp_vector_image_size)
#define DSP_IMAGE_TEXT_START    ((uint32_t *)dsp_text_image_start)
#define DSP_IMAGE_TEXT_SIZE     ((uint32_t)dsp_text_image_size)
#define DSP_IMAGE_DATA_START    ((uint32_t *)dsp_data_image_start)
#define DSP_IMAGE_DATA_SIZE     ((uint32_t)dsp_data_image_size)
#ifdef DSP_NCACHE
#define DSP_IMAGE_NCACHE_START ((uint32_t *)dsp_ncache_image_start)
#define DSP_IMAGE_NCACHE_SIZE  ((uint32_t)dsp_ncache_image_size)
#endif
#endif
/*******************************************************************************
 * API
