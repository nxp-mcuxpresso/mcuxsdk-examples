...
#define BOARD_NAME "FRDM-IMXRT700"
...
#define BOARD_BT_UART_CLK_FREQ     CLOCK_GetLPFlexCommClkFreq(2U)
#define BOARD_BT_UART_CLK_ATTACH   kFCCLK1_to_FLEXCOMM2
...
#define BOARD_BT_UART_IRQ_HANDLER  LP_FLEXCOMM2_IRQHandler
#define BOARD_BT_UART_IRQ          LP_FLEXCOMM2_IRQn
...
#define BOARD_MIPI_PANEL_TOUCH_RST_GPIO       GPIO1
#define BOARD_MIPI_PANEL_TOUCH_RST_PIN        6
#define BOARD_MIPI_PANEL_TOUCH_INT_GPIO       GPIO0
#define BOARD_MIPI_PANEL_TOUCH_INT_PIN        20
#define BOARD_MIPI_TOUCH_INT_GPIO_IRQ         GPIO00_IRQn
#define BOARD_MIPI_TOUCH_INT_GPIO_IRQ_Handler GPIO00_IRQHandler
...
#define BOARD_CODEC_I2C_CLOCK_FREQ CLOCK_GetLPI2cClkFreq(3)
#define BOARD_CODEC_I2C_INSTANCE   3

#define BOARD_CODEC_I2C_SCL_PIN  17U
#define BOARD_CODEC_I2C_SDA_PIN  18U
...
#define ERPC_BOARD_LPI2C_BASEADDR LPI2C3_BASE
#define ERPC_BOARD_LPI2C_BAUDRATE 100000U
#define ERPC_BOARD_LPI2C_CLKSRC   kCLOCK_Flexcomm3
#define ERPC_BOARD_LPI2C_CLK_FREQ CLOCK_GetLPFlexCommClkFreq(3u)
 ...
 */
#define BOARD_Codec_I2C_ReleaseBus() BOARD_I2C_ReleaseBus(3)
#endif
