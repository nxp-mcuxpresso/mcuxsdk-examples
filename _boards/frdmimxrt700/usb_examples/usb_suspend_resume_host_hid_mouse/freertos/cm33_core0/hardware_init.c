...
#define APP_DEEPSLEEP_SLEEPCFG                                                                                  \
    (SLEEPCON0_SLEEPCFG_PLLANA_PD_MASK | SLEEPCON0_SLEEPCFG_PLLLDO_PD_MASK | SLEEPCON0_SLEEPCFG_LPOSC_PD_MASK | \
...
#define APP_DEEPSLEEP_PDSLEEPCFG4                                                                       \
    (PMC_PDSLEEPCFG4_CPU0_CCACHE_MASK | PMC_PDSLEEPCFG4_CPU0_SCACHE_MASK | PMC_PDSLEEPCFG4_OCOTP_MASK | \
     PMC_PDSLEEPCFG4_USB0_SRAM_MASK | PMC_PDSLEEPCFG4_USB1_SRAM_MASK)
