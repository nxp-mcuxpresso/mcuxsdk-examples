...
MEMORY
{
  dsp_core_seg :                      	org = 0x20400000, len = 0xe0000
  dsp_core_ncache_seg :               	org = 0x204e0000, len = 0xa0000
...
PHDRS
{
  ...
  dsp_core_ncache_phdr PT_LOAD;
  dsp_core_ncache_bss_phdr PT_LOAD;
...
SECTIONS
{
  ...
  } >dsp_core_ncache_seg :dsp_core_ncache_phdr
