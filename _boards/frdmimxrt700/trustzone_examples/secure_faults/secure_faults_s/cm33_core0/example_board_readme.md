...
Address that caused secure bus violation is 0x20200000.

Additional AHB secure controller error information:
Secure error at AHB layer 9.
Address that caused secure violation is 0x2020000C.
...
Flash target:
    1. secure binary download into 0x38000000 address.
