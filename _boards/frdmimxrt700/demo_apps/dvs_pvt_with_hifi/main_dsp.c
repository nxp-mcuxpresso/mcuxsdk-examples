...
#if defined(PMC0)
#ifndef DEMO_LED_GPIO
#define DEMO_LED_GPIO BOARD_LED_BLUE_GPIO
#endif
#ifndef DEMO_LED_GPIO_PIN
#define DEMO_LED_GPIO_PIN BOARD_LED_BLUE_GPIO_PIN
#endif
#else
#ifndef DEMO_LED_GPIO
...
int main(void)
{
    ...
    GPIO_PinInit(DEMO_LED_GPIO, DEMO_LED_GPIO_PIN, &led_config);
#endif
