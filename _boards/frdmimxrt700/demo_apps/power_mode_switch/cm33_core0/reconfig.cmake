...
mcux_add_iar_linker_script(
    BASE_PATH ${SdkRootDirPath}
    TARGETS debug release
    LINKER ${board_root}/${board}/demo_apps/power_mode_switch/${multicore_foldername}/linker/MIMXRT798Sxxxx_cm33_core0_ram.icf
)
mcux_add_mdk_linker_script(
    BASE_PATH ${SdkRootDirPath}
    TARGETS debug release
    LINKER ${board_root}/${board}/demo_apps/power_mode_switch/${multicore_foldername}/linker/MIMXRT798Sxxxx_cm33_core0_ram.scf
)
mcux_add_armgcc_linker_script(
    BASE_PATH ${SdkRootDirPath}
    TARGETS debug release
    LINKER ${board_root}/${board}/demo_apps/power_mode_switch/${multicore_foldername}/linker/MIMXRT798Sxxxx_cm33_core0_ram.ld
)