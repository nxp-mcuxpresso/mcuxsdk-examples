...
- pin_list:
  ...
  - {pin_num: V23, peripheral: GPIO0, signal: 'GPIO, 10', pin_signal: PIO0_10/LP_FLEXCOMM5_P0/SCT0_GPIN4/SCT0_OUT4/CTIMER1_MAT0/CTIMER_C_INP0/SAI2_RX_DATA, input_buffer: enable}
