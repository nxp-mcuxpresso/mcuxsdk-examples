...
void APP_SetTrdcAccessible(void)
{
    ...
    *(volatile uint32_t *)0x400E8000 = 0x00060000;
    *(volatile uint32_t *)0x400E8000 = 0x0002000F;
    *(volatile uint32_t *)0x400E8000 = 0x0001000F;
    *(volatile uint32_t *)0x400E8004 = 0x00290000;
    *(volatile uint32_t *)0x400E8000 = 0x0002000F;
    *(volatile uint32_t *)0x400E8004 = 0x00280000;
    *(volatile uint32_t *)0x400E8000 = 0x0000000F;
}
...
void APP_SetTrdcGlobalConfig(void)
{
    ...
    *(volatile uint32_t *)0x400C9020 = 0x00007777;
    *(volatile uint32_t *)0x400C9040 = 0x00000000;
    *(volatile uint32_t *)0x400C9044 = 0x00000000;
    *(volatile uint32_t *)0x400C9048 = 0x00000000;
    *(volatile uint32_t *)0x400C904C = 0x00000000;
    *(volatile uint32_t *)0x400C9050 = 0x00000000;
    *(volatile uint32_t *)0x400C9054 = 0x00000000;
    *(volatile uint32_t *)0x400C9058 = 0x00000000;
    *(volatile uint32_t *)0x400C905C = 0x00000000;
    
    *(volatile uint32_t *)0x400C9060 = 0x00000000;
    *(volatile uint32_t *)0x400C9064 = 0x00000000;
    *(volatile uint32_t *)0x400C9068 = 0x00000000;
    *(volatile uint32_t *)0x400C906C = 0x00000000;
    *(volatile uint32_t *)0x400C9070 = 0x00000000;
    *(volatile uint32_t *)0x400C9074 = 0x00000000;
    *(volatile uint32_t *)0x400C9078 = 0x00000000;
    *(volatile uint32_t *)0x400C907C = 0x00000000;
...
{
    /* Touch the memory. */
    (*(volatile uint32_t *)(16384U * EXAMPLE_TRDC_MBC_MEMORY_INDEX));
}
