...
#define MASTER_LPSPI_PCS_FOR_INIT     (kLPSPI_Pcs1)
#define MASTER_LPSPI_PCS_FOR_TRANSFER (kLPSPI_MasterPcs1)
#define MASTER_LPSPI_CLOCK_FREQUENCY  CLOCK_GetLpspiClkFreq(2U)
