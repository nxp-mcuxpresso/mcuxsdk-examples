...
/* TRDC MDAC instance index */
#define TRDC_MDAC0_INDEX                         (0) /* T-MADC0 - MDA_W0_0_DFMT0 */
#define TRDC_MDAC1_INDEX                         (1) /* T-MADC1 - MDA_W0_1_DFMT1 */
#define TRDC_MDAC2_INDEX                         (2) /* T-MADC2 - MDA_W0_2_DFMT1 */
#define TRDC_MDAC3_INDEX                         (3) /* T-MADC3 - MDA_W0_3_DFMT1 */
#define TRDC_MDAC4_INDEX                         (4) /* T-MADC4 - MDA_W0_4_DFMT1 */
#define TRDC_MDAC5_INDEX                         (5) /* T-MADC5 - MDA_W0_5_DFMT1 */
#define TRDC_MDAC6_INDEX                         (6) /* T-MADC6 - MDA_W0_6_DFMT1 */
#define TRDC_MDAC7_INDEX                         (7) /* T-MADC7 - MDA_W0_7_DFMT1 */

/* TRDC MRC instance index */
#define TRDC_MRC0_INDEX                          (0) /* T-MRC0 */
#define TRDC_MRC1_INDEX                          (1) /* T-MRC1 */

/* TRDC access control policy index */
#define TRDC_MBC_ACCESS_CONTROL_POLICY_ALL_INDEX (0)
#define TRDC_MRC_ACCESS_CONTROL_POLICY_ALL_INDEX (0)

/* TRDC domain id(overwrite default domain id) */
#define TRDC_DMA0_DOMAIN_ID                      (0)
#define TRDC_DMA1_DOMAIN_ID                      (1)
#define TRDC_HIFI4_DSP_DOMAIN_ID                 (2)
#define TRDC_DCNANO_DOMAIN_ID                    (3)
#define TRDC_POWERQUAD_DOMAIN_ID                 (4)
#define TRDC_FUSION_DSP_DOMAIN_ID                (5)
#define TRDC_M33_DOMAIN_ID                       (6)
#define TRDC_A35_DOMAIN_ID                       (7)

/* Master's MDAC instance index(From bus architecture diagram in RM) */
#define TRDC_M33_MMAC_INST_INDEX                 TRDC_MDAC0_INDEX
#define TRDC_UPOWER_MDAC_INST_INDEX              TRDC_MDAC1_INDEX
#define TRDC_DMA0_MDAC_INST_INDEX                TRDC_MDAC2_INDEX
#define TRDC_FUSION_DSP_MDAC_INST_INDEX          TRDC_MDAC3_INDEX
#define TRDC_DAP_MDAC_INST_INDEX                 TRDC_MDAC4_INDEX
#define TRDC_TESTPORT_MDAC_INST_INDEX            TRDC_MDAC5_INDEX
#define TRDC_POWERQUAD_MDAC_INST_INDEX           TRDC_MDAC6_INDEX
#define TRDC_ETR_MDAC_INST_INDEX                 TRDC_MDAC7_INDEX
...
/* For i2c release bus */
#define I2C_MAX_INSTANCE_NUM 2
#define I2C0_RELEASE_SDA_GPIO  GPIOA
#define I2C0_RELEASE_SDA_PIN   9U
#define I2C0_RELEASE_SCL_GPIO  GPIOA
#define I2C0_RELEASE_SCL_PIN   8U
#define I2C0_RELEASE_SCL_PAD_USE_AS_GPIO_ARGS IOMUXC_PTA8_PTA8
#define I2C0_RELEASE_SDA_PAD_USE_AS_GPIO_ARGS IOMUXC_PTA9_PTA9
#define I2C0_RELEASE_SCL_PAD_USE_AS_SCL_ARGS IOMUXC_PTA8_LPI2C0_SCL
#define I2C0_RELEASE_SDA_PAD_USE_AS_SDA_ARGS IOMUXC_PTA9_LPI2C0_SDA

#define I2C1_RELEASE_SDA_GPIO  GPIOA
#define I2C1_RELEASE_SDA_PIN   13U
#define I2C1_RELEASE_SCL_GPIO  GPIOA
#define I2C1_RELEASE_SCL_PIN   12U
#define I2C_RELEASE_BUS_COUNT 100U
#define I2C1_RELEASE_SCL_PAD_USE_AS_GPIO_ARGS IOMUXC_PTA12_PTA12
#define I2C1_RELEASE_SDA_PAD_USE_AS_GPIO_ARGS IOMUXC_PTA13_PTA13
#define I2C1_RELEASE_SCL_PAD_USE_AS_SCL_ARGS IOMUXC_PTA12_LPI2C1_SCL
#define I2C1_RELEASE_SDA_PAD_USE_AS_SDA_ARGS IOMUXC_PTA13_LPI2C1_SDA
