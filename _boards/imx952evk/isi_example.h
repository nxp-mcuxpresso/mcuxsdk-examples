...
#define APP_MIPI_CSI2_PRIMARY                   ((PRIMARY_CSI2_CONTROLLER_Type *)APP_MIPI_CSI2_PRIMARY_BASE)
#define APP_MIPI_CSI2_SECONDARY_BASE            CAMERA__CSI_COMPLEX__SECONDARY_CSI2_CONTROLLER_BASE
#define APP_MIPI_CSI2_SECONDARY                 ((SECONDARY_CSI2_CONTROLLER_Type *)APP_MIPI_CSI2_SECONDARY_BASE)
