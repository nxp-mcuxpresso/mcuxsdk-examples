 ...
 ******************************************************************************/
/*${macro:start}*/
/* TDM and I2C instance and clock */
#define DEMO_TDM1             SAI6
#define DEMO_TDM2             SAI3
#define DEMO_AUDMIX           WAKEUP__AUDMIX1
#define DEMO_SAI_BITWIDTH     kSAI_WordWidth32bits
#define DEMO_SAI_CHANNEL_NUM  2U
#define DEMO_SAI_CHANNEL      kSAI_Channel0Mask
#define DEMO_SAI_TX_SYNC_MODE kSAI_ModeAsync
#define DEMO_SAI_MASTER_SLAVE kSAI_Master
#define DEMO_SAI_SAMPLE_RATE  kSAI_SampleRate48KHz
#define DEMO_CODEC_VOLUME     75

/* Get frequency of the shared audio TDM clock source. */
...
#define DEMO_TDM1_TX_SOURCE    Dma5RequestMuxSai6Tx
#define DEMO_TDM2_TX_SOURCE    Dma5RequestMuxSai3Tx

/* DMA */
#define DEMO_DMA               EDMA5_2
#define DEMO_EDMA_CHANNEL      2U
#define DEMO_SAI_EDMA_CHANNEL  Dma5RequestMuxSai6Tx
