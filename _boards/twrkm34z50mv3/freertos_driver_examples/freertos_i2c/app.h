...
#define EXAMPLE_I2C_MASTER_CLK_SRC  (kCLOCK_BusClk)
#define EXAMPLE_I2C_MASTER_CLK_FREQ CLOCK_GetFreq((kCLOCK_BusClk))
...
#define EXAMPLE_I2C_SLAVE_CLK_SRC  (kCLOCK_BusClk)
#define EXAMPLE_I2C_SLAVE_CLK_FREQ CLOCK_GetFreq((kCLOCK_BusClk))
