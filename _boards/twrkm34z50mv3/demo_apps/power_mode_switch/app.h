...
#define APP_DEBUG_UART_CLKSRC_NAME kCLOCK_CoreSysClk /* Sys clock. */

#define LLWU_LPTMR_IDX       0U                      /* LLWU_M0IF */
#define LLWU_WAKEUP_PIN_IDX  11U                     /* LLWU_P15 */
...
/* Debug console RX pin: PORTI0 MUX: 1 */
...
/* Debug console TX pin: PORTI1 MUX: 1 */
...
#define LPTMR0            LPTMR
#define LPTMR0_IRQn       LPTMR_IRQn
#define LPTMR0_IRQHandler LPTMR_IRQHandler
/*${macro:end}*/
