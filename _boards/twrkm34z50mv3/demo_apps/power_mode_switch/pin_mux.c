...
- pin_list:
  ...
  - {pin_num: '47', peripheral: GPIOD, signal: 'GPIO, 0', pin_signal: CMP0P0/PTD0/SCI0_RxD/PXBAR_IN2/LLWU_P11, slew_rate: fast, pull_select: up, pull_enable: enable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    const port_pin_config_t portd0_pin47_config = {/* Internal pull-up resistor is enabled */
                                                   kPORT_PullUp,
