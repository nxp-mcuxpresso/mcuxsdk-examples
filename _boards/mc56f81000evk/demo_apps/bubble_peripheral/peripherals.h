...
/* LPI2C1_MCR: RRF=1, RTF=1, DBGEN=0, DOZEN=0, MEN=1 */
#define LPI2C1_MCR_INIT 0x301U
/* LPI2C1_MIER: DMIE=0, PLTIE=0, FEIE=0, ALIE=0, NDIE=0, SDIE=0, EPIE=0, RDIE=0, TDIE=0 */
#define LPI2C1_MIER_INIT 0x0U
/* LPI2C1_MDER: RDDE=0, TDDE=0 */
#define LPI2C1_MDER_INIT 0x0U
/* LPI2C1_MCFGR0: RDMO=0, CIRFIFO=0, HRSEL=0, HRPOL=0, HREN=0 */
#define LPI2C1_MCFGR0_INIT 0x0U
/* LPI2C1_MCFGR1: FRCHS=0, PINCFG=0, TIMECFG=0, IGNACK=0, AUTOSTOP=0, MATCFG=0, PRESCALE=0 */
#define LPI2C1_MCFGR1_INIT 0x0U
/* LPI2C1_MCFGR2: BUSIDLE=0 */
#define LPI2C1_MCFGR2_INIT 0x0U
/* LPI2C1_MCFGR3: FILTSDA=0, FILTSCL=0 */
#define LPI2C1_MCFGR3_INIT 0x0U
/* LPI2C1_MCFGR4: PINLOW=0 */
#define LPI2C1_MCFGR4_INIT 0x0U
/* LPI2C1_MDMR: MATCH1=0, MATCH0=0 */
#define LPI2C1_MDMR_INIT 0x0U
/* LPI2C1_MCCR0: CLKHI=60, CLKLO=61 */
#define LPI2C1_MCCR0_INIT 0x3C3DU
/* LPI2C1_MCCR1: DATAVD=30, SETHOLD=30 */
#define LPI2C1_MCCR1_INIT 0x1E1EU
/* LPI2C1_MCCR2: CLKHI=21, CLKLO=25 */
#define LPI2C1_MCCR2_INIT 0x1519U
/* LPI2C1_MCCR3: DATAVD=10, SETHOLD=10 */
#define LPI2C1_MCCR3_INIT 0xA0AU
/* LPI2C1_MFCR: RXWATER=0, TXWATER=0 */
#define LPI2C1_MFCR_INIT 0x0U
