...
/* Definition of Expansion configuration ID 0 */
#define ADC_CONFIG_EXPA_0 0
/* Definition of Expansion configuration ID 1 */
#define ADC_CONFIG_EXPA_1 1
/* Definition of Expansion configuration ID 2 */
#define ADC_CONFIG_EXPA_2 2
/* Definition of Expansion configuration ID 3 */
#define ADC_CONFIG_EXPA_3 3
/* Definition of Expansion configuration ID 4 */
#define ADC_CONFIG_EXPA_4 4
/* Definition of Expansion configuration ID 5 */
#define ADC_CONFIG_EXPA_5 5
/* Definition of Expansion configuration ID 6 */
#define ADC_CONFIG_EXPA_6 6
/* Definition of Expansion configuration ID 7 */
#define ADC_CONFIG_EXPA_7 7
/* Definition of Expansion configuration ID 0 */
#define ADC_CONFIG_EXPB_0 0
/* Definition of Expansion configuration ID 1 */
#define ADC_CONFIG_EXPB_1 1
/* Definition of Expansion configuration ID 2 */
#define ADC_CONFIG_EXPB_2 2
/* Definition of Expansion configuration ID 3 */
#define ADC_CONFIG_EXPB_3 3
/* Definition of Expansion configuration ID 4 */
#define ADC_CONFIG_EXPB_4 4
/* Definition of Expansion configuration ID 5 */
#define ADC_CONFIG_EXPB_5 5
/* Definition of Expansion configuration ID 6 */
#define ADC_CONFIG_EXPB_6 6
/* Definition of Expansion configuration ID 7 */
#define ADC_CONFIG_EXPB_7 7
...
/* ADC_CLIST1: SAMPLE3=3, SAMPLE2=2, SAMPLE1=2, SAMPLE0=0 */
#define ADC_CLIST1_INIT 0x3220U
...
/* ADC_CAL: SEL_VREFH_B=0, SEL_VREFL_B=0, SEL_VREFH_A=0, SEL_VREFL_A=0, EXPOSE_MODE1=0, EXPOSE_MODE0=0 */
...
/* ADC_EXPMUX4A0: MSDIS3=0, MSDIS2=0, MSDIS1=0, MSDIS0=0 */
#define ADC_EXPMUX4A0_INIT 0x0U
/* ADC_EXPMUX4A1: MSDIS7=0, MSDIS6=0, MSDIS5=0, MSDIS4=0 */
#define ADC_EXPMUX4A1_INIT 0x0U
/* ADC_EXPMUX4B0: MSDIS3=0, MSDIS2=0, MSDIS1=0, MSDIS0=0 */
#define ADC_EXPMUX4B0_INIT 0x0U
/* ADC_EXPMUX4B1: MSDIS7=0, MSDIS6=0, MSDIS5=0, MSDIS4=0 */
...
#define PIT0_COUNTER_CLK_SOURCE_FREQ_HZ 97656U
/* Definition of the PIT0 counter roll-over frequency in Hertz */
#define PIT0_ROLLOVER_FREQ_HZ 996U
/* PIT0_CTRL: SLAVE=0, CLKSEL=0, PRESCALER=9, PRIE=1, CNT_EN=1 */
#define PIT0_CTRL_INIT 0x4BU
/* PIT0_MOD_L: MODULO_VALUE=98 */
#define PIT0_MOD_L_INIT 0x62U
...
/* PWMA_MCTRL: IPOL=0, RUN=7, LDOK=7 */
#define PWMA_MCTRL_INIT 0x707U
/* PWMA_MCTRL2: STRETCH_CNT_PRSC=0, WRPROT=0, MONPLL=0 */
