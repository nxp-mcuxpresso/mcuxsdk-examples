...
- name: BOARD_InitPeripherals
  UUID: dd24e774-bb93-44f4-a5ab-090885c340a3
    ...
    - cadcConfig:
      ...
      - expansion_config_a:
        ...
        - mux_aux_expansion_array:
          - 0:
            - sampleName: 'Config_ExpA_0'
            - stop_scan: 'false'
            - aux: '0'
          - 1:
            - sampleName: 'Config_ExpA_1'
            - stop_scan: 'false'
            - aux: '0'
          - 2:
            - sampleName: 'Config_ExpA_2'
            - stop_scan: 'false'
            - aux: '0'
          - 3:
            - sampleName: 'Config_ExpA_3'
            - stop_scan: 'false'
            - aux: '0'
          - 4:
            - sampleName: 'Config_ExpA_4'
            - stop_scan: 'false'
            - aux: '0'
          - 5:
            - sampleName: 'Config_ExpA_5'
            - stop_scan: 'false'
            - aux: '0'
          - 6:
            - sampleName: 'Config_ExpA_6'
            - stop_scan: 'false'
            - aux: '0'
          - 7:
            - sampleName: 'Config_ExpA_7'
            - stop_scan: 'false'
            - aux: '0'
      ...
      - expansion_config_b:
        ...
        - mux_aux_expansion_array:
          - 0:
            - sampleName: 'Config_ExpB_0'
            - stop_scan: 'false'
            - aux: '0'
          - 1:
            - sampleName: 'Config_ExpB_1'
            - stop_scan: 'false'
            - aux: '0'
          - 2:
            - sampleName: 'Config_ExpB_2'
            - stop_scan: 'false'
            - aux: '0'
          - 3:
            - sampleName: 'Config_ExpB_3'
            - stop_scan: 'false'
            - aux: '0'
          - 4:
            - sampleName: 'Config_ExpB_4'
            - stop_scan: 'false'
            - aux: '0'
          - 5:
            - sampleName: 'Config_ExpB_5'
            - stop_scan: 'false'
            - aux: '0'
          - 6:
            - sampleName: 'Config_ExpB_6'
            - stop_scan: 'false'
            - aux: '0'
          - 7:
            - sampleName: 'Config_ExpB_7'
            - stop_scan: 'false'
            - aux: '0'
    - channelConfig:
      - 0:
  ...
  - freemaster_config:
    ...
    - generalConfig:
      ...
      - FMSTR_CUSTOM_OPTIONS: '#ifdef DATA_IN_XFLASH\n// Target-side address translation (TSA)\n#define FMSTR_TSA_CDECL const __declspec(DATA_IN_XFLASH) __attribute__((far))\n#undef  FMSTR_USE_TSA\n#define
        FMSTR_USE_TSA           1   // Enable TSA functionality\n#endif // DATA_IN_XFLASH'
...
static void BOARD_InitPeripherals_CommonPostInit(void)
{
  ...
  /* Set the interrupt priority: Priority 0 of the kGPIOC_VECTORn request in the INTC. */
  INTC->IPR12 = (INTC->IPR12 & ~INTC_IPR12_GPIOC_MASK) | INTC_IPR12_GPIOC(1);
