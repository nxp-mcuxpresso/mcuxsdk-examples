...
- pin_list:
  ...
  - {pin_num: '49', peripheral: XBARA, signal: 'IN, 6', pin_signal: GPIOC13/TA3/XB_IN6/EWM_OUT_B, pull_enable: enable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    /* Enable peripheral functionality on pin GPIOC13 (pin 49) */
    GPIO_PinSetPeripheralMode(GPIOC, kGPIO_Pin13, kGPIO_ModePeripheral);
    /* Peripheral functionality on pin GPIOC13 (pin 49) */
