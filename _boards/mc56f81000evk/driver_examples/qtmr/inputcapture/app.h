...
#define DEMO_EDMA_CHANNEL      kEDMA_Channel0
#define DEMO_EDMA_CHANNEL_IRQn DMACH0_IRQn

#define EXAMPLE_QTMR_DMA_MUX           DMAMUX
#define DEMO_DMAMUX_CHANNEL            kDMAMUX_DMAChannel0
#define QTMR_EDMA_REQUEST_CMPLD_SOURCE kDmaRequestMuxTMRA0CaptureCompare1
