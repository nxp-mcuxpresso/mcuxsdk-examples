...
void BOARD_InitHardware(void)
{
    ...
    CLOCK_ConfigI2cClockSrc(kCLOCK_LPI2C0, kCLOCK_IPClkSrc_BusClk);
    CLOCK_ConfigI2cClockSrc(kCLOCK_LPI2C1, kCLOCK_IPClkSrc_BusClk);
    EnableIRQWithPriority(LPI2C0_IRQn, 1U);
    EnableIRQWithPriority(LPI2C1_IRQn, 2U);
