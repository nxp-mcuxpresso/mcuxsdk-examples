...
- pin_list:
  ...
  - {pin_num: '51', peripheral: LPI2C1, signal: SCL, pin_signal: GPIOE4/PWMA_2B/XB_IN2/LP_SCL1/XB_OUT8, open_drain: enable, pull_enable: enable}
  - {pin_num: '52', peripheral: LPI2C1, signal: SDA, pin_signal: GPIOE5/PWMA_2A/XB_IN3/LP_SDA1/XB_OUT9, open_drain: enable, pull_enable: enable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    GPIO_PinSetPeripheralMux(kGPIO_Peri_E4_LP_SCL1);
    ...
    GPIO_PinSetPeripheralMux(kGPIO_Peri_E5_LP_SDA1);
    ...
    /* Pull-Pull/Open drain output mode configuration: Open drain output mode */
    GPIO_PinSetOutputMode(BOARD_LED4_GPIO, BOARD_LED4_PIN_MASK, kGPIO_OutputOpenDrain);

    /* Pin configuration on GPIOE5 (pin 52) */
    /* Pull-Pull/Open drain output mode configuration: Open drain output mode */
    GPIO_PinSetOutputMode(BOARD_LED5_GPIO, BOARD_LED5_PIN_MASK, kGPIO_OutputOpenDrain);
    ...
    GPIOE->PUR = ((GPIOE->PUR &
                   /* Mask bits to zero which are setting */
                   (~(GPIO_PUR_PU_4_MASK | GPIO_PUR_PU_5_MASK)))

                  /* Pull Resistor Enable Bits: Pull resistor is enabled. */
                  | GPIO_PUR_PU(PUR_PU_4_ENABLED)
