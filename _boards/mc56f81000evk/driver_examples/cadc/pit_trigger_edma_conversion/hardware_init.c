...
void EDMA_Configuration(void)
{
    ...
    g_transferConfig1.u16MinorLoopCountsEachMajorLoop       = 16U;
    ...
    g_transferConfig0.i16SrcOffsetOfEachTransfer            = 0U;
    g_transferConfig0.i16DstOffsetOfEachTransfer            = 2U;
    ...
    g_transferConfig0.bEnableDstMinorLoopOffset             = true;
    g_transferConfig0.i32DstMajorLoopOffset                 = -32;
    g_transferConfig0.i32SrcMajorLoopOffset                 = 0U;
    g_transferConfig0.u16MinorLoopCountsEachMajorLoop       = 16U;
