...
- ahb:
  - regions: [{memory: PROGRAM_FLASH, security: s_priv, start: '0x00000000', size: '0x00010000'}, {memory: PROGRAM_FLASH, security: ns_user, start: '0x00010000',
    ...
    {memory: SRAM2, security: s_priv, start: '0x00000000', size: '0x00001000'}, {memory: SRAM2, security: ns_user, start: '0x00001000', size: '0x00003000'}, {memory: SRAM3,
  ...
  - peripherals: {ns_user: {id: [ADC0, AHB_SECURE_CTRL, ANACTRL, CAN0, CASPER, CRC_ENGINE, CTIMER0, CTIMER1, CTIMER2, CTIMER3, CTIMER4, DBGMAILBOX, DMA0, DMA1,
        ...
        PRINCE, PUF, RNG, RTC, SCT0, SECGPIO, SECPINT, SPI8, SYSCTL, UTICK0, WWDT]}, s_priv: {id: [FLEXCOMM0, IOCON, SYSCON]}}
  - interrupts:
    - masking: {}
...
- user_memory_regions: [{id: Region_1, security: s_priv, name: Secure Code, start: '0x10000000', size: '0x0000FE00'}, {id: Region_2, security: nsc_priv, name: Veneer
  ...
  {id: Region_5, security: ns_user, name: Non-secure Stack and Data, description: 'Privilege check is disabled so reset value (NS-User) can be used. ', start: '0x20008000',
    size: '0x00004000'}, {id: Region_6, security: s_priv, name: Wrong Non-secure Stack and Data, description: This region is configured to demonstrate misalignment  between
      SAU/IDAU and AHB secure controller configuration in test 5., start: '0x3000C000', size: '0x00001000'}, {id: Region_7, security: ns_user, name: Non-secure Stack
      and Data, description: 'Privilege check is disabled so reset value (NS-User) can be used. ', start: '0x2000D000', size: '0x00007000'}]
- mpus:
  - mpu:
    - enabled: 'false'
    - id: 's'
