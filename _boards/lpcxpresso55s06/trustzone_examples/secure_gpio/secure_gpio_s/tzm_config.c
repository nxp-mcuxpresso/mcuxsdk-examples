...
- ahb:
  - regions: [{memory: PROGRAM_FLASH, security: s_priv, start: '0x00000000', size: '0x00010000'}, {memory: PROGRAM_FLASH, security: ns_user, start: '0x00010000',
      ...
      size: '0x00004000'}, {memory: SRAM0, security: s_priv, start: '0x00000000', size: '0x00008000'}, {memory: SRAM1, security: ns_user, start: '0x00000000', size: '0x00004000'},
    {memory: SRAM2, security: ns_user, start: '0x00000000', size: '0x00004000'}, {memory: SRAM3, security: ns_user, start: '0x00000000', size: '0x00004000'}]
  - masters: {ns_user: {id: [CANFD, HASH, SDMA0, SDMA1]}}
  - peripherals: {ns_user: {id: [ADC0, AHB_SECURE_CTRL, ANACTRL, CAN0, CASPER, CRC_ENGINE, CTIMER0, CTIMER1, CTIMER2, CTIMER3, CTIMER4, DBGMAILBOX, DMA0, DMA1,
        FLASH, FLEXCOMM1, FLEXCOMM2, FLEXCOMM3, FLEXCOMM4, FLEXCOMM5, FLEXCOMM6, FLEXCOMM7, GINT0, GINT1, GPIO, HASHCRYPT, INPUTMUX, MRT0, OSTIMER, PINT, PLU, PMC,
        PRINCE, PUF, RNG, RTC, SCT0, SECPINT, SPI8, SYSCTL, UTICK0, WWDT]}, s_priv: {id: [FLEXCOMM0, IOCON, SECGPIO, SYSCON]}}
  - interrupts:
    - masking: {}
    - security: {Secure: {id: [ACMP_IRQn, ADC0_IRQn, CAN0_IRQ0_IRQn, CAN0_IRQ1_IRQn, CASER_IRQn, CTIMER0_IRQn, CTIMER1_IRQn, CTIMER2_IRQn, CTIMER3_IRQn, CTIMER4_IRQn,
          ...
          SEC_VIO_IRQn, UTICK0_IRQn, WDT_BOD_IRQn]}}
  - pins_masks:
    - pio0: {Non-masked: {id: ['0', '1', '10', '11', '12', '13', '14', '15', '16', '18', '19', '2', '20', '21', '22', '23', '24', '25', '26', '27', '28', '3', '31',
          '4', '6', '7', '8', '9']}, Masked: {id: ['29', '30', '5']}}
    - pio1: {Non-masked: {id: ['0', '1', '10', '11', '2', '21', '22', '23', '25', '29', '3', '4', '5', '9']}}
- sau:
  - enabled: 'true'
  ...
  - regions: [{index: '0', enabled: 'true', security: ns, start: '0x00000000', size: '0x10000000'}, {index: '1', enabled: 'true', security: ns, start: '0x20000000',
      size: '0xC0000000'}, {index: '2', enabled: 'false', security: nsc, start: '0x1000FE00', size: '0x00000200'}, {index: '3', enabled: 'false', security: ns, start: '0x00000000',
...
- global_options:
  - no:
    - id: [AIRCR_PRIS, AIRCR_BFHFNMINS, AIRCR_SYSRESETREQS, SCR_SLEEPDEEPS, SHCSR_SECUREFAULTENA, NSACR_CP2, NSACR_CP3, NSACR_CP4, NSACR_CP5, NSACR_CP6, NSACR_CP7,
      ...
      CPPWR_SU7, CPPWR_SUS7, CPPWR_SU10, CPPWR_SUS10, CPPWR_SU11, CPPWR_SUS11, SEC_GPIO_MASK0_LOCK, SEC_GPIO_MASK1_LOCK, MASTER_SEC_LEVEL_LOCK, CPU0_LOCK_NS_VTOR,
      CPU0_LOCK_NS_MPU, CPU0_LOCK_S_VTAIRCR, CPU0_LOCK_S_MPU, CPU0_LOCK_SAU, CPU0_LOCK_REG_LOCK, AHB_MISC_CTRL_REG_ENABLE_S_PRIV_CHECK, AHB_MISC_CTRL_REG_ENABLE_NS_PRIV_CHECK,
  ...
  - c_code:
    - id: [_output_type_]
- user_memory_regions: [{id: Region_1, security: s_priv, name: Secure Code, start: '0x10000000', size: '0x00010000'}, {id: Region_2, security: s_priv, name: Secure
      Stack and Data, start: '0x30000000', size: '0x00008000'}, {id: Region_3, security: ns_user, name: Non-secure Code, description: Privilege check is disabled
      so reset value (NS-User) can be used, start: '0x00010000', size: '0x00030000'}, {id: Region_4, security: ns_user, name: Non-secure Stack and Data, description: 'Privilege
      check is disabled so reset value (NS-User) can be used. ', start: '0x20008000', size: '0x0000C000'}]
- mpus:
  - mpu:
    - enabled: 'false'
    - id: 's'
...
void BOARD_InitTrustZone()
{
    ...
    */
    ...
    AHB_SECURE_CTRL->SEC_CTRL_APB_BRIDGE[0].SEC_CTRL_APB_BRIDGE1_MEM_CTRL3 = 0xFFCFCCFFU;
    AHB_SECURE_CTRL->SEC_CTRL_AHB_PORT7_SLAVE0_RULE                        = 0xCFCFFCFFU;
    AHB_SECURE_CTRL->SEC_CTRL_AHB_PORT7_SLAVE1_RULE                        = 0xFFFCFCCCU;
    AHB_SECURE_CTRL->SEC_CTRL_AHB_PORT8_SLAVE0_RULE                        = 0xCCCFFFFFU;
    AHB_SECURE_CTRL->SEC_CTRL_AHB_PORT8_SLAVE1_RULE                        = 0xCFCCFFFCU;
    AHB_SECURE_CTRL->SEC_CTRL_AHB_PORT9[0].SLAVE0_RULE                     = 0xCFCCFFFCU;
    AHB_SECURE_CTRL->SEC_CTRL_AHB_PORT9[0].SLAVE1_RULE                     = 0xFFFFFFCFU;
     ...
     *  0b0    Deny
     *  0b1    Allow */
    AHB_SECURE_CTRL->SEC_GPIO_MASK0 = 0x9FFFFFDFU;
