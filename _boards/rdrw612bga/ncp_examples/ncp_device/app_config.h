...
#define CONFIG_NCP_PRIORITY_OFFSET 2
#define IMU_TASK_PRIORITY (PRIORITY_RTOS_TO_OSA(((configMAX_PRIORITIES - CONFIG_NCP_PRIORITY_OFFSET) - 3)))
#define SERIAL_MANAGER_TASK_PRIORITY (PRIORITY_RTOS_TO_OSA(((configMAX_PRIORITIES - CONFIG_NCP_PRIORITY_OFFSET) - 2)))
