...
mcux_add_source(
  BASE_PATH "${SdkRootDirPath}"
  SOURCES
    "${board_root}/${board}/usb_examples/usb_device_audio_generator/bm/dmic_config.h"
    "${board_root}/${board}/usb_examples/usb_device_audio_generator/bm/hardware_init.c"
    "${board_root}/${board}/usb_examples/usb_device_audio_generator/bm/pin_mux.c"
    "${board_root}/${board}/usb_examples/usb_device_audio_generator/bm/pin_mux.h"
    "${board_root}/${board}/usb_examples/usb_device_audio_generator/bm/usb_audio_config.h"
    "examples/usb_examples/usb_device_audio_generator/bm/audio_data_dmic.c"
    "examples/usb_examples/usb_device_audio_generator/bm/audio_data_dmic.h"
)
