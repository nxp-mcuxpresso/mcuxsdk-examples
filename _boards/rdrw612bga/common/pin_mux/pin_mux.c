...
pin_labels:
- {pin_num: E7, pin_signal: GPIO_25, label: SW2, identifier: SW2}
...
- pin_list:
  ...
  - {pin_num: E7, peripheral: ENET, signal: ENET_REF_CLK, pin_signal: GPIO_25, identifier: ''}
  ...
  - {pin_num: G11, peripheral: ENET, signal: 'ENET_TX_DATA, 0', pin_signal: GPIO_58}
  - {pin_num: D12, peripheral: ENET, signal: 'ENET_TX_DATA, 1', pin_signal: GPIO_59}
...
{
    /* Initialize FC0_SPI_SS0 functionality on pin GPIO_3, GPIO_0, GPIO_4, GPIO_2 (pin C13_M1_F8_F10) */
...
{
    /* Initialize QUAD_SPI_FLASH functionality on pin GPIO_28, GPIO_34, GPIO_32, GPIO_33, GPIO_29, GPIO_31, GPIO_30
     * (pin F4_E3_F2_G3_D2_D3_F3) */
