...
/* Priority and stack size of the FreeMASTER communication task */
#define EXAMPLE_FMSTR_THREAD_PRIO      2
#define EXAMPLE_FMSTR_THREAD_STACKSIZE 1024

/* Priority and stack size of the FreeMASTER example task */
#define EXAMPLE_APP_THREAD_PRIO      1
#define EXAMPLE_APP_THREAD_STACKSIZE 1024
...
static void init_freemaster_wifi(void);
...
int main(void)
{
    ...
    if (xTaskCreate(example_task, "example_task", EXAMPLE_APP_THREAD_STACKSIZE, NULL, EXAMPLE_APP_THREAD_PRIO, NULL) ==
        pdFAIL)
...
static void fmstr_task(void *arg)
{
    /* Network interface initialization (Must be in task!) */
    Network_Init();
