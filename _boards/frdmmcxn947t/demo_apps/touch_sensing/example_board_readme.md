...
Running the demo
================
The control page in FreeMASTER should show changing values from TSI measurement. The FRDM-MCXN947T on-board LED is turned on when the touch event is detected, 
