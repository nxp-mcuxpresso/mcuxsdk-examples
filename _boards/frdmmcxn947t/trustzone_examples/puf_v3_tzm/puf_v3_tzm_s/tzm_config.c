...
- ahb:
  ...
  - peripherals: {ns_user: {id: [ADC0, AHBSC, ANACTRL, CASPER, CRC_ENGINE, CTIMER0, CTIMER1, CTIMER2, CTIMER3, CTIMER4, DBGMAILBOX, DMA0, DMA1, FLASH,
...
void BOARD_InitTrustZone()
{
    ...
    */
    ...
    //    AHBSC->SEC_CTRL_FLASH_ROM[0].SEC_CTRL_FLASH_MEM_RULE[0] = 0x00000033U;
    //    AHBSC->SEC_CTRL_FLASH_ROM[0].SEC_CTRL_FLASH_MEM_RULE[1] = 0;
    //    AHBSC->SEC_CTRL_FLASH_ROM[0].SEC_CTRL_FLASH_MEM_RULE[2] = 0;
    //    AHBSC->SEC_CTRL_FLASH_ROM[0].SEC_CTRL_ROM_MEM_RULE[0] = 0;
    //    AHBSC->SEC_CTRL_FLASH_ROM[0].SEC_CTRL_ROM_MEM_RULE[1] = 0;
    //    AHBSC->SEC_CTRL_FLASH_ROM[0].SEC_CTRL_ROM_MEM_RULE[2] = 0;
    //    AHBSC->SEC_CTRL_FLASH_ROM[0].SEC_CTRL_ROM_MEM_RULE[3] = 0;
    //    AHBSC->SEC_CTRL_RAMX[0].MEM_RULE[0] = 0;
    //    AHBSC->SEC_CTRL_RAM0[0].MEM_RULE[0] = 0x33333333U;
    //    AHBSC->SEC_CTRL_RAM0[0].MEM_RULE[1] = 0;
    //    AHBSC->SEC_CTRL_RAM1[0].MEM_RULE[0] = 0;
    //    AHBSC->SEC_CTRL_RAM1[0].MEM_RULE[1] = 0;
    //    AHBSC->SEC_CTRL_RAM2[0].MEM_RULE[0] = 0;
    //    AHBSC->SEC_CTRL_RAM2[0].MEM_RULE[1] = 0;
    //    AHBSC->SEC_CTRL_RAM3[0].MEM_RULE[0] = 0;
    //    AHBSC->SEC_CTRL_RAM3[0].MEM_RULE[1] = 0;
    //    AHBSC->SEC_CTRL_RAM4[0].MEM_RULE[0] = 0;
    //    AHBSC->SEC_CTRL_USB_HS[0].MEM_RULE[0] = 0;
    //
    //    /* Security level configuration of PPC checker */
    //    AHBSC->SEC_CTRL_APB_BRIDGE[0].SEC_CTRL_APB_BRIDGE0_MEM_CTRL0 = 0xFCCCCCFFU;
    //    AHBSC->SEC_CTRL_APB_BRIDGE[0].SEC_CTRL_APB_BRIDGE0_MEM_CTRL1 = 0xFCCCFFCCU;
    //    AHBSC->SEC_CTRL_APB_BRIDGE[0].SEC_CTRL_APB_BRIDGE0_MEM_CTRL2 = 0xFFFFCFFFU;
    //    AHBSC->SEC_CTRL_APB_BRIDGE[0].SEC_CTRL_APB_BRIDGE1_MEM_CTRL0 = 0xFFFFCFFCU;
    //    AHBSC->SEC_CTRL_APB_BRIDGE[0].SEC_CTRL_APB_BRIDGE1_MEM_CTRL1 = 0xFFCCFCCCU;
    //    AHBSC->SEC_CTRL_APB_BRIDGE[0].SEC_CTRL_APB_BRIDGE1_MEM_CTRL2 = 0xFFCCFFFFU;
    //    AHBSC->SEC_CTRL_APB_BRIDGE[0].SEC_CTRL_APB_BRIDGE1_MEM_CTRL3 = 0xFFCFCCFCU;
    //    AHBSC->SEC_CTRL_AHB_PORT8_SLAVE0_RULE = 0xCFCCFCFFU;
    //    AHBSC->SEC_CTRL_AHB_PORT8_SLAVE1_RULE = 0xFFFCCCCCU;
    //    AHBSC->SEC_CTRL_AHB_PORT9_SLAVE0_RULE = 0xCCCCFFFFU;
    //    AHBSC->SEC_CTRL_AHB_PORT9_SLAVE1_RULE = 0xCFFCCFFCU;
    //    AHBSC->SEC_CTRL_AHB_PORT10[0].SLAVE0_RULE = 0xCCCCCCFCU;
    //    AHBSC->SEC_CTRL_AHB_PORT10[0].SLAVE1_RULE = 0xFFFFFFCCU;
     ...
     *  0b0    Deny
     *  0b1    Allow */
    AHBSC->SEC_GPIO_MASK[0] = 0x9FFFFFFFU;
    ...
    AHBSC->SEC_CPU1_INT_MASK4 = 0xFFFFFFFFU;
    ...
    AHBSC->MASTER_SEC_LEVEL        = (AHBSC->MASTER_SEC_LEVEL & 0x03FFFFFFFU) | 0x080000000U;
    AHBSC->MASTER_SEC_ANTI_POL_REG = (AHBSC->MASTER_SEC_ANTI_POL_REG & 0x03FFFFFFFU) | 0x080000000U;
    AHBSC->CPU0_LOCK_REG           = 0x800002AAU;
    AHBSC->CPU1_LOCK_REG           = 0x8000000AU;
    // AHBSC->MISC_CTRL_REG = 0x00008AA6U;
    // AHBSC->MISC_CTRL_DP_REG = 0x00008AA6U;
}
