...
Board settings
==============
This example project uses ACMP instance 3 to compare the voltage signal input from External Input2(GPIO_AD_28,J11-12)
...
Connect ACMP External Input2(GPIO_AD_28, J11-12) to stable external voltage generator to avoid floating voltage. 
