...
#define PD_PORT1_PHY_INTERRUPT_PORT (9U)

#define PD_PORT1_SHIELD2_EXTERNAL_POWER_DETECT_PIN  (0U)
#define PD_PORT1_SHIELD2_EXTERNAL_POWER_DETECT_PORT (9U)

#define PD_PORT1_EXTRA_SRC_PIN  (4U)
#define PD_PORT1_EXTRA_SRC_PORT (9U)

#define PD_PORT1_SHIELD2_DP4LANE_PIN  (12U)
#define PD_PORT1_SHIELD2_DP4LANE_PORT (12U)

#define PD_PORT1_SHIELD2_XSD_PIN  (31U)
#define PD_PORT1_SHIELD2_XSD_PORT (8U)
