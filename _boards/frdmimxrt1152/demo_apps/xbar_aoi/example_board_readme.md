...
Running the demo
================
If CMP3_IN1 (J11-12) connected to the input voltage that in the range of 0.9V to 1.8V then the XBAR interrupt will start.
If CMP3_IN1 (J11-12) connected to the input voltage that in the range of 0V to 0.9V then XBAR interrupt will stop.
