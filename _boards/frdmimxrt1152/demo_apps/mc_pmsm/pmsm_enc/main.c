...
app_ver_t g_sAppIdFM = {
    "../../../examples/_boards/frdmimxrt1152/demo_apps/mc_pmsm/pmsm_enc/cm7",         /* User Path 1- the highest priority */
    "../../../boards/frdmimxrt1152/demo_apps/mc_pmsm/pmsm_enc/cm7",       /* User Path 2 */
    "frdmimxrt1152", /* board id */
    "pmsm_enc", /* example id */
