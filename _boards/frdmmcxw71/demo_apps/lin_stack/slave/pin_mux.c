...
- pin_list:
  - {pin_num: '13', peripheral: TPM0, signal: 'CH, 3', pin_signal: CMP1_IN1/PTA18/LPSPI0_SOUT/LPUART0_CTS_b/LPI2C0_SDA/TPM0_CH3/RF_GPO_0/LPUART0_RX, pull_select: down,
...
void BOARD_InitLinLpuart(void)
{
    ...
    gpio_pin_config_t gpioc_pin45_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 1U
    };
    /* Initialize GPIO functionality on pin PTC7 (pin 45)  */
    GPIO_PinInit(GPIOC, 7U, &gpioc_pin45_config);
    ...
    const port_pin_config_t portc7_pin45_config = {/* Internal pull-up/down resistor is disabled */
                                                   (uint16_t)kPORT_PullDisable,
                                                   /* Low internal pull resistor value is selected. */
                                                   (uint16_t)kPORT_LowPullResistor,
                                                   /* Fast slew rate is configured */
    ...
    PORT_SetPinConfig(PORTC, 7U, &portc7_pin45_config);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
