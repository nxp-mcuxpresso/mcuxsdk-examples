...
/*******************************************************************************
 * Variables for BOARD_BootClockPLL configuration
 ******************************************************************************/
/*******************************************************************************
 * Code for BOARD_BootClockPLL configuration
 ******************************************************************************/
void BOARD_BootClockPLL(void)
{
  
    /* External Crystal start, Crystal 8MHz */
    ...
    const pll_setup_t pll1Setup = {
        ...
        .pllpdiv = SCG_SPLLPDIV_PDIV(16U),
        .pllmdiv = SCG_SPLLMDIV_MDIV(209U),
        .pllRate = 180000000U
