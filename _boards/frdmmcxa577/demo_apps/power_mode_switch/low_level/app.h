...
#define APP_SPC_WAKEUP_BUTTON_ISO_VALUE         (0x36U)          /* VDD_USB, VDD_P2/ANA, VDD_P4, VDD_VBAT. */
#define APP_SPC_WAKEUP_BUTTON_LPISO_VALUE       (0x36U)          /* VDD_USB, VDD_P2/ANA, VDD_P4, VDD_VBAT. */
#define APP_SPC_WAKEUP_BUTTON_ISO_DOMAINS       "VDD_USB, VDD_P2/ANA, VDD_P4, VDD_VBAT"
