...
======================
The hardware should be reworked according to the hardware rework guide for frdmimxrt1186 and Murata 1XK M.2 Adapter in document Hardware Rework Guide for EdgeFast BT PAL.
The hardware should be reworked according to the hardware rework guide for frdmimxrt1186 and Murata 1ZM M.2 Adapter in document Hardware Rework Guide for EdgeFast BT PAL.
The rework guide for frdmimxrt1186 and Murata 2EL M.2 Adapter is same as frdmimxrt1186 and Murata 1ZM M.2 Adapter.
...
The button used to switch the role of wireless_uart in frdmimxrt1186 is SW8.