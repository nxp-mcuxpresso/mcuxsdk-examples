...
2.  Import the configuration file for the servo motor example.
    ...
    4.  Navigate to the \\*boards\\frdmimxrt1186\\ecat\_examples\\servo\_motor\\cm7\\SSC* folder.
...
6.  Copy the *Src* subfolder to *boards\\frdmimxrt1186\\ecat\_examples\\ servo\_motor\\cm7\\SSC\\Src* under the SDK source code.
7.  **Apply patch**.

    Change to *.\\boards\\frdmimxrt1186\\ecat\_examples\\servo\_motor\\cm7\\SSC* path. Install patch tool.
    ...
    -   To apply the patch on **Windows**:
        ...
        2.  Transfer the patch format. `$(Dos2Unix/Unix2Dos-DIR)/bin/unix2dos.exe …\boards\frdmimxrt1186\ecat_examples\servo_motor\cm7\SSC\CiA402-combine-the-SSC-subdevice-with-ec_pmsm-support.patch`.



        3.  Apply patch by using the command `./patch.exe -i …\boards\frdmimxrt1186\ecat_examples\servo_motor\cm7\SSC\CiA402-combine-the-SSC-subdevice-with-ec_pmsm-support.patch -d …\boards\frdmimxrt1186\ecat_examples\servo_motor\cm7\SSC\Src\`.
