...
1.  Download the latest SDK package with the motor control software for permanent magnet synchronous motor \(PMSM\) from [https://mcuxpresso.nxp.com/en/builder?hw=FRDM-IMXRT1186&components=nxp\_motor\_control](https://mcuxpresso.nxp.com/en/builder?hw=FRDM-IMXRT1186&components=nxp_motor_control).
