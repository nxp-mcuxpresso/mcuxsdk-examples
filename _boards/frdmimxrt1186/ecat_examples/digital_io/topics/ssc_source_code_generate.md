...
2.  Import the configuration file for the digital IO example.
    ...
    4.  Navigate to the \\*boards\\frdmimxrt1186\\ecat\_examples\\digital\_io\\<core\>\\SSC* folder.
...
5.  Create the digital IO example application via importing the *digital\_io.xlsx* file.
    ...
    2.  Navigate to the *\\boards\\frdmimxrt1186\\ecat\_examples\\digital\_io\\<core\>\\SSC* folder.
...
7.  Copy the *Src* subfolder to *boards\\frdmimxrt1186\\ecat\_examples\\digital\_io\\<core\>\\SSC\\Src* under the SDK source code.
