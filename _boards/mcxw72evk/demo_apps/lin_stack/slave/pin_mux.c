...
- options: {callFromInitBoot: 'true', coreID: cm33_core0, enableClock: 'true'}
- pin_list:
  - {pin_num: '40', peripheral: LPUART1, signal: TX, pin_signal: PTC3/LPSPI1_SCK/LPUART1_TX/LPI2C1_SDAS/TPM1_CH3/FLEXIO0_D19, pull_select: down, pull_enable: enable,
...
void BOARD_DebugConsolePins(void)
{
    ...
    const port_pin_config_t portc3_pin40_config = {/* Internal pull-down resistor is enabled */
...
void BOARD_InitLeds(void)
{
    ...
    PORT_SetPinConfig(BOARD_INITLEDS_LED_GREEN_PORT, BOARD_INITLEDS_LED_GREEN_PIN, &LED_GREEN);
    ...
    PORT_SetPinConfig(BOARD_INITLEDS_LED_BLUE_PORT, BOARD_INITLEDS_LED_BLUE_PIN, &LED_BLUE);
