...
#define BOARD_INITPINS_LPSPI1_PCS3_PORT PORTB               /*!<@brief PORT peripheral base pointer */
#define BOARD_INITPINS_LPSPI1_PCS3_PIN 4U                   /*!<@brief PORT pin number */
#define BOARD_INITPINS_LPSPI1_PCS3_PIN_MASK (1U << 4U)      /*!<@brief PORT pin mask */
                                                            /* @} */
