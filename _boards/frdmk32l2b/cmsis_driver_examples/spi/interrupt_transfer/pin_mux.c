...
- pin_list:
  ...
  - {pin_num: '54', peripheral: LCD, signal: 'P, 25', pin_signal: LCD_P25/PTC5/LLWU_P9/SPI0_SCK/LPTMR0_ALT2/CMP0_OUT}
  - {pin_num: '55', peripheral: CMP0, signal: 'IN, 0', pin_signal: LCD_P26/CMP0_IN0/PTC6/LLWU_P10/SPI0_MOSI/EXTRG_IN/SPI0_MISO}
  - {pin_num: '56', peripheral: CMP0, signal: 'IN, 1', pin_signal: LCD_P27/CMP0_IN1/PTC7/SPI0_MISO/USB_SOF_OUT/SPI0_MOSI}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void SPI0_DeinitPins(void)
{
    ...
    /* PORTC7 (pin 56) is configured as CMP0_IN1 */
