mcux_add_source(
  ...
  SOURCES
    ...
    examples/_boards/${board}/edgefast_bluetooth_examples/peripheral_fmp/${core_id}/hardware_init.c
    examples/_boards/${board}/edgefast_bluetooth_examples/peripheral_fmp/${core_id}/pin_mux.c
    examples/_boards/${board}/edgefast_bluetooth_examples/peripheral_fmp/${core_id}/pin_mux.h
)
mcux_add_include(
  BASE_PATH ${SdkRootDirPath}
  INCLUDES
    ...
    examples/_boards/${board}/edgefast_bluetooth_examples/peripheral_fmp/${core_id}
...
mcux_add_iar_linker_script(
  BASE_PATH ${SdkRootDirPath}
  LINKER examples/_boards/${board}/edgefast_bluetooth_examples/peripheral_fmp/linker/iar/MCXN947_cm33_core0_flash.icf
  TARGETS
    debug
    release
)
mcux_add_mdk_linker_script(
  BASE_PATH ${SdkRootDirPath}
  LINKER examples/_boards/${board}/edgefast_bluetooth_examples/peripheral_fmp/linker/arm/MCXN947_cm33_core0_flash.scf
  TARGETS
    debug
    release
)
mcux_add_armgcc_linker_script(
  BASE_PATH ${SdkRootDirPath}
  LINKER examples/_boards/${board}/edgefast_bluetooth_examples/peripheral_fmp/linker/gcc/MCXN947_cm33_core0_flash.ld
  TARGETS
    debug
    release
)
