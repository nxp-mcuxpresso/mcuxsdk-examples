...
When Tamper 4 is connected to 3V3, In output log line Line Tampering detected on Passive TAMPER should change to No tampering detected on Passive TAMPER
