...
void BOARD_BootClockRUN_InitClockModule(clock_module_t module)
{
    switch(module) {
        ...
        case kClockModule_AUDIO_PLL0:
            ...
            CLOCK_EnableAudioPllPfdClkForDomain(kCLOCK_Pfd0, kCLOCK_AllDomainEnable);
            ...
            CLOCK_EnableAudioPllPfdClkForDomain(kCLOCK_Pfd2, kCLOCK_AllDomainEnable);
            ...
            CLOCK_EnableAudioPllVcoClkForDomain(kCLOCK_AllDomainEnable);
