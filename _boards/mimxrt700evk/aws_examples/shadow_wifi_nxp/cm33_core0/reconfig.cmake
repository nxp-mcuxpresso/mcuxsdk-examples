...
mcux_add_include(
    ...
    INCLUDES ${board_root}/${board}
             ${board_root}/${board}/aws_examples/common/mbedtls_config
)
...
mcux_add_iar_linker_script(
    BASE_PATH ${SdkRootDirPath}
    TARGETS flash_debug flash_release
    LINKER ${board_root}/${board}/aws_examples/common/linker/MIMXRT798Sxxxx_cm33_core0_flash.icf
)
mcux_add_armgcc_linker_script(
    BASE_PATH ${SdkRootDirPath}
    TARGETS flash_debug flash_release
    LINKER ${board_root}/${board}/aws_examples/common/linker/MIMXRT798Sxxxx_cm33_core0_flash.ld
)
mcux_add_mdk_linker_script(
    BASE_PATH ${SdkRootDirPath}
    TARGETS flash_debug flash_release
    LINKER ${board_root}/${board}/aws_examples/common/linker/MIMXRT798Sxxxx_cm33_core0_flash.scf
)
