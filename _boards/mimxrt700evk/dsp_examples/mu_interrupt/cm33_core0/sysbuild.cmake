...
ExternalZephyrProject_Add(
        APPLICATION mu_interrupt_hifi4
...
ExternalMCUXProject_Add(
        APPLICATION mu_interrupt_hifi1
        SOURCE_DIR  ${APP_DIR}/../dsp
        board ${SB_CONFIG_dsp_board}
...
ExternalZephyrProject_Add(
        APPLICATION mu_interrupt_cm33_core1
...
add_dependencies(mu_interrupt_cm33_core1 mu_interrupt_hifi1)

add_dependencies(${DEFAULT_IMAGE} mu_interrupt_hifi4)

add_dependencies(${DEFAULT_IMAGE} mu_interrupt_cm33_core1)