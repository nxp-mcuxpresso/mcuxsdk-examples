...
mcux_add_source(
    ...
    SOURCES ${board_root}/${board}/demo_apps/dvs_pvt_with_hifi/${core_id}/clock_config.c
            ...
            ${board_root}/${board}/demo_apps/dvs_pvt_with_hifi/${core_id}/dvs_pvt_with_hifi_primary.c
            ...
            ${board_root}/${board}/demo_apps/dvs_pvt_with_hifi/hifi4/binary/*.bin
)

mcux_add_source(
    BASE_PATH ${SdkRootDirPath}
    EXCLUDE TRUE
    SOURCES ${board_root}/${board}/demo_apps/dvs_pvt_with_hifi/main_dsp.c
)
...
mcux_add_include(
    ...
    INCLUDES ${board_root}/${board}/demo_apps/dvs_pvt_with_hifi/${core_id}
             ...
             ${board_root}/${board}/demo_apps/dvs_pvt_with_hifi/hifi4/binary/
             ${board_root}/${board}/demo_apps/
)

mcux_add_iar_configuration(
    LD "--image_input=${APPLICATION_BINARY_DIR}/../dvs_pvt_with_hifi_secondary/iar/core1_image.bin,_core1_image,__core1_image,4\
        --keep=_core1_image\
        --image_input=${SdkRootDirPath}/${board_root}/${board}/demo_apps/dvs_pvt_with_hifi/hifi4/binary/dsp_literal_release.bin,__dsp_literal_bin,__dsp_literal_section,4\
        --keep=__dsp_literal_bin\
        --image_input=${SdkRootDirPath}/${board_root}/${board}/demo_apps/dvs_pvt_with_hifi/hifi4/binary/dsp_text_release.bin,__dsp_text_bin,__dsp_text_section,4\
        --keep=__dsp_text_bin\
        --image_input=${SdkRootDirPath}/${board_root}/${board}/demo_apps/dvs_pvt_with_hifi/hifi4/binary/dsp_data_release.bin,__dsp_data_bin,__dsp_data_section,4\
        --keep=__dsp_data_bin"
)
...
mcux_add_include(
    ...
    INCLUDES ../dvs_pvt_with_hifi_secondary/${CONFIG_TOOLCHAIN}/
)