...
- {id: CLKCTL2_MAINPLL0PFDDOMAINEN_PFD0_OF_CMPT_CFG, value: Disabled}
- {id: CLKCTL2_MAINPLL0PFD_PFD0_CLKGATE_CFG, value: Disabled}
...
- {id: CLKCTL3.WAKE32KCLKSEL.sel, value: OSC32KNP.OSC32K_OUT}
...
- {id: OSC32KNP_CTRL_MODE_CFG, value: low_power}
sources:
...
const clock_fro_config_t g_fro0Config_BOARD_BootClockRUN192M =
    {
...
/*******************************************************************************
 * Code for BOARD_BootClockRUN192M configuration
 ******************************************************************************/
void BOARD_BootClockRUN192M_InitClockModule(clock_module_t module)
{
    switch(module) {
        case kClockModule_FRO0:
            ...
            CLOCK_EnableFroClkFreqCloseLoop(FRO0, &g_fro0Config_BOARD_BootClockRUN192M, kCLOCK_FroDiv1OutEn | kCLOCK_FroDiv3OutEn | kCLOCK_FroDiv6OutEn);
...
void BOARD_BootClockRUN192M(void)
{
    ...
    BOARD_BootClockRUN192M_InitClockModule(kClockModule_LPOSC_1M_CLK_SEL);
    BOARD_BootClockRUN192M_InitClockModule(kClockModule_VDDN_COM_BASE_CLK_SEL);
    BOARD_BootClockRUN192M_InitClockModule(kClockModule_VDD2_COMP_BASE_CLK_SEL);
    BOARD_BootClockRUN192M_InitClockModule(kClockModule_VDD2_DSP_BASE_CLK_SEL);
    BOARD_BootClockRUN192M_InitClockModule(kClockModule_VDD2_COM_BASE_CLK_SEL);
    BOARD_BootClockRUN192M_InitClockModule(kClockModule_VDD2_MEDIA_BASE_CLK_SEL);
    BOARD_BootClockRUN192M_InitClockModule(kClockModule_VDDN_MEDIA_BASE_CLK_SEL);
    BOARD_BootClockRUN192M_InitClockModule(kClockModule_CLK_ROOT_COMPUTE_MAIN_CLK);
    BOARD_BootClockRUN192M_InitClockModule(kClockModule_CLK_ROOT_COMMON_VDDN_CLK);
    BOARD_BootClockRUN192M_InitClockModule(kClockModule_CLK_ROOT_MEDIA_VDDN_CLK);
    BOARD_BootClockRUN192M_InitClockModule(kClockModule_CLK_ROOT_MEDIA_MAIN_CLK);
    BOARD_ClockLPPostConfig();
    /*!< Set SystemCoreClock variable. */
    SystemCoreClock = BOARD_BOOTCLOCKRUN192M_CORE_CLOCK;
}
