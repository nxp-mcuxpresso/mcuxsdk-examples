...
/* Frequencies Examples: 110000000U, 192000000U, 325000000U */
 ...
 */
#if (DEMO_MAINCLK_FREQ == DEMO_MAINCLK_FREQ_SP2)
#define DEMO_TYPICAL_DELAY_CPU0  17U
#define DEMO_TYPICAL_DELAY_HIFI4 17U
#elif (DEMO_MAINCLK_FREQ == DEMO_MAINCLK_FREQ_SP1)
#define DEMO_TYPICAL_DELAY_CPU0  19U
#define DEMO_TYPICAL_DELAY_HIFI4 19U
#elif (DEMO_MAINCLK_FREQ == DEMO_MAINCLK_FREQ_SP0)
#define DEMO_TYPICAL_DELAY_CPU0  24U
#define DEMO_TYPICAL_DELAY_HIFI4 24U
#endif
/*******************************************************************************
 * API
 ******************************************************************************/
