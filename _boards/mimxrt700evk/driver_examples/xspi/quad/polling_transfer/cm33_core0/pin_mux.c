 ...
 * Description   : Configures pin routing and optionally pin electrical features.
 *                 Only the W25Q512NW Quad-I/O (1-4-4) signals are muxed: SCLK, SS0_N,
 *                 DATA0-3 and DQS (used for DQS-pad loopback sampling). The octal
 *                 DATA4-7, the unused SS1_N, and the single-ended-mode-unused SCLK0_N
 *                 are intentionally not muxed.
 *
 * END ****************************************************************************************************************/
/* Function assigned for the Cortex-M33 (Core #0) */
