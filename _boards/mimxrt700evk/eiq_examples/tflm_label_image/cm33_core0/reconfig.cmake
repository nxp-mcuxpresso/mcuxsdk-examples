mcux_add_include(
  ...
  INCLUDES  ${board_root}/${board}/eiq_examples/tflm_label_image/pcq_npu
  )
mcux_add_source(
  BASE_PATH ${SdkRootDirPath}
  SOURCES ${board_root}/${board}/eiq_examples/tflm_label_image/pcq_npu/model_mobilenet_ops_npu.cpp
  ${board_root}/${board}/eiq_examples/tflm_label_image/pcq_npu/model_data.h
  )
...
mcux_add_armgcc_linker_script(
  TARGETS debug release
  BASE_PATH ${SdkRootDirPath}
  LINKER ${board_root}/mimxrt700evk/eiq_examples/tflm_label_image/cm33_core0/gcc/MIMXRT798Sxxxx_cm33_core0_ram.ld
  )
mcux_add_armgcc_linker_script(
  TARGETS flash_debug flash_release
  BASE_PATH ${SdkRootDirPath}
  LINKER ${board_root}/mimxrt700evk/eiq_examples/tflm_label_image/cm33_core0/gcc/MIMXRT798Sxxxx_cm33_core0_flash.ld
  )
mcux_add_mdk_linker_script(
  TARGETS debug release
  BASE_PATH ${SdkRootDirPath}
  LINKER ${board_root}/mimxrt700evk/eiq_examples/tflm_label_image/cm33_core0/arm/MIMXRT798Sxxxx_cm33_core0_ram.scf
  )
mcux_add_mdk_linker_script(
  TARGETS flash_debug flash_release
  BASE_PATH ${SdkRootDirPath}
  LINKER ${board_root}/mimxrt700evk/eiq_examples/tflm_label_image/cm33_core0/arm/MIMXRT798Sxxxx_cm33_core0_flash.scf
  )
mcux_add_iar_linker_script(
  TARGETS debug release
  BASE_PATH ${SdkRootDirPath}
  LINKER ${board_root}/mimxrt700evk/eiq_examples/tflm_label_image/cm33_core0/iar/MIMXRT798Sxxxx_cm33_core0_ram.icf
  )
mcux_add_iar_linker_script(
  TARGETS flash_debug flash_release
  BASE_PATH ${SdkRootDirPath}
  LINKER ${board_root}/mimxrt700evk/eiq_examples/tflm_label_image/cm33_core0/iar/MIMXRT798Sxxxx_cm33_core0_flash.icf
  )
