...
#define APP_USE_JPEG_IMAGES

#ifdef APP_USE_JPEG_IMAGES
/* define a static image that will be included if needed */
#define APP_STATIC_IMAGE_RGB_NAME "kaggle_img_color_yuyv_jpg.h"
#define APP_STATIC_IMAGE_IR_NAME "kaggle_img_ir_yuyv_jpg.h"
#else
/* define a static image that will be included if needed */
#define APP_STATIC_IMAGE_RGB_NAME "kaggle_img_rgb.h"
#define APP_STATIC_IMAGE_IR_NAME "kaggle_img_ir_bgr.h"
