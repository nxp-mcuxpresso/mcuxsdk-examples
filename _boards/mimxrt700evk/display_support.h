...
#define ST7796S_DRIVEN_BY_FLEXIO 0
#define ST7796S_DRIVEN_BY_LCDIF 1

/* Configure this macro in Kconfig or directly in the generated mcux_config.h. */
#ifndef ST7796S_DRIVEN_BY
#define ST7796S_DRIVEN_BY ST7796S_DRIVEN_BY_LCDIF
#endif

/* Pixel format macro mapping. */
#define DEMO_LCD_PAR_S035_BUFFER_RGB565   0
#define DEMO_LCD_PAR_S035_BUFFER_RGB888   1

#ifndef DEMO_LCD_PAR_S035_BUFFER_FORMAT
#define DEMO_LCD_PAR_S035_BUFFER_FORMAT DEMO_LCD_PAR_S035_BUFFER_RGB565
#endif
...
#define DEMO_BUFFER_PIXEL_FORMAT   kVIDEO_PixelFormatRGB888
#define DEMO_BUFFER_BYTE_PER_PIXEL 3
#define FRAME_BUFFER_ALIGN         192U
#endif
...
#define DEMO_BUFFER_FIXED_ADDRESS 1
#define DEMO_BUFFER0_ADDR DEMO_ALIGN_ADDR(0x60000000U, FRAME_BUFFER_ALIGN)
#define DEMO_BUFFER1_ADDR DEMO_ALIGN_ADDR(0x60100000U, FRAME_BUFFER_ALIGN)
#define DEMO_BUFFER_COUNT  1

#if (ST7796S_DRIVEN_BY == ST7796S_DRIVEN_BY_FLEXIO)
/* No align requirement for FLEXIO. */
#define DEMO_BUFFER_STRIDE_BYTE DEMO_FB_WIDTH * DEMO_BUFFER_BYTE_PER_PIXEL
#else
#if (DEMO_LCD_PAR_S035_BUFFER_FORMAT == DEMO_LCD_PAR_S035_BUFFER_RGB565)
