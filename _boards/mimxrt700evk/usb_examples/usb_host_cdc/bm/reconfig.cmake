...
mcux_add_include(
  ...
  INCLUDES
    ...
    "${board_root}/${board}/usb_examples/usb_host_cdc/bm"
    "${board_root}/${board}/usb_examples/usb_host_cdc/bm/${core_id}"
)

mcux_add_source(
  BASE_PATH "${SdkRootDirPath}"
  SOURCES
    "${board_root}/${board}/usb_examples/usb_host_cdc/bm/${core_id}/hardware_init.c"
    "${board_root}/${board}/usb_examples/usb_host_cdc/bm/${core_id}/pin_mux.c"
    "${board_root}/${board}/usb_examples/usb_host_cdc/bm/${core_id}/pin_mux.h"
)
