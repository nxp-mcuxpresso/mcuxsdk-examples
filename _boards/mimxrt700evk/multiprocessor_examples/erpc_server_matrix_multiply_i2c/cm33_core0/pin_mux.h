...
#define PCOR_PTCO2_ptco1 0x01u            /*!<@brief Port Clear Output: Corresponding field in PDOR becomes 0 */
#define PDDR_PDD2_pdd1 0x01u              /*!<@brief Port Data Direction: Output */

/*! @name PIO3_2 (coord D2), GPIO_HANDSHAKE
  @{ */
/* Routed pin properties */
/*!
 * @brief Peripheral name */
#define BOARD_INITPINS_GPIO_HANDSHAKE_PERIPHERAL GPIO3
/*!
 * @brief Signal name */
#define BOARD_INITPINS_GPIO_HANDSHAKE_SIGNAL GPIO
/*!
 * @brief Signal channel */
#define BOARD_INITPINS_GPIO_HANDSHAKE_CHANNEL 2

/* Symbols to be used with GPIO driver */
/*!
 * @brief GPIO peripheral base pointer */
#define BOARD_INITPINS_GPIO_HANDSHAKE_GPIO GPIO3
/*!
 * @brief GPIO pin mask */
#define BOARD_INITPINS_GPIO_HANDSHAKE_GPIO_PIN_MASK (1U << 2U)
/*!
 * @brief PORT peripheral base pointer */
#define BOARD_INITPINS_GPIO_HANDSHAKE_PORT 3U
/*!
 * @brief PORT pin number */
#define BOARD_INITPINS_GPIO_HANDSHAKE_PIN 2U
/*!
 * @brief PORT pin mask */
#define BOARD_INITPINS_GPIO_HANDSHAKE_PIN_MASK (1U << 2U)
/* @} */
