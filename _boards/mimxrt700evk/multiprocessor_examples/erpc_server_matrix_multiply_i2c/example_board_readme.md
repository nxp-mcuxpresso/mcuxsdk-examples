...
Running the demo
================
When the target device application is running execute Python run_i2c.py from boards\mimxrt700evk\multiprocessor_examples\erpc_common\erpc_matrix_multiply folder:
