...
#define DEMO_SW2_GPIO           BOARD_SW7_GPIO
#define DEMO_SW2_GPIO_PIN       BOARD_SW7_GPIO_PIN
#define DEMO_SW2_GPIO_NSE_MASK  GPIO_PCNS_NSE3_MASK

#define DEMO_LED_RED_GPIO           BOARD_LED_GREEN_GPIO
#define DEMO_LED_RED_GPIO_PIN       BOARD_LED_GREEN_GPIO_PIN
#define DEMO_LED_RED_GPIO_NSE_MASK  GPIO_PCNS_NSE18_MASK
