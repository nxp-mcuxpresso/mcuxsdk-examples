...
- pin_list:
  ...
  - {pin_num: B13, peripheral: ENET, signal: enet_ref_clk, pin_signal: GPIO_B1_10, software_input_on: Enable, pull_keeper_enable: Disable, speed: MHZ_50, drive_strength: R0_6,
    slew_rate: Fast}
  ...
  - {pin_num: M14, peripheral: LPI2C1, signal: SCLS, pin_signal: GPIO_AD_B0_00, software_input_on: Enable, pull_up_down_config: Pull_Up_22K_Ohm, open_drain: Enable}
  - {pin_num: H10, peripheral: LPI2C1, signal: SDAS, pin_signal: GPIO_AD_B0_01, software_input_on: Enable, pull_up_down_config: Pull_Up_22K_Ohm, open_drain: Enable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
void BOARD_InitPins(void) {
  ...
  IOMUXC_SetPinMux(
      IOMUXC_GPIO_AD_B0_00_LPI2C1_SCLS,       /* GPIO_AD_B0_00 is configured as LPI2C1_SCLS */
      1U);                                    /* Software Input On Field: Force input path of pad GPIO_AD_B0_00 */
  IOMUXC_SetPinMux(
      IOMUXC_GPIO_AD_B0_01_LPI2C1_SDAS,       /* GPIO_AD_B0_01 is configured as LPI2C1_SDAS */
      1U);                                    /* Software Input On Field: Force input path of pad GPIO_AD_B0_01 */
  IOMUXC_SetPinMux(
  ...
  IOMUXC_SetPinConfig(
      IOMUXC_GPIO_AD_B0_00_LPI2C1_SCLS,       /* GPIO_AD_B0_00 PAD functional properties : */
  ...
  IOMUXC_SetPinConfig(
      IOMUXC_GPIO_AD_B0_01_LPI2C1_SDAS,       /* GPIO_AD_B0_01 PAD functional properties : */
      0xD8B0U);                               /* Slew Rate Field: Slow Slew Rate
                                                 Drive Strength Field: R0/6
                                                 Speed Field: medium(100MHz)
                                                 Open Drain Enable Field: Open Drain Enabled
