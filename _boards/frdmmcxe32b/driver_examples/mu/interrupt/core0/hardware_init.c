...
void BOARD_InitHardware(void)
{
     ...
     * register access (or the MU2_A ISR) takes a precise bus fault. */
    APP_EnableMu2Clock();

    /* MU2_A has dedicated NVIC lines on MCXE32B. Enable the TX, RX and
     * general-purpose A-side vectors so MU2_A interrupt flags reach core0
     * (M7_0, primary) directly. */
