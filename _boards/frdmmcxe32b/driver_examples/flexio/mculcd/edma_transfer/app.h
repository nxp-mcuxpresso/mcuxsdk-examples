...
#define DEMO_FLEXIO_BAUDRATE_BPS 80000000U
...
/* Macros for DMA */
#define DEMO_EDMA EDMA
#define EXAMPLE_FLEXIO_MCULCD_DMAMUX_BASEADDR DMAMUX_0
#define DEMO_FLEXIO_TX_DMAMUX_CHANNEL 0
#define DEMO_FLEXIO_TX_DMA_CHANNEL 0
#define DEMO_FLEXIO_TX_DMA_REQUEST 33
