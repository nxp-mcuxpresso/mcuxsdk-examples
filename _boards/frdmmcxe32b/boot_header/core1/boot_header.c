...
extern void *const __isr_vector;
#else
...
typedef struct image_vector_table
{
    ...
    const uint32_t *CM7_1_StartAddress; /* Start address of CM7_1 Core    */
...
{
    .Header     = 0x5AA55AA5,
    .BootConfig = SET(CM7_1_ENABLE_MASK) | /* booting core is core0            */
