...
- {id: EMAC_CLK_CPU_Core_Config, value: core1}
- {id: FIRC_CPU_Core_Config, value: core1}
- {id: FXOSC_CPU_Core_Config, value: core1}
- {id: JTAG_TCK_CPU_Core_Config, value: core1}
- {id: JTAG_TCK_INIT_Config, value: custom}
- {id: MUX0_CSC_DC_CPU_Core_Config, value: core1}
- {id: MUX10_CSC_DC_CPU_Core_Config, value: core1}
- {id: MUX10_CSC_DC_INIT_Config, value: custom}
- {id: MUX11_CSC_DC_CPU_Core_Config, value: core1}
- {id: MUX11_CSC_DC_INIT_Config, value: custom}
- {id: MUX1_CSC_DC_CPU_Core_Config, value: core1}
- {id: MUX1_CSC_DC_INIT_Config, value: custom}
- {id: MUX2_CSC_DC_CPU_Core_Config, value: core1}
- {id: MUX2_CSC_DC_INIT_Config, value: custom}
- {id: MUX3_CSC_DC_CPU_Core_Config, value: core1}
- {id: MUX3_CSC_DC_INIT_Config, value: custom}
- {id: MUX4_CSC_DC_CPU_Core_Config, value: core1}
- {id: MUX4_CSC_DC_INIT_Config, value: custom}
- {id: MUX5_CSC_DC_CPU_Core_Config, value: core1}
- {id: MUX5_CSC_DC_INIT_Config, value: custom}
- {id: MUX6_CSC_DC_CPU_Core_Config, value: core1}
- {id: MUX6_CSC_DC_INIT_Config, value: custom}
- {id: MUX7_CSC_DC_CPU_Core_Config, value: core1}
- {id: MUX7_CSC_DC_INIT_Config, value: custom}
- {id: MUX8_CSC_DC_CPU_Core_Config, value: core1}
- {id: MUX8_CSC_DC_INIT_Config, value: custom}
- {id: MUX9_CSC_DC_CPU_Core_Config, value: core1}
- {id: MUX9_CSC_DC_INIT_Config, value: custom}
- {id: PLL_CPU_Core_Config, value: core1}
- {id: RTC_CPU_Core_Config, value: core1}
- {id: SIRC_CPU_Core_Config, value: core1}
- {id: SXOSC_CPU_Core_Config, value: core1}
...
void BOARD_BootClockRUN_InitClockModule(clock_module_t module)
{
    switch(module) {
        case kClockModule_FIRC:
            ...
            (void)CLOCK_SetFircDiv(kFIRC_Undivided);
