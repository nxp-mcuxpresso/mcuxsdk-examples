...
- pin_list:
  ...
  - {pin_num: '58', peripheral: GPIO, signal: 'PIO1, 19', pin_signal: PIO1_19/SCT0_OUT7/CTIMER3_MAT1/SCT_GPI7/FC4_SCK/PLU_OUT1/ACMPVREF, mode: inactive, slew_rate: standard,
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t port1_pin19_config = (/* Pin is configured as PIO1_19 */
                                         IOCON_PIO_FUNC0 |
                                         /* No addition pin function */
                                         IOCON_PIO_MODE_INACT |
                                         /* Standard mode, output slew rate control is enabled */
