...
- ahb:
  - regions: [{memory: PROGRAM_FLASH, security: s_priv, start: '0x00000000', size: '0x00010000'}, {memory: PROGRAM_FLASH, security: ns_user, start: '0x00010000',
    ...
    {memory: SRAM1, security: s_priv, start: '0x00000000', size: '0x00008000'}, {memory: SRAM1, security: ns_user, start: '0x00008000', size: '0x00008000'}, {memory: SRAM2,
...
- user_memory_regions: [{id: Region_1, security: s_priv, name: Secure Code, start: '0x10000000', size: '0x0000FE00'}, {id: Region_2, security: nsc_priv, name: Veneer
  ...
  {id: Region_5, security: ns_user, name: Non-secure Stack and Data, description: 'Privilege check is disabled so reset value (NS-User) can be used. ', start: '0x20008000',
    size: '0x00008000'}, {id: Region_6, security: s_priv, name: Wrong Non-secure Stack and Data, description: This region is configured to demonstrate misalignment  between
      SAU/IDAU and AHB secure controller configuration in test 5., start: '0x30010000', size: '0x00008000'}, {id: Region_7, security: ns_user, name: Non-secure Stack
      and Data, description: 'Privilege check is disabled so reset value (NS-User) can be used. ', start: '0x20018000', size: '0x0001B000'}]
- mpus:
  - mpu:
    - enabled: 'false'
    - id: 's'
