...
#define DEMO_USER_WAKEUP_KEY_PORT              BOARD_SW1_GPIO_PORT
#define DEMO_USER_WAKEUP_KEY_PIN               BOARD_SW1_GPIO_PIN
...
#define DEMO_DEEP_POWERDOWN_WAKEUP_SOURCE_SIZE (2U)
