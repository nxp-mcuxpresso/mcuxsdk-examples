...
- pin_list:
  ...
  - {pin_num: '3', peripheral: I3C, signal: SCL, pin_signal: PTB5/LPSPI1_PCS2/LPUART1_RTS_b/LPI2C1_SCL/I3C0_SCL/TRGMUX0_OUT0/FLEXIO0_D31, pull_select: up, pull_enable: enable,
    slew_rate: fast, passive_filter: disable, open_drain: disable, drive_strength: low, drive_strength_1: normal, invert_input: disable}
  - {pin_num: '2', peripheral: I3C, signal: SDA, pin_signal: PTB4/WUU0_P15/LPSPI1_PCS3/LPUART1_CTS_b/LPI2C1_SDA/I3C0_SDA/TRGMUX0_IN0/FLEXIO0_D30, pull_select: up,
...
void BOARD_InitPins(void)
{
    ...
    /* PORTB4 (pin 2) is configured as I3C0_SDA */
    ...
    const port_pin_config_t portb5_pin3_config = {/* Internal pull-up resistor is enabled */
                                                  ...
                                                  /* Pin Control Register fields [15:0] are not locked */
                                                  (uint16_t)kPORT_UnlockRegister};
    /* PORTB5 (pin 3) is configured as I3C0_SCL */
