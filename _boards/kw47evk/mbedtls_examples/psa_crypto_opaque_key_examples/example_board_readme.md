...
Prepare the Demo
================
1. Connect a micro USB cable between the PC host and the OpenSDA USB port (J14) on the board.
...
256 bit ECC_KEY_PAIR(BRAINPOOL_R1) with sign/verify algo ECDSA(SHA256): PASSED
