...
- pin_list:
  - {pin_num: '37', peripheral: GPIOC, signal: 'GPIO, 0', pin_signal: PTC0/WUU0_P7/LPSPI1_PCS2/CAN0_TX/I3C0_SDA/TPM1_CH0/LPI2C1_SCL/FLEXIO0_D16/RF_UART_CTS_b, pull_select: down,
...
void BOARD_InitPins(void)
{
    ...
    const port_pin_config_t portc7_pin45_config = {/* Internal pull-up resistor is enabled */
