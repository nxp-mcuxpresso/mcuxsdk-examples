...
#define APP_SLEEP_CONSTRAINTS          \
    2U, PM_RESC_MAIN_PD_PERI_OPERATIONAL, PM_RESC_WAKE_PD_PERI_ACTIVE

#define APP_DEEP_SLEEP_CONSTRAINTS     \
    2U, PM_RESC_MAIN_PD_PERI_STATE_RETENTION, PM_RESC_WAKE_PD_PERI_STATE_RETENTION

#define APP_POWER_DOWN_CONSTRAINTS     \
    1U, PM_RESC_WAKE_PD_PERI_STATE_RETENTION
