...
#define RSA_KEY_BYTE_LENGTH                                                    \
  (RSA_KEY_BIT_LENGTH / 8U) /* Converting the key-bitlength to bytelength */
#define RSA_PSS_SALT_LENGTH                                                    \
  (0U) /* The salt length is set to 0 in this example */
#define RSA_MESSAGE_DIGEST_LENGTH                                              \
  (32U) /* The example uses a Sha2-256 digest, which is 32 bytes long */
    ...
    if ((data_from_ram)) {                                                     \
      MCUX_CSSL_FP_FUNCTION_CALL_BEGIN(                                        \
          ...
          mcuxClRsa_sign((session), (&private_key),                            \
                         (m_length) == 32U ? s_MessageDigest32Byte             \
                                           : s_MessageDigest64Byte,            \
                         (m_length) == 32U ? sizeof(s_MessageDigest32Byte)     \
                                           : sizeof(s_MessageDigest64Byte),    \
                         (m_length) == 32U                                     \
                             ? (mcuxClRsa_SignVerifyMode_t                     \
                                    *)&mcuxClRsa_Mode_Sign_Pss_Sha2_256        \
                             : (mcuxClRsa_SignVerifyMode_t                     \
                                    *)&mcuxClRsa_Mode_Sign_Pss_Sha2_512,       \
                         RSA_PSS_SALT_LENGTH, MCUXCLRSA_OPTION_MESSAGE_DIGEST, \
                         s_SignatureBuffer));                                  \
      ...
      MCUX_CSSL_FP_FUNCTION_CALL_BEGIN(                                        \
          ...
          mcuxClRsa_sign(                                                      \
              (session), (&private_key),                                       \
              (m_length) == 32U ? s_MessageDigest32ByteFlash                   \
                                : s_MessageDigest64ByteFlash,                  \
              (m_length) == 32U ? sizeof(s_MessageDigest32ByteFlash)           \
                                : sizeof(s_MessageDigest64ByteFlash),          \
              (m_length) == 32U ? (mcuxClRsa_SignVerifyMode_t                  \
                                       *)&mcuxClRsa_Mode_Sign_Pss_Sha2_256     \
                                : (mcuxClRsa_SignVerifyMode_t                  \
                                       *)&mcuxClRsa_Mode_Sign_Pss_Sha2_512,    \
              RSA_PSS_SALT_LENGTH, MCUXCLRSA_OPTION_MESSAGE_DIGEST,            \
    ...
    if ((data_from_ram)) {                                                     \
      MCUX_CSSL_FP_FUNCTION_CALL_BEGIN(                                        \
          ...
          mcuxClRsa_verify((session), (&public_key),                           \
                           ...
                           RSA_PSS_SALT_LENGTH,                                \
                           MCUXCLRSA_OPTION_MESSAGE_DIGEST, encoded_message)); \
...
#define GENERATE_ECC_ED25519_SIGNATURE(data_from_ram, session, priv_key,       \
                                       m_length)                               \
  do {                                                                         \
    if ((data_from_ram)) {                                                     \
      ...
      MCUX_CSSL_FP_FUNCTION_CALL_BEGIN(                                        \
          ...
          mcuxClEcc_EdDSA_GenerateSignature(                                   \
              ...
              (m_length) == MESSAGE_SMALL ? s_MessageSmallEccEd25519           \
                                          : s_MessageLargeEccEd25519,          \
              (m_length) == MESSAGE_SMALL ? sizeof(s_MessageSmallEccEd25519)   \
                                          : sizeof(s_MessageLargeEccEd25519),  \
              s_SignatureBuffer, &signatureSize));                             \
      if ((MCUX_CSSL_FP_FUNCTION_CALLED(mcuxClEcc_EdDSA_GenerateSignature) !=  \
           sign_token) ||                                                      \
      ...
      MCUX_CSSL_FP_FUNCTION_CALL_BEGIN(                                        \
          ...
          mcuxClEcc_EdDSA_GenerateSignature(                                   \
              (&session), (priv_key),                                          \
              &mcuxClEcc_EdDsa_Ed25519ProtocolDescriptor,                      \
              (m_length) == MESSAGE_SMALL ? s_MessageSmallEccEd25519Flash      \
                                          : s_MessageLargeEccEd25519Flash,     \
              (m_length) == MESSAGE_SMALL                                      \
                  ? sizeof(s_MessageSmallEccEd25519Flash)                      \
...
#define ECC_ED25519_VERIFY(data_from_ram, session, pub_key_handler, m_length)  \
  do {                                                                         \
    if ((data_from_ram)) {                                                     \
      MCUX_CSSL_FP_FUNCTION_CALL_BEGIN(                                        \
          verify_result, verify_token,                                         \
          mcuxClEcc_EdDSA_VerifySignature(                                     \
              &(session), (pub_key_handler),                                   \
              &mcuxClEcc_EdDsa_Ed25519ProtocolDescriptor,                      \
              (m_length) == MESSAGE_SMALL ? s_MessageSmallEccEd25519           \
                                          : s_MessageLargeEccEd25519,          \
              (m_length) == MESSAGE_SMALL ? sizeof(s_MessageSmallEccEd25519)   \
...
static uint8_t s_PublicKeyBufferEcc[MCUXCLECC_EDDSA_ED25519_SIZE_PUBLICKEY]
...
static uint8_t s_PrivKeyInputEccEd25519[32U] = {
    0x83U, 0x3FU, 0xE6U, 0x24U, 0x09U, 0x23U, 0x7BU, 0x9DU, 0x62U, 0xECU, 0x77U,
...
static uint8_t s_PrivateKeyInputWeier256[32U] = {
    0xE9U, 0x46U, 0xFFU, 0x12U, 0xFFU, 0xB2U, 0xE7U, 0xBAU, 0x2CU, 0x5DU, 0x3AU,
...
static uint8_t s_PrivateKeyInputWeier384[48U] = {
    0x8EU, 0x49U, 0xBFU, 0x1CU, 0x5DU, 0x9CU, 0xBEU, 0x73U, 0xD5U, 0xD3U,
    0xDCU, 0xD7U, 0xBBU, 0x57U, 0x6AU, 0x2BU, 0xDEU, 0x17U, 0xB1U, 0xAAU,
    0xA7U, 0xCCU, 0x31U, 0xD0U, 0x24U, 0x10U, 0xB0U, 0xE6U, 0x9FU, 0xF7U,
    0x42U, 0x4BU, 0xA6U, 0x58U, 0x87U, 0x41U, 0x6AU, 0x04U, 0x14U, 0x43U,
    0x4CU, 0x25U, 0x5CU, 0xECU, 0x9DU, 0x84U, 0x36U, 0x88U};

static uint8_t s_PrivateKeyInputWeier521[66U] = {
    0x00U, 0xA8U, 0x14U, 0x1AU, 0xE2U, 0xF5U, 0x5FU, 0xFCU, 0x6EU, 0x4AU,
    0x39U, 0xF2U, 0x0FU, 0x3DU, 0x53U, 0x47U, 0x19U, 0xB0U, 0x6BU, 0x32U,
    0xC7U, 0xBDU, 0xEAU, 0x46U, 0x40U, 0x58U, 0xE2U, 0xC6U, 0x73U, 0xD4U,
    0xE2U, 0x35U, 0x73U, 0x8FU, 0x0FU, 0x49U, 0x08U, 0x2AU, 0x8FU, 0xE7U,
    0xAAU, 0x47U, 0x1DU, 0x2AU, 0x73U, 0x61U, 0xCAU, 0x2CU, 0xF7U, 0x60U,
    0x6EU, 0x85U, 0xDBU, 0xD7U, 0x03U, 0xBEU, 0xA6U, 0x3FU, 0xB3U, 0xCDU,
    0x8CU, 0x78U, 0x72U, 0xA9U, 0x4BU, 0x20U};

/* Public key input for ECC-Weier */
static uint8_t s_PublicKeyInputWeier256[64U] = {
    0x52U, 0x03U, 0x46U, 0xA7U, 0x4AU, 0x71U, 0xE0U, 0x4DU, 0x39U, 0xFEU, 0x4BU,
    0x20U, 0x1BU, 0xF7U, 0x4CU, 0x92U, 0xB6U, 0xBEU, 0x9FU, 0x88U, 0x11U, 0x1EU,
    0x7CU, 0x31U, 0x63U, 0x13U, 0xB3U, 0xFCU, 0x94U, 0x85U, 0xDAU, 0xD9U, 0x70U,
    0x7AU, 0xBDU, 0x51U, 0x8EU, 0x51U, 0xC2U, 0xD6U, 0x56U, 0x54U, 0xC4U, 0xD9U,
    0x86U, 0xE7U, 0x76U, 0x9FU, 0x4EU, 0xA1U, 0xD9U, 0x37U, 0x39U, 0xF7U, 0xC3U,
    0xABU, 0x73U, 0x89U, 0xBDU, 0x30U, 0x03U, 0x17U, 0x9BU, 0xD9U};

static uint8_t s_PublicKeyInputWeier384[96U] = {
    0x89U, 0xF1U, 0xB7U, 0x32U, 0x2DU, 0x68U, 0xEFU, 0x8AU, 0x73U, 0x17U, 0xB2U,
    0x98U, 0x72U, 0xF0U, 0xE1U, 0x10U, 0x8AU, 0xFFU, 0xF7U, 0x19U, 0x53U, 0x83U,
    0x79U, 0x4AU, 0x1CU, 0x94U, 0x08U, 0xA2U, 0x16U, 0xE6U, 0x18U, 0x0AU, 0xF3U,
    0xC3U, 0x7FU, 0x69U, 0x6AU, 0xE8U, 0xCBU, 0xF0U, 0x34U, 0x8DU, 0x14U, 0x8AU,
    0x9AU, 0x22U, 0x75U, 0x1DU, 0x57U, 0x39U, 0x14U, 0x3EU, 0xE8U, 0xAFU, 0xB6U,
    0x51U, 0x35U, 0x83U, 0x6CU, 0xBDU, 0x35U, 0x97U, 0x4DU, 0x67U, 0x53U, 0xB7U,
    0x12U, 0x7DU, 0xAAU, 0xDDU, 0xB2U, 0xEEU, 0x0AU, 0x60U, 0x39U, 0xFBU, 0xF0U,
    0xE5U, 0x77U, 0x8CU, 0x76U, 0xD0U, 0x6CU, 0x28U, 0xBBU, 0x66U, 0xEAU, 0xA9U,
    0x4EU, 0xA3U, 0x14U, 0x6BU, 0x53U, 0xA6U, 0xA6U, 0x22U};

static uint8_t s_PublicKeyInputWeier521[132U] = {
    0x00U, 0x4BU, 0x29U, 0xF5U, 0xEFU, 0x68U, 0xBBU, 0x53U, 0x47U, 0xA5U,
    0x4AU, 0x76U, 0x6AU, 0x09U, 0x80U, 0xD6U, 0x1FU, 0x45U, 0xA1U, 0x90U,
    0xD8U, 0xBBU, 0x4EU, 0xFDU, 0x88U, 0x90U, 0x5FU, 0xA6U, 0xABU, 0x6AU,
    0x6DU, 0x6BU, 0x5EU, 0xFAU, 0x5BU, 0x3EU, 0xB4U, 0xBCU, 0x4CU, 0xB4U,
    0x98U, 0x6BU, 0xF0U, 0xB5U, 0x99U, 0xACU, 0xB1U, 0xAAU, 0xD8U, 0x62U,
    0xADU, 0xE0U, 0xCAU, 0x7AU, 0x22U, 0x4AU, 0xE0U, 0xC5U, 0xAEU, 0x6DU,
    0x6EU, 0x9EU, 0x97U, 0x88U, 0xDDU, 0xA0U, 0x01U, 0x01U, 0x08U, 0x21U,
    0x53U, 0x9BU, 0xDAU, 0x45U, 0x0FU, 0xCBU, 0x07U, 0x93U, 0x8EU, 0xFCU,
    0x8EU, 0xE5U, 0x56U, 0xF8U, 0x8AU, 0xE0U, 0xC8U, 0x06U, 0xA8U, 0x7CU,
    0xD2U, 0x1AU, 0x1EU, 0x82U, 0x8EU, 0x3AU, 0xECU, 0x00U, 0x5EU, 0x0DU,
    0x90U, 0x5FU, 0x13U, 0xF5U, 0x50U, 0xE1U, 0xA1U, 0x95U, 0x6DU, 0x76U,
    0x80U, 0xEEU, 0x9AU, 0xC5U, 0x88U, 0xBEU, 0x42U, 0x85U, 0x5CU, 0x15U,
    0xDDU, 0xCBU, 0x97U, 0xA9U, 0xFAU, 0x1BU, 0x24U, 0x91U, 0x98U, 0xA5U,
    0x49U, 0x8EU};

/* Small input message */
static uint8_t s_MessageSmallEccEd25519[MESSAGE_SMALL]
    __attribute__((aligned(4U))) = {
        0xDDU, 0xAFU, 0x35U, 0xA1U, 0x93U, 0x61U, 0x7AU, 0xBAU, 0xCCU, 0x41U,
        0x73U, 0x49U, 0xAEU, 0x20U, 0x41U, 0x31U, 0x12U, 0xE6U, 0xFAU, 0x4EU,
        0x89U, 0xA9U, 0x7EU, 0xA2U, 0x0AU, 0x9EU, 0xEEU, 0xE6U, 0x4BU, 0x55U,
        0xD3U, 0x9AU, 0x21U, 0x92U, 0x99U, 0x2AU, 0x27U, 0x4FU, 0xC1U, 0xA8U,
        0x36U, 0xBAU, 0x3CU, 0x23U, 0xA3U, 0xFEU, 0xEBU, 0xBDU, 0x45U, 0x4DU,
        0x44U, 0x23U, 0x64U, 0x3CU, 0xE8U, 0x0EU, 0x2AU, 0x9AU, 0xC9U, 0x4FU,
        0xA5U, 0x4CU, 0xA4U, 0x9FU};

/* Larger input message */
static uint8_t s_MessageLargeEccEd25519[MESSAGE_LARGE]
    __attribute__((aligned(4U)));

/* Example value for private RSA exponent d */
static uint8_t s_ExponentDRSA[RSA_KEY_BYTE_LENGTH] __attribute__((
    aligned(4U))) = {
    0x15U, 0x5FU, 0xE6U, 0x60U, 0xCDU, 0xDEU, 0xAAU, 0x17U, 0x1BU, 0x5EU, 0xD6U,
    0xBDU, 0xD0U, 0x3BU, 0xB3U, 0x56U, 0xE0U, 0xF6U, 0xE8U, 0x6BU, 0x5AU, 0x3CU,
    0x26U, 0xF3U, 0xCEU, 0x7DU, 0xAEU, 0x00U, 0x8CU, 0x4EU, 0x38U, 0xA9U, 0xA9U,
    0x7FU, 0xA5U, 0x97U, 0xB2U, 0xB9U, 0x0AU, 0x45U, 0x10U, 0xD2U, 0x23U, 0x8DU,
    0x3FU, 0x15U, 0x8AU, 0xB8U, 0x91U, 0x97U, 0xFBU, 0x08U, 0xA5U, 0xB7U, 0x4CU,
    0xFEU, 0x5CU, 0xC8U, 0xF1U, 0x3DU, 0x47U, 0x09U, 0x62U, 0x91U, 0xD0U, 0x05U,
    0x38U, 0xAAU, 0x58U, 0x93U, 0xD8U, 0x2DU, 0xCEU, 0x55U, 0xB3U, 0x64U, 0x8CU,
    0x6AU, 0x71U, 0x9AU, 0xE3U, 0x87U, 0xDEU, 0xE5U, 0x5EU, 0xC5U, 0xBEU, 0xF0U,
    0x89U, 0x76U, 0x3DU, 0xE7U, 0x1EU, 0x47U, 0x61U, 0xB7U, 0x03U, 0xADU, 0x69U,
    0x2EU, 0xD6U, 0x2DU, 0x7CU, 0x1FU, 0x4FU, 0x0FU, 0xF0U, 0x03U, 0xC1U, 0x67U,
    0xEBU, 0x62U, 0xD2U, 0xC6U, 0x79U, 0xCCU, 0x6FU, 0x13U, 0xB9U, 0x87U, 0xA1U,
    0x42U, 0xF1U, 0x37U, 0x7AU, 0x40U, 0xBDU, 0xC0U, 0xA0U, 0x36U, 0x60U, 0x72U,
    0x94U, 0x40U, 0x14U, 0x63U, 0xA3U, 0x0EU, 0x82U, 0x91U, 0x2BU, 0x42U, 0x8AU,
    0x1DU, 0x3FU, 0x80U, 0xB5U, 0xD0U, 0xD3U, 0x3EU, 0xA8U, 0x4EU, 0x8BU, 0xB6U,
    0x4CU, 0x36U, 0x22U, 0xB9U, 0xBEU, 0xE3U, 0x56U, 0xF1U, 0x2CU, 0x6AU, 0x19U,
    0x0EU, 0x55U, 0x7BU, 0xBFU, 0x25U, 0xE1U, 0x10U, 0x80U, 0x7BU, 0x85U, 0xCAU,
    0xD5U, 0x1BU, 0x39U, 0x87U, 0x57U, 0x08U, 0x06U, 0xBEU, 0x81U, 0xF3U, 0x71U,
    0x3FU, 0x5DU, 0x17U, 0x40U, 0x74U, 0x99U, 0xA5U, 0xDEU, 0xDAU, 0xC0U, 0xF3U,
    0xE3U, 0xBCU, 0x79U, 0x96U, 0x35U, 0x95U, 0xF8U, 0xE0U, 0xCFU, 0x01U, 0x29U,
    0x1DU, 0xC1U, 0x02U, 0x09U, 0xC0U, 0x6EU, 0xB6U, 0x0EU, 0x2EU, 0x9CU, 0x47U,
    0xECU, 0x91U, 0x42U, 0xEDU, 0xA5U, 0xF3U, 0xB7U, 0x0AU, 0xC6U, 0x7FU, 0x72U,
    0xBFU, 0x52U, 0xB3U, 0x31U, 0x37U, 0xD1U, 0x49U, 0xB6U, 0xF6U, 0x06U, 0xE4U,
    0x59U, 0x61U, 0x7DU, 0xAAU, 0x8EU, 0x10U, 0x18U, 0xA8U, 0x14U, 0x1DU, 0x89U,
    0x4EU, 0xCAU, 0xFFU};

/* Example value for public RSA exponent e */
static uint8_t s_ExponentERSA[3U]
    __attribute__((aligned(4))) = {0x01U, 0x00U, 0x01U};

/* Example value for public RSA modulus N */
static uint8_t s_ModulusRSA[RSA_KEY_BYTE_LENGTH] __attribute__((
    aligned(4U))) = {
    0xD3U, 0x24U, 0x96U, 0xE6U, 0x2DU, 0x16U, 0x34U, 0x6EU, 0x06U, 0xE7U, 0xA3U,
    0x1CU, 0x12U, 0x0AU, 0x21U, 0xB5U, 0x45U, 0x32U, 0x32U, 0x35U, 0xEEU, 0x1DU,
    0x90U, 0x72U, 0x1DU, 0xCEU, 0xAAU, 0xD4U, 0x6DU, 0xC4U, 0xCEU, 0xBDU, 0x80U,
    0xC1U, 0x34U, 0x5AU, 0xFFU, 0x95U, 0xB1U, 0xDDU, 0xF8U, 0x71U, 0xEBU, 0xB7U,
    0xF2U, 0x0FU, 0xEDU, 0xB6U, 0xE4U, 0x2EU, 0x67U, 0xA0U, 0xCCU, 0x59U, 0xB3U,
    0x9FU, 0xFDU, 0x31U, 0xE9U, 0x83U, 0x42U, 0xF4U, 0x0AU, 0xD9U, 0xAFU, 0xF9U,
    0x3CU, 0x3CU, 0x51U, 0xCFU, 0x5FU, 0x3CU, 0x8AU, 0xD0U, 0x64U, 0xB8U, 0x33U,
    0xF9U, 0xACU, 0x34U, 0x22U, 0x9AU, 0x3EU, 0xD3U, 0xDDU, 0x29U, 0x41U, 0xBEU,
    0x12U, 0x5BU, 0xC5U, 0xA2U, 0x0CU, 0xB6U, 0xD2U, 0x31U, 0xB6U, 0xD1U, 0x84U,
    0x7EU, 0xC4U, 0xFEU, 0xAEU, 0x2BU, 0x88U, 0x46U, 0xCFU, 0x00U, 0xC4U, 0xC6U,
    0xE7U, 0x5AU, 0x51U, 0x32U, 0x65U, 0x7AU, 0x68U, 0xECU, 0x04U, 0x38U, 0x36U,
    0x46U, 0x34U, 0xEAU, 0xF8U, 0x27U, 0xF9U, 0xBBU, 0x51U, 0x6CU, 0x93U, 0x27U,
    0x48U, 0x1DU, 0x58U, 0xB8U, 0xFFU, 0x1EU, 0xA4U, 0xC0U, 0x1FU, 0xA1U, 0xA2U,
    0x57U, 0xA9U, 0x4EU, 0xA6U, 0xD4U, 0x72U, 0x60U, 0x3BU, 0x3FU, 0xB3U, 0x24U,
    0x53U, 0x22U, 0x88U, 0xEAU, 0x3AU, 0x97U, 0x43U, 0x53U, 0x59U, 0x15U, 0x33U,
    0xA0U, 0xEBU, 0xBEU, 0xF2U, 0x9DU, 0xF4U, 0xF8U, 0xBCU, 0x4DU, 0xDBU, 0xF8U,
    0x8EU, 0x47U, 0x1FU, 0x1DU, 0xA5U, 0x00U, 0xB8U, 0xF5U, 0x7BU, 0xB8U, 0xC3U,
    0x7CU, 0xA5U, 0xEAU, 0x17U, 0x7CU, 0x4EU, 0x8AU, 0x39U, 0x06U, 0xB7U, 0xC1U,
    0x42U, 0xF7U, 0x78U, 0x8CU, 0x45U, 0xEAU, 0xD0U, 0xC9U, 0xBCU, 0x36U, 0x92U,
    0x48U, 0x3AU, 0xD8U, 0x13U, 0x61U, 0x11U, 0x45U, 0xB4U, 0x1FU, 0x9CU, 0x01U,
    0x2EU, 0xF2U, 0x87U, 0xBEU, 0x8BU, 0xBFU, 0x93U, 0x19U, 0xCFU, 0x4BU, 0x91U,
    0x84U, 0xDCU, 0x8EU, 0xFFU, 0x83U, 0x58U, 0x9BU, 0xE9U, 0x0CU, 0x54U, 0x81U,
    0x14U, 0xACU, 0xFAU, 0x5AU, 0xBFU, 0x79U, 0x54U, 0xBFU, 0x9FU, 0x7AU, 0xE5U,
    0xB4U, 0x38U, 0xB5U};

/* Example value for Sha2-256 message digest */
static uint8_t s_MessageDigest32Byte[RSA_MESSAGE_DIGEST_LENGTH] __attribute__((
    aligned(4U))) = {0xF4U, 0x45U, 0x80U, 0x1EU, 0x0CU, 0xB8U, 0x99U, 0x26U,
                     0x2CU, 0x9BU, 0x9EU, 0x21U, 0x98U, 0x36U, 0x88U, 0x0DU,
                     0x73U, 0xCAU, 0x2DU, 0x1BU, 0x0BU, 0x9CU, 0x15U, 0xFBU,
                     0x95U, 0x9CU, 0x90U, 0xEBU, 0x12U, 0x12U, 0x34U, 0xE3U};

/* Example value for Sha2-512 message digest */
static uint8_t s_MessageDigest64Byte[RSA_MESSAGE_DIGEST_LENGTH * 2U]
    __attribute__((aligned(4U))) = {
        0xF4U, 0x45U, 0x80U, 0x1EU, 0x0CU, 0xB8U, 0x99U, 0x26U, 0x2CU, 0x9BU,
        0x9EU, 0x21U, 0x98U, 0x36U, 0x88U, 0x0DU, 0x73U, 0xCAU, 0x2DU, 0x1BU,
        0x0BU, 0x9CU, 0x15U, 0xFBU, 0x95U, 0x9CU, 0x90U, 0xEBU, 0x12U, 0x12U,
        0x34U, 0xE3U, 0xF4U, 0x45U, 0x80U, 0x1EU, 0x0CU, 0xB8U, 0x99U, 0x26U,
        0x2CU, 0x9BU, 0x9EU, 0x21U, 0x98U, 0x36U, 0x88U, 0x0DU, 0x73U, 0xCAU,
        0x2DU, 0x1BU, 0x0BU, 0x9CU, 0x15U, 0xFBU, 0x95U, 0x9CU, 0x90U, 0xEBU,
        0x12U, 0x12U, 0x34U, 0xE3U};
...
static uint8_t s_BN_P256_G[2U * WEIER256_BIT_LENGTH / 8U] = {
    ...
    0x33U, 0xA0U, 0xF4U, 0xA1U, 0x39U, 0x45U, 0xD8U, 0x98U, 0xC2U, 0x96U, 0x4FU,
    0xE3U, 0x42U, 0xE2U, 0xFEU, 0x1AU, 0x7FU, 0x9BU, 0x8EU, 0xE7U, 0xEBU, 0x4AU,
    0x7CU, 0x0FU, 0x9EU, 0x16U, 0x2BU, 0xCEU, 0x33U, 0x57U, 0x6BU, 0x31U, 0x5EU,
    0xCEU, 0xCBU, 0xB6U, 0x40U, 0x68U, 0x37U, 0xBFU, 0x51U, 0xF5U};
...
static uint8_t s_BN_P384_P[48U] = {
    0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
    0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
    0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
    0xFFU, 0xFEU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0x00U, 0x00U, 0x00U, 0x00U,
    0x00U, 0x00U, 0x00U, 0x00U, 0xFFU, 0xFFU, 0xFFU, 0xFFU};

static uint8_t s_BN_P384_A[48U] = {
    0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
    0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
    0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
    0xFFU, 0xFEU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0x00U, 0x00U, 0x00U, 0x00U,
...
static uint8_t s_BN_P384_B[48U] = {
    0xB3U, 0x31U, 0x2FU, 0xA7U, 0xE2U, 0x3EU, 0xE7U, 0xE4U, 0x98U, 0x8EU,
    0x05U, 0x6BU, 0xE3U, 0xF8U, 0x2DU, 0x19U, 0x18U, 0x1DU, 0x9CU, 0x6EU,
    0xFEU, 0x81U, 0x41U, 0x12U, 0x03U, 0x14U, 0x08U, 0x8FU, 0x50U, 0x13U,
    0x87U, 0x5AU, 0xC6U, 0x56U, 0x39U, 0x8DU, 0x8AU, 0x2EU, 0xD1U, 0x9DU,
    0x2AU, 0x85U, 0xC8U, 0xEDU, 0xD3U, 0xECU, 0x2AU, 0xEFU};

static uint8_t s_BN_P384_G[96U] = {
    0xAAU, 0x87U, 0xCAU, 0x22U, 0xBEU, 0x8BU, 0x05U, 0x37U, 0x8EU, 0xB1U, 0xC7U,
    0x1EU, 0xF3U, 0x20U, 0xADU, 0x74U, 0x6EU, 0x1DU, 0x3BU, 0x62U, 0x8BU, 0xA7U,
    0x9BU, 0x98U, 0x59U, 0xF7U, 0x41U, 0xE0U, 0x82U, 0x54U, 0x2AU, 0x38U, 0x55U,
    0x02U, 0xF2U, 0x5DU, 0xBFU, 0x55U, 0x29U, 0x6CU, 0x3AU, 0x54U, 0x5EU, 0x38U,
    0x72U, 0x76U, 0x0AU, 0xB7U, 0x36U, 0x17U, 0xDEU, 0x4AU, 0x96U, 0x26U, 0x2CU,
    0x6FU, 0x5DU, 0x9EU, 0x98U, 0xBFU, 0x92U, 0x92U, 0xDCU, 0x29U, 0xF8U, 0xF4U,
    0x1DU, 0xBDU, 0x28U, 0x9AU, 0x14U, 0x7CU, 0xE9U, 0xDAU, 0x31U, 0x13U, 0xB5U,
    0xF0U, 0xB8U, 0xC0U, 0x0AU, 0x60U, 0xB1U, 0xCEU, 0x1DU, 0x7EU, 0x81U, 0x9DU,
    0x7AU, 0x43U, 0x1DU, 0x7CU, 0x90U, 0xEAU, 0x0EU, 0x5FU};

static uint8_t s_BN_P384_N[48U] = {
    0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
    0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
    0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xC7U, 0x63U, 0x4DU, 0x81U, 0xF4U, 0x37U,
    0x2DU, 0xDFU, 0x58U, 0x1AU, 0x0DU, 0xB2U, 0x48U, 0xB0U, 0xA7U, 0x7AU,
    0xECU, 0xECU, 0x19U, 0x6AU, 0xCCU, 0xC5U, 0x29U, 0x73U};

static uint8_t s_BN_P521_P[66U] = {
...
static uint8_t s_BN_P521_A[66U] = {
    0x01U, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
    0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
    0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
    0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
...
static uint8_t s_BN_P521_B[66U] = {
    0x00U, 0x51U, 0x95U, 0x3EU, 0xB9U, 0x61U, 0x8EU, 0x1CU, 0x9AU, 0x1FU,
    0x92U, 0x9AU, 0x21U, 0xA0U, 0xB6U, 0x85U, 0x40U, 0xEEU, 0xA2U, 0xDAU,
    0x72U, 0x5BU, 0x99U, 0xB3U, 0x15U, 0xF3U, 0xB8U, 0xB4U, 0x89U, 0x91U,
    0x8EU, 0xF1U, 0x09U, 0xE1U, 0x56U, 0x19U, 0x39U, 0x51U, 0xECU, 0x7EU,
    0x93U, 0x7BU, 0x16U, 0x52U, 0xC0U, 0xBDU, 0x3BU, 0xB1U, 0xBFU, 0x07U,
    0x35U, 0x73U, 0xDFU, 0x88U, 0x3DU, 0x2CU, 0x34U, 0xF1U, 0xEFU, 0x45U,
    0x1FU, 0xD4U, 0x6BU, 0x50U, 0x3FU, 0x00U};

static uint8_t s_BN_P521_G[2U * 66U] = {
    0x00U, 0xC6U, 0x85U, 0x8EU, 0x06U, 0xB7U, 0x04U, 0x04U, 0xE9U, 0xCDU,
    0x9EU, 0x3EU, 0xCBU, 0x66U, 0x23U, 0x95U, 0xB4U, 0x42U, 0x9CU, 0x64U,
    0x81U, 0x39U, 0x05U, 0x3FU, 0xB5U, 0x21U, 0xF8U, 0x28U, 0xAFU, 0x60U,
    0x6BU, 0x4DU, 0x3DU, 0xBAU, 0xA1U, 0x4BU, 0x5EU, 0x77U, 0xEFU, 0xE7U,
    0x59U, 0x28U, 0xFEU, 0x1DU, 0xC1U, 0x27U, 0xA2U, 0xFFU, 0xA8U, 0xDEU,
    0x33U, 0x48U, 0xB3U, 0xC1U, 0x85U, 0x6AU, 0x42U, 0x9BU, 0xF9U, 0x7EU,
    0x7EU, 0x31U, 0xC2U, 0xE5U, 0xBDU, 0x66U, 0x01U, 0x18U, 0x39U, 0x29U,
    0x6AU, 0x78U, 0x9AU, 0x3BU, 0xC0U, 0x04U, 0x5CU, 0x8AU, 0x5FU, 0xB4U,
    0x2CU, 0x7DU, 0x1BU, 0xD9U, 0x98U, 0xF5U, 0x44U, 0x49U, 0x57U, 0x9BU,
    0x44U, 0x68U, 0x17U, 0xAFU, 0xBDU, 0x17U, 0x27U, 0x3EU, 0x66U, 0x2CU,
    0x97U, 0xEEU, 0x72U, 0x99U, 0x5EU, 0xF4U, 0x26U, 0x40U, 0xC5U, 0x50U,
    0xB9U, 0x01U, 0x3FU, 0xADU, 0x07U, 0x61U, 0x35U, 0x3CU, 0x70U, 0x86U,
    0xA2U, 0x72U, 0xC2U, 0x40U, 0x88U, 0xBEU, 0x94U, 0x76U, 0x9FU, 0xD1U,
    0x66U, 0x50U};

static uint8_t s_BN_P521_N[66U] = {
    0x01U, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
    0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
    0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU,
    0xFFU, 0xFFU, 0xFFU, 0xFAU, 0x51U, 0x86U, 0x87U, 0x83U, 0xBFU, 0x2FU,
    0x96U, 0x6BU, 0x7FU, 0xCCU, 0x01U, 0x48U, 0xF7U, 0x09U, 0xA5U, 0xD0U,
    0x3BU, 0xB5U, 0xC9U, 0xB8U, 0x89U, 0x9CU, 0x47U, 0xAEU, 0xBBU, 0x6FU,
    0xB7U, 0x1EU, 0x91U, 0x38U, 0x64U, 0x09U};

/* Variables stored in flash */

/* Private key input for ECC-Ed25519 from flash */
static const uint8_t
    s_PrivKeyInputEccEd25519Flash[MCUXCLECC_EDDSA_ED25519_SIZE_PRIVATEKEY]
    __attribute__((aligned(4U))) = {
...
static const uint8_t s_MessageSmallEccEd25519Flash[MESSAGE_SMALL]
    __attribute__((aligned(4U))) = {
        0xDDU, 0xAFU, 0x35U, 0xA1U, 0x93U, 0x61U, 0x7AU, 0xBAU, 0xCCU, 0x41U,
        0x73U, 0x49U, 0xAEU, 0x20U, 0x41U, 0x31U, 0x12U, 0xE6U, 0xFAU, 0x4EU,
        0x89U, 0xA9U, 0x7EU, 0xA2U, 0x0AU, 0x9EU, 0xEEU, 0xE6U, 0x4BU, 0x55U,
...
static const uint8_t s_MessageLargeEccEd25519Flash[MESSAGE_LARGE]
    __attribute__((aligned(4U)));

/* Example value for private RSA exponent d stored in flash */
static const uint8_t s_ExponentDRSAFlash[RSA_KEY_BYTE_LENGTH] __attribute__((
    aligned(4U))) = {
    0x15U, 0x5FU, 0xE6U, 0x60U, 0xCDU, 0xDEU, 0xAAU, 0x17U, 0x1BU, 0x5EU, 0xD6U,
    0xBDU, 0xD0U, 0x3BU, 0xB3U, 0x56U, 0xE0U, 0xF6U, 0xE8U, 0x6BU, 0x5AU, 0x3CU,
    0x26U, 0xF3U, 0xCEU, 0x7DU, 0xAEU, 0x00U, 0x8CU, 0x4EU, 0x38U, 0xA9U, 0xA9U,
...
static const uint8_t s_ExponentERSAFlash[3U]
    __attribute__((aligned(4))) = {0x01U, 0x00U, 0x01U};

/* Example value for public RSA modulus N stored in flash */
static const uint8_t s_ModulusRSAFlash[RSA_KEY_BYTE_LENGTH] __attribute__((
    aligned(4U))) = {
    0xD3U, 0x24U, 0x96U, 0xE6U, 0x2DU, 0x16U, 0x34U, 0x6EU, 0x06U, 0xE7U, 0xA3U,
    0x1CU, 0x12U, 0x0AU, 0x21U, 0xB5U, 0x45U, 0x32U, 0x32U, 0x35U, 0xEEU, 0x1DU,
    0x90U, 0x72U, 0x1DU, 0xCEU, 0xAAU, 0xD4U, 0x6DU, 0xC4U, 0xCEU, 0xBDU, 0x80U,
...
static const uint8_t s_MessageDigest32ByteFlash[RSA_MESSAGE_DIGEST_LENGTH]
    __attribute__((aligned(4U))) = {
        0xF4U, 0x45U, 0x80U, 0x1EU, 0x0CU, 0xB8U, 0x99U, 0x26U,
        0x2CU, 0x9BU, 0x9EU, 0x21U, 0x98U, 0x36U, 0x88U, 0x0DU,
        0x73U, 0xCAU, 0x2DU, 0x1BU, 0x0BU, 0x9CU, 0x15U, 0xFBU,
        0x95U, 0x9CU, 0x90U, 0xEBU, 0x12U, 0x12U, 0x34U, 0xE3U};

/* Example value for Sha2-512 message digest stored in flash */
static const uint8_t s_MessageDigest64ByteFlash[RSA_MESSAGE_DIGEST_LENGTH * 2U]
    __attribute__((aligned(4U))) = {
        0xF4U, 0x45U, 0x80U, 0x1EU, 0x0CU, 0xB8U, 0x99U, 0x26U, 0x2CU, 0x9BU,
        0x9EU, 0x21U, 0x98U, 0x36U, 0x88U, 0x0DU, 0x73U, 0xCAU, 0x2DU, 0x1BU,
        0x0BU, 0x9CU, 0x15U, 0xFBU, 0x95U, 0x9CU, 0x90U, 0xEBU, 0x12U, 0x12U,
...
bool exec_rsa_sign_pss_sha(char *data_from, uint32_t m_length,
  ...
  ALLOCATE_AND_INITIALIZE_SESSION(
      session, MCUXCLRSA_SIGN_PLAIN_PSSENCODE_4096_WACPU_SIZE,
  ...
  const mcuxClRsa_KeyEntry_t mod1 = {
      .pKeyEntryData = data_from_ram ? (uint8_t *)s_ModulusRSA
                                     : (uint8_t *)s_ModulusRSAFlash,
      .keyEntryLength = RSA_KEY_BYTE_LENGTH};

  const mcuxClRsa_KeyEntry_t exp1 = {
      .pKeyEntryData = data_from_ram ? (uint8_t *)s_ExponentDRSA
                                     : (uint8_t *)s_ExponentDRSAFlash,
      .keyEntryLength =
          data_from_ram ? sizeof(s_ExponentDRSA) : sizeof(s_ExponentDRSAFlash)};
  ...
  /**************************************************************************/
  a_result->signPerS = TIME_PUBLIC(
      GENERATE_RSA_SIGNATURE(data_from_ram, session, private_key, m_length));
...
bool exec_rsa_verify_pss_sha(char *data_from, uint32_t m_length,
  ...
  const mcuxClRsa_KeyEntry_t exp1 = {
      .pKeyEntryData = data_from_ram ? (uint8_t *)s_ExponentERSA
                                     : (uint8_t *)s_ExponentERSAFlash,
      .keyEntryLength =
          data_from_ram ? sizeof(s_ExponentERSA) : sizeof(s_ExponentERSAFlash)};
  ...
  /**************************************************************************/
  a_result->verifyPerS =
      TIME_PUBLIC(RSA_VERIFY(data_from_ram, session, public_key, m_length));
...
bool exec_EdDSA_generate_signature_Ed25519(
  ...
  uint32_t context[1U] = {0};
  mcuxClRandom_Context_t rng_ctx = (mcuxClRandom_Context_t)context;
  ...
  /* Allocate space for and initialize private key handle for an Ed25519 private
   * key */
  ...
  MCUX_CSSL_FP_FUNCTION_CALL_BEGIN(
      privkeyinit_result, privkeyinit_token,
      mcuxClKey_init(
          /* mcuxClSession_Handle_t session         */ &session,
  ...
  /* Allocate space for and initialize pbulic key handle for an Ed25519 public
   * key */
  ...
  MCUX_CSSL_FP_FUNCTION_CALL_BEGIN(
      ...
      mcuxClKey_init(
          ...
          /* mcuxCl_Buffer_t pKeyData               */
          (mcuxCl_Buffer_t)s_PublicKeyBufferEcc,
          /* uint32_t keyDataLength                 */
          sizeof(s_PublicKeyBufferEcc)));
  ...
  /* Allocate space for and initialize EdDSA key pair generation descriptor for
   * private key input */
  uint8_t priv_key_input_descriptor
      [MCUXCLECC_EDDSA_GENERATEKEYPAIR_DESCRIPTOR_SIZE];
  MCUX_CSSL_FP_FUNCTION_CALL_BEGIN(
      initmode_result, initmode_token,
      mcuxClEcc_EdDSA_InitPrivKeyInputMode(
          ...
          (mcuxClEcc_EdDSA_GenerateKeyPairDescriptor_t
               *)&priv_key_input_descriptor,
          /* const uint8_t *pPrivKey                          */
          data_from_ram ? s_PrivKeyInputEccEd25519
                        : s_PrivKeyInputEccEd25519Flash));
  ...
  /* Call mcuxClEcc_EdDSA_GenerateKeyPair to derive the public key from the
   * private one. */
  MCUX_CSSL_FP_FUNCTION_CALL_BEGIN(
      keygen_result, keygen_token,
      mcuxClEcc_EdDSA_GenerateKeyPair(
          ...
          (mcuxClEcc_EdDSA_GenerateKeyPairDescriptor_t
               *)&priv_key_input_descriptor,
          /*  mcuxClKey_Handle_t priv_key                               */
          priv_key,
          /*  mcuxClKey_Handle_t pubKey                                */
          pub_key));

  if ((MCUX_CSSL_FP_FUNCTION_CALLED(mcuxClEcc_EdDSA_GenerateKeyPair) !=
       keygen_token) ||
  ...
  /**************************************************************************/
  a_result->signPerS = TIME_PUBLIC(GENERATE_ECC_ED25519_SIGNATURE(
      data_from_ram, session, priv_key, m_length));
...
bool exec_EdDSA_verify_signature_Ed25519(char *data_from, uint32_t m_length,
  ...
  if ((MCUX_CSSL_FP_FUNCTION_CALLED(mcuxClKey_init) != keyInit_token) ||
      (MCUXCLKEY_STATUS_OK != keyInit_status)) {
    PRINTF("[Error] Public key initialization failed\r\n");
    return BM_STATUS_ERROR;
  }
  MCUX_CSSL_FP_FUNCTION_CALL_END();
  ...
  /**************************************************************************/
  a_result->verifyPerS = TIME_PUBLIC(
      ECC_ED25519_VERIFY(data_from_ram, session, pub_key_handler, m_length));
...
static mcuxClEcc_DomainParam_t get_domain_param_by_mode(uint32_t bit_length,
                                                        bool data_from_ram) {
  const uint32_t p_byte_length = (bit_length + 7U) / 8U;
  const uint32_t n_byte_length = (bit_length + 7U) / 8U;
  switch (bit_length) {
  case WEIER256_BIT_LENGTH:
    return (mcuxClEcc_DomainParam_t){
        .pA = data_from_ram ? s_BN_P256_A : s_BN_P256_A_Flash,
  ...
  case WEIER384_BIT_LENGTH:
    return (mcuxClEcc_DomainParam_t){
        .pA = data_from_ram ? s_BN_P384_A : s_BN_P384_A_Flash,
  ...
  case WEIER521_BIT_LENGTH:
    return (mcuxClEcc_DomainParam_t){
        .pA = data_from_ram ? s_BN_P521_A : s_BN_P521_A_Flash,
...
static mcuxClEcc_Sign_Param_t
get_param_sign(uint32_t bit_length, mcuxClEcc_DomainParam_t domain_params,
               bool data_from_ram, uint32_t m_length) {
  if (data_from_ram) {
    switch (bit_length) {
    case WEIER256_BIT_LENGTH:
    ...
    case WEIER256_BIT_LENGTH:
      return (mcuxClEcc_Sign_Param_t){
          .curveParam = domain_params,
          .pHash = m_length == 32U ? s_MessageDigest32ByteFlash
                                   : s_MessageDigest64ByteFlash,
...
bool exec_weier_ecc_generate_signature(char *data_from, uint32_t m_length,
  ...
  ALLOCATE_AND_INITIALIZE_SESSION(
      session, MCUXCLECC_SIGN_WACPU_SIZE,
      MCUXCLECC_SIGN_WAPKC_SIZE(p_byte_length, n_byte_length));

  /* Initialize the RNG context, with maximum size */
  uint32_t rng_ctx[MCUXCLRANDOMMODES_CTR_DRBG_AES256_CONTEXT_SIZE_IN_WORDS] = {
      0U};
  ...
  mcuxClEcc_DomainParam_t domain_param =
      get_domain_param_by_mode(bit_length, data_from_ram);

  /**************************************************************************/
  /* Generate signature                                                     */
  /**************************************************************************/
  mcuxClEcc_Sign_Param_t parameters =
      get_param_sign(bit_length, domain_param, data_from_ram, m_length);
  parameters.pMode = &mcuxClEcc_ECDSA_ProtocolDescriptor;

  MCUX_CSSL_FP_FUNCTION_CALL_BEGIN(sign_result, sign_token,
                                   mcuxClEcc_Sign(session, &parameters));
...
bool exec_weier_ecc_verify_signature(char *data_from, uint32_t m_length,
  ...
  mcuxClSession_Handle_t session = &session_desc;
  ALLOCATE_AND_INITIALIZE_SESSION(
      session, MCUXCLECC_VERIFY_WACPU_SIZE,
  ...
  scalar_prec_G[n_byte_length - 1U - (scalar_bit_index / 8U)] =
      (uint8_t)1U << (scalar_bit_index & 7U);
  ...
  mcuxClEcc_PointMult_Param_t point_mult_params = {.curveParam = domain_params,
                                                   ...
                                                   .optLen = 0U};
  MCUX_CSSL_FP_FUNCTION_CALL_BEGIN(
      retEccPointMult, tokenEccPointMult,
  ...
  if (data_from_ram) {
    ...
    paramVerify.pOutputR = output_R;
    paramVerify.optLen = m_length == 32U
                             ? mcuxClEcc_Sign_Param_optLen_Pack(32U)
                             : mcuxClEcc_Sign_Param_optLen_Pack(64U);
  } else {
    paramVerify.curveParam = domain_params;
    paramVerify.pPrecG = result;
    paramVerify.pHash = m_length == 32U ? s_MessageDigest32ByteFlash
                                        : s_MessageDigest64ByteFlash;
    paramVerify.pSignature = s_SignatureBufferWeier;
    switch (bit_length) {
    case WEIER256_BIT_LENGTH:
  ...
  MCUX_CSSL_FP_FUNCTION_CALL_BEGIN(retEccVerify, tokenEccVerify,
...
void test_weier_signature(char *code_from, char *data_from, uint32_t m_length,
  ...
  a_result.signPerS = TIME_PUBLIC(
      exec_weier_ecc_generate_signature(data_from, m_length, bit_length));
  a_result.verifyPerS = TIME_PUBLIC(
      exec_weier_ecc_verify_signature(data_from, m_length, bit_length));
...
void test_ecc_ed25519_signature(char *code_from, char *data_from,
  ...
  strcpy(a_result.execution,
         m_length == MESSAGE_SMALL ? "SMALL MESSAGE" : "LARGE MESSAGE");
