...
static ALIGNED uint8_t s_PlainKeyCkdfSp800108[32U] = {
    0x9CU, 0xF4U, 0x83U, 0x16U, 0xE4U, 0xEEU, 0x94U, 0x0FU, 0x75U, 0xA0U, 0x8BU,
...
static ALIGNED uint8_t s_DerivationDataCkdfSp800108[12U] = {
    0xC8U, 0xACU, 0x48U, 0x88U, 0xA6U, 0x1BU,
    0x3DU, 0x9BU, 0x56U, 0xA9U, 0x75U, 0xE7U,
};

static ALIGNED uint8_t s_AesInputCkdfSp800108[16U] = {
    0x35U, 0xE6U, 0x2CU, 0x18U, 0x02U, 0xCAU, 0x06U, 0x5BU,
    0xCDU, 0x56U, 0x1EU, 0xBFU, 0x9BU, 0xF0U, 0x2DU, 0x00U};

static ALIGNED uint8_t s_DerivedKeyKATCkdfSp800108[32U] = {
    0xF8U, 0x84U, 0x40U, 0x89U, 0xE9U, 0x47U, 0xADU, 0x6BU, 0xACU, 0x71U, 0x2FU,
    0x35U, 0x39U, 0x87U, 0xCAU, 0x4BU, 0x9AU, 0x1DU, 0x6BU, 0xCAU, 0xCFU, 0xE2U,
    0xCAU, 0xF5U, 0x1CU, 0x55U, 0xFDU, 0x56U, 0xCDU, 0x83U, 0xC3U, 0xF4U};

/* Hkdf RFC5869 variables */
static ALIGNED uint8_t s_PlainKeyHkdfRfc5869[32U] = {
    0x4AU, 0xDFU, 0x2DU, 0xD0U, 0x0CU, 0x88U, 0xC7U, 0x27U, 0x89U, 0x00U, 0x80U,
...
static ALIGNED uint8_t s_AES256KATOutputHkdfRfc5869[16U] = {
    0x94U, 0x21U, 0x64U, 0x1CU, 0xA4U, 0x9DU, 0xEBU, 0x10U,
    0xFBU, 0xDAU, 0x1AU, 0x15U, 0x64U, 0xABU, 0xA4U, 0x61U};

static ALIGNED uint8_t s_AES256InputHkdfRfc5869[16U] = {
    0x6BU, 0xC1U, 0xBEU, 0xE2U, 0x2EU, 0x40U, 0x9FU, 0x96U,
    0xE9U, 0x3DU, 0x7EU, 0x11U, 0x73U, 0x93U, 0x17U, 0x2AU};

static ALIGNED uint8_t s_DerivationDataHkdfRfc5869[32U] = {0U};

/* Hkdf SP80056C variables */
static ALIGNED uint8_t s_PlainKeyHkdfSp80056c[32U] = {
    0x95U, 0x37U, 0xA2U, 0xE8U, 0xA3U, 0x38U, 0x27U, 0xC2U, 0xDEU, 0xF4U, 0xEAU,
...
static ALIGNED uint8_t s_DerivationDataHkdfSp80056c[32U] = {
    0x00U, 0x00U, 0x00U, 0x01U, 0x66U, 0x2AU, 0xF2U, 0x03U, 0x79U, 0xB2U, 0x9DU,
    0x5EU, 0xF8U, 0x13U, 0xE6U, 0x55U, 0x80U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
    0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x01U, 0x80U};

static ALIGNED uint8_t s_DerivedKeyKatHkdfSp80056c[32U] = {
    0xF1U, 0x97U, 0xF8U, 0xD2U, 0xB5U, 0xF2U, 0x8AU, 0x87U, 0xF1U, 0x4CU, 0xEEU,
...
static status_t ckdf_sp800108(void) {
  ...
  ALIGNED uint8_t aes256_kat_output[16U] = {0U};
  ...
  MCUX_CSSL_FP_FUNCTION_CALL_BEGIN(
      ...
      mcuxClEls_Cipher_Async(
          cipher_options, (mcuxClEls_KeyIndex_t)0U, s_DerivedKeyKATCkdfSp800108,
          MCUXCLELS_CIPHER_KEY_SIZE_AES_256, s_AesInputCkdfSp800108,
          sizeof(s_AesInputCkdfSp800108), NULL, aes256_kat_output));

  if ((MCUX_CSSL_FP_FUNCTION_CALLED(mcuxClEls_Cipher_Async) != token) ||
  ...
  if (import_plain_key_into_els(
          s_PlainKeyCkdfSp800108, sizeof(s_PlainKeyCkdfSp800108),
  ...
  MCUX_CSSL_FP_FUNCTION_CALL_BEGIN(
      ...
      mcuxClEls_Ckdf_Sp800108_Async(key_index, key_index_derived,
                                    s_DerivedKeyProperties,
                                    s_DerivationDataCkdfSp800108));

  if ((MCUX_CSSL_FP_FUNCTION_CALLED(mcuxClEls_Ckdf_Sp800108_Async) !=
       tokenAsync) ||
  ...
  ALIGNED uint8_t aes256_output[16U] = {0U};
  ...
  MCUX_CSSL_FP_FUNCTION_CALL_BEGIN(
      result, token,
      mcuxClEls_Cipher_Async(
          cipher_options_els, (mcuxClEls_KeyIndex_t)key_index_derived, NULL,
          MCUXCLELS_CIPHER_KEY_SIZE_AES_256, s_AesInputCkdfSp800108,
...
static status_t hkdf_rfc5869(void) {
  ...
  /* Import plain key into ELS keystore */
  if (import_plain_key_into_els(
          s_PlainKeyHkdfRfc5869, sizeof(s_PlainKeyHkdfRfc5869),
          s_PlainKeyPropertiesHkdf, &key_index) != STATUS_SUCCESS) {
    return STATUS_ERROR_GENERIC;
  }
  ...
  MCUX_CSSL_FP_FUNCTION_CALL_BEGIN(
      ...
      mcuxClEls_Hkdf_Rfc5869_Async(options, key_index, key_index_derived,
                                   s_DerivedKeyProperties,
                                   s_DerivationDataHkdfRfc5869));
  if ((MCUX_CSSL_FP_FUNCTION_CALLED(mcuxClEls_Hkdf_Rfc5869_Async) !=
       tokenAsync) ||
      (MCUXCLELS_STATUS_OK_WAIT != resultCkdf)) {
    (void)els_delete_key(key_index);
    return STATUS_ERROR_GENERIC;
...
static status_t hkdf_sp80056c(void) {
  ...
  ALIGNED uint8_t derived_key[32U] = {0U};

  /* Import plain key into ELS keystore */
  if (import_plain_key_into_els(
          s_PlainKeyHkdfSp80056c, sizeof(s_PlainKeyHkdfSp80056c),
          s_PlainKeyPropertiesHkdf, &key_index) != STATUS_SUCCESS) {
    return STATUS_ERROR_GENERIC;
  }
  ...
  MCUX_CSSL_FP_FUNCTION_CALL_BEGIN(
      resultCkdf, tokenAsync,
      mcuxClEls_Hkdf_Sp80056c_Async(key_index, derived_key,
                                    s_DerivationDataHkdfSp80056c,
                                    sizeof(s_DerivationDataHkdfSp80056c)));
  if ((MCUX_CSSL_FP_FUNCTION_CALLED(mcuxClEls_Hkdf_Sp80056c_Async) !=
       tokenAsync) ||
      (MCUXCLELS_STATUS_OK_WAIT != resultCkdf)) {
    (void)els_delete_key(key_index);
    return STATUS_ERROR_GENERIC;
