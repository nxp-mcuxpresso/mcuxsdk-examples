 ...
 ******************************************************************************/
/* SHA2 variables */
static ALIGNED uint8_t s_MsgSha224[11U] = {0x6FU, 0x29U, 0xCAU, 0x27U,
                                           0x41U, 0x90U, 0x40U, 0x07U,
                                           0x20U, 0xBBU, 0xA2U};

static ALIGNED uint8_t s_MacKatSha224[28U] = {
    0xACU, 0x53U, 0x15U, 0x79U, 0x47U, 0xAAU, 0x4BU, 0x2AU, 0x19U, 0x08U,
    0x91U, 0x82U, 0x38U, 0x2AU, 0x43U, 0x63U, 0xD1U, 0x82U, 0xDDU, 0x8EU,
    0x4CU, 0xA7U, 0x9CU, 0xD8U, 0x57U, 0x13U, 0x90U, 0xBEU};

static ALIGNED uint8_t s_MsgSha256[11U] = {0x76U, 0xEDU, 0x24U, 0xA0U,
                                           0xF4U, 0x0AU, 0x41U, 0x22U,
                                           0x1EU, 0xBFU, 0xCFU};

static ALIGNED uint8_t s_MacKatSha256[32U] = {
    0x04U, 0x4CU, 0xEFU, 0x80U, 0x29U, 0x01U, 0x93U, 0x2EU, 0x46U, 0xDCU, 0x46U,
...
static ALIGNED uint8_t s_MsgSha384[11U] = {0x96U, 0x7FU, 0xA3U, 0x4CU,
                                           0x07U, 0xE4U, 0x94U, 0x5AU,
                                           0x77U, 0x05U, 0x1AU};

static ALIGNED uint8_t s_MacKatSha384[48U] = {
    0xF8U, 0xF2U, 0x4DU, 0x81U, 0xC4U, 0xF8U, 0xF2U, 0x3EU, 0xCBU, 0x42U,
...
static ALIGNED uint8_t s_MsgSha512[11U] = {0x62U, 0x13U, 0xE1U, 0x0AU,
                                           0x44U, 0x20U, 0xE0U, 0xD9U,
                                           0xB7U, 0x70U, 0x37U};

static ALIGNED uint8_t s_MacKatSha512[64U] = {
    0x99U, 0x82U, 0xDCU, 0x2AU, 0x04U, 0xDFU, 0xF1U, 0x65U, 0x56U, 0x7FU, 0x27U,
 ...
 */
static status_t sha2(const uint8_t *msg, const uint32_t msg_size,
                     const uint8_t *input_md, const uint32_t md_size,
                     mcuxClHash_Algo_t sha_algorithm) {
  /* Initialize session */
  mcuxClSession_Descriptor_t session_desc;
  mcuxClSession_Handle_t session = &session_desc;

  ALLOCATE_AND_INITIALIZE_SESSION(session, MCUXCLHASH_MAX_CPU_WA_BUFFER_SIZE,
                                  0U);
  ...
  ALIGNED uint8_t output_md[64U] = {0U};
...
void execute_sha_kat(uint64_t options, char name[]) {
  ...
  if ((bool)(options & FIPS_SHA224)) {
    CHECK_STATUS_AND_LOG(sha2(s_MsgSha224, sizeof(s_MsgSha224), s_MacKatSha224,
                              sizeof(s_MacKatSha224),
                              mcuxClHash_Algorithm_Sha224),
                         name, "KAT");
  }
  /* Execute SHA256 KAT */
  if ((bool)(options & FIPS_SHA256)) {
    CHECK_STATUS_AND_LOG(sha2(s_MsgSha256, sizeof(s_MsgSha256), s_MacKatSha256,
                              sizeof(s_MacKatSha256),
                              mcuxClHash_Algorithm_Sha256),
                         name, "KAT");
  }
  /* Execute SHA384 KAT */
  if ((bool)(options & FIPS_SHA384)) {
    CHECK_STATUS_AND_LOG(sha2(s_MsgSha384, sizeof(s_MsgSha384), s_MacKatSha384,
                              sizeof(s_MacKatSha384),
                              mcuxClHash_Algorithm_Sha384),
                         name, "KAT");
  }
  /* Execute SHA512 KAT */
  if ((bool)(options & FIPS_SHA512)) {
    CHECK_STATUS_AND_LOG(sha2(s_MsgSha512, sizeof(s_MsgSha512), s_MacKatSha512,
                              sizeof(s_MacKatSha512),
