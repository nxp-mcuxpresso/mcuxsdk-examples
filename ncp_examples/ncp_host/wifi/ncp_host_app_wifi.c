...
#define PING_SOCK_TASK_PRIO   PRIORITY_RTOS_TO_OSA((configMAX_PRIORITIES - 2))
static OSA_TASK_HANDLE_DEFINE(ping_sock_thread);
static OSA_TASK_DEFINE(ping_sock_task, PING_SOCK_TASK_PRIO, 1, 1024, 0);

#define NCP_IPERF_TX_TASK_PRIO   PRIORITY_RTOS_TO_OSA((configMAX_PRIORITIES - 2))
...
#define NCP_IPERF_RX_TASK_PRIO   PRIORITY_RTOS_TO_OSA((configMAX_PRIORITIES - 2))
...
#define WIFI_NCP_TASK_PRIO   PRIORITY_RTOS_TO_OSA((configMAX_PRIORITIES - 2))
