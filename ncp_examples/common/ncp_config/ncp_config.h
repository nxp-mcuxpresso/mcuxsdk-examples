 ...
 *
 */
#define WLAN_VERIFY_PEER_CERT_OFT      WLAN_EAP_VER_END
#define WLAN_VERIFY_PEER_CERT_NAME     "verify_peer_cert="
#define WLAN_VERIFY_PEER_CERT_NAME_LEN 17
#define WLAN_VERIFY_PEER_CERT_MAX_LEN  2
#define WLAN_VERIFY_PEER_CERT_DEF      "0"
#define WLAN_VERIFY_PEER_CERT_END      (WLAN_VERIFY_PEER_CERT_OFT + WLAN_VERIFY_PEER_CERT_NAME_LEN + WLAN_VERIFY_PEER_CERT_MAX_LEN)
 ...
 */
#define WLAN_IP_ADDR_TYPE_OFT      WLAN_VERIFY_PEER_CERT_END
