...
3.  Create a new project with the imported configuration.
    1.  Select **File** \> **New**.
        ...
        ![](../images/foe/image10.png "Select the custom project")
...
7.  Create the subdevice stack code for the FoE example.
    ...
    2.  To create the code, select **Start**. By default, the code is located in the Src subfolder under the folder where the project is saved.
        ...
        ![](../images/foe/image18.png "Start to create the code")

8.  Copy the **Src** subfolder to `boards\frdmimxrt1186\ecat_examples\foe\<core>\SSC\Src` under the SDK source code.
9.  Delete the **foe.c** file under the **Src** folder because this file is already provided in the root directory of *foe* example.
