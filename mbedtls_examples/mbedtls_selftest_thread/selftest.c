...
#endif /* NXP remove CTR_DRBG setftest for ELS PKC since there is different implementation */
#if defined(MBEDTLS_CTR_DRBG_C) && !defined(MBEDTLS_MCUX_ELS_PKC_API) && !defined(MBEDTLS_MCUX_ELS_API)
