...
#define HANDLE_BUFFER_SIZE  (16 * 1024)
...
typedef struct _lc3_encoder_t {
    ...
    WORD32 scratch_size;
    xa_lc3_enc_init_cfg_t cfg __attribute__((aligned(8)));

    uint32_t audio_buff[480] __attribute__((aligned(8)));
    uint32_t sdu_buff[400/4] __attribute__((aligned(8)));
    WORD32 handle_buff[HANDLE_BUFFER_SIZE / sizeof(WORD32)] __attribute__((aligned(8)));
    WORD32 scratch_buff[SCRATCH_BUFFER_SIZE / sizeof(WORD32)] __attribute__((aligned(8)));
} lc3_encoder_t;

typedef struct __attribute__((aligned(8))) _lc3_decoder_t {
    int sample_rate;  /* 8000Hz, 16000Hz, 24000Hz, 32000Hz, 44100Hz, 48000Hz. */
    int duration_us;  /* 10000us or 7500us */
    ...
    xa_codec_handle_t handle;
    WORD32 scratch_size;
    xa_lc3_dec_init_cfg_t cfg __attribute__((aligned(8)));
