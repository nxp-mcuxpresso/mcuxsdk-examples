*Copyright 2026 NXP*<br>
*SPDX-License-Identifier: BSD-3-Clause*

# EdgeLock 2GO CSR

This sample application demonstrates how to generate a Certificate Signing Request (CSR) using EdgeLock 2GO provisioned key material stored in secure storage.
