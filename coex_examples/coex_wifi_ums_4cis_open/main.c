 ...
 *
 * Architecture:
 *   This app combines the edgefast_open ums_4cis BT app with Wi-Fi CLI.
 ...
 *   - middleware/edgefast_open/examples/ums_4cis (BT LE Audio UMS)
 *   - examples/coex_examples/coex_wifi_a2dp_source (ethermind coex pattern reference)
 */
...
int main(void)
{
    ...
    printSeparator();
    PRINTF("        Coex Wi-Fi UMS 4CIS Open APP\r\n");
    printSeparator();
