...
#elif defined(APP_USE_NEUTRON64_MODEL) && (HAL_TFLM_TENSOR_ARENA_SIZE_KB < 256)
#error "Must set HAL_TFLM_TENSOR_ARENA_SIZE_KB >= 254"
#elif !defined(APP_USE_NEUTRON16_MODEL) && !defined(APP_USE_NEUTRON64_MODEL) && (HAL_TFLM_TENSOR_ARENA_SIZE_KB < 1536)
...
static void app_task(void *params)
{
    ...
    PRINTF("ULTRAFACE_WIDTH: %d\r\n", ULTRAFACE_WIDTH);
    PRINTF("ULTRAFACE_HEIGHT: %d\r\n", ULTRAFACE_HEIGHT);
    PRINTF("\r\n");
    ...
    static mpp_stats_t ultraface_stats = {0};
