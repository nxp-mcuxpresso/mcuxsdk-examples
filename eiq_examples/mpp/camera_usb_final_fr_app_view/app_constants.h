 ...
 */
#define VIEW_HEIGHT SRC_HEIGHT
#define VIEW_WIDTH  SRC_WIDTH
...
#define MIN_FACE_AREA (RECO_ZONE_RECT_HEIGHT * RECO_ZONE_RECT_WIDTH * 20 / 100) // 20% of recognition-zone size
#define MAX_FACE_AREA (RECO_ZONE_RECT_HEIGHT * RECO_ZONE_RECT_WIDTH * 50 / 100) // 50% of recognition-zone size

#define FRAME_ASP_RATIO    ((float)SRC_WIDTH / SRC_HEIGHT)
