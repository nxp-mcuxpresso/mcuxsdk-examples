 ...
 * reducing the view resolution saves RAM without impacting recognition.
 */
#define VIEW_HEIGHT (APP_CAMERA_HEIGHT / 2)
#define VIEW_WIDTH (APP_CAMERA_WIDTH / 2)
...
#define FACE_BOX_RATIO 120

/* recognition zone size % of detection zone */
//#define RECO_SIZE_PERCENT 70
