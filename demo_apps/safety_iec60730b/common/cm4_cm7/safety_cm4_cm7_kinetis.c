...
#if !defined(_MKE18F16_H_) && !defined(K32L3A60_CM4_H_)
...
void SafetyAnalogTest(safety_common_t *psSafetyCommon)
{
  ...
  {
  case FS_AIO_INIT:
    FS_AIO_InputSet_A7(g_aio_safety_test_items[index], (fs_aio_a7_t *)TESTED_ADC);
    break;
  case FS_AIO_PROGRESS:
    FS_AIO_ReadResult_A7(g_aio_safety_test_items[index], (fs_aio_a7_t *)TESTED_ADC);
    break;
  case FS_PASS: /* successfull execution of test, call the trigger function again */
    if( g_aio_safety_test_items[++index] == NULL)
    {
