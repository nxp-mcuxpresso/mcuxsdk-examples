...
This example demonstrates use of the low power metering library in typical
two-phase power meter application.

## Supported Boards
- [TWR-KM35Z75M](../../_boards/twrkm35z75m/demo_apps/meterliblp2ph_test/example_board_readme.md)
