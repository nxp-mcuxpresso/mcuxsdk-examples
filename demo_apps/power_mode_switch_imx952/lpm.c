...
bool LPM_Resume(void)
{
    ...
    /* it need removed mpu setting, otherwise it induce asser issue:
     * ASSERT ERROR " size == (uint32_t)(1 << i) ": file "/opt/repo/sdk-next/mcuxsdk/examples_int/_boards/imx952lpd5evk19/board.c" Line "547*/
    //BOARD_ConfigMPU();
