...
This example demonstrates use of the low power metering library in active energy
two-phase power meter application.

## Supported Boards
- [TWR-KM35Z75M](../../_boards/twrkm35z75m/demo_apps/meterliblp2phkwh_test/example_board_readme.md)
