...
#if !defined(DEMO_BOARD_MQS_INIT)
#error "This example requires MQS output. Please define DEMO_BOARD_MQS_INIT in board app.h."
#endif
...
int main(void)
{
    ...
    PRINTF("SAI MQS EDMA example started!\n\r");
    ...
    SAI_GetLeftJustifiedConfig(&saiConfig, DEMO_AUDIO_BIT_WIDTH, kSAI_Stereo, 1U << DEMO_SAI_CHANNEL);
    ...
    SAI_Deinit(DEMO_SAI);
    PRINTF("\n\r SAI MQS EDMA example finished!\n\r ");
    while (1)
    {
    }
}
