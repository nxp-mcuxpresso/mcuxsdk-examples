...
static flexio_spi_master_dma_handle_t g_spiHandle;
...
int main(void)
{
    ...
    FLEXIO_SPI_MasterTransferCreateHandleDMA(&spiDev, &g_spiHandle, spi_master_completionCallback, NULL, &txHandle,
                                             &rxHandle);
