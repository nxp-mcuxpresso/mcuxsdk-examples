...
static status_t flexio_pwm_init(uint32_t freq_Hz, uint32_t duty)
{
    ...
    fxioTimerConfig.triggerSelect   = 0;//FLEXIO_TIMER_TRIGGER_SEL_SHIFTnSTAT(0U);
    fxioTimerConfig.triggerSource   = kFLEXIO_TimerTriggerSourceExternal;//kFLEXIO_TimerTriggerSourceInternal;
    ...
    fxioTimerConfig.timerDecrement  = kFLEXIO_TimerDecSrcOnTriggerInputShiftTimerOutput;//kFLEXIO_TimerDecSrcOnFlexIOClockShiftTimerOutput;
    fxioTimerConfig.timerDisable    = kFLEXIO_TimerDisableNever;
    fxioTimerConfig.timerEnable     = kFLEXIO_TimerEnableOnTriggerHigh;//kFLEXIO_TimerEnabledAlways;
