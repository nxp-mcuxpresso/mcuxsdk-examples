# pdm_sai_mqs_interrupt

## Overview
The pdm_sai_mqs_interrupt example shows how to use the PDM driver with interrupt.

In this example, PDM gathers audio data and SAI sends it to MQS.
