 ...
 * Prototypes
 ******************************************************************************/
static void i2c_master_callback(i2c_master_dma_transfer_handle_t *psHandle);
...
i2c_master_dma_transfer_handle_t g_m_i2c_dma_handle;
...
int main(void)
{
    ...
    DMA_Init(EXAMPLE_I2C_DMA_BASEADDR, &dmaConfig);
    DMA_SetChannelPeripheralRequest(EXAMPLE_I2C_DMA_BASEADDR, EXAMPLE_I2C_DMA_CHANNEL, EXAMPLE_DMA_REQUEST_SRC);
    ...
    memset(&g_m_i2c_dma_handle, 0, sizeof(g_m_i2c_dma_handle));
    ...
    I2C_MasterCreateDMAHandle(EXAMPLE_I2C_MASTER_BASEADDR, &g_m_i2c_dma_handle, i2c_master_callback, NULL,
                              EXAMPLE_I2C_DMA_BASEADDR, EXAMPLE_I2C_DMA_CHANNEL);
    I2C_MasterTransferDMA(&g_m_i2c_dma_handle, &masterXfer);
