 ...
 * Definitions
 ******************************************************************************/
#ifndef DMEO_CMP_IRQ_PRIORITY
#define DMEO_CMP_IRQ_PRIORITY 0
#endif
/*******************************************************************************
 * Prototypes
 ******************************************************************************/
 ...
 */
void DEMO_CMPA_IRQ_Handler(void)
{
...
int main(void)
{
    ...
    sCmpConfig.uDmaInterruptConfig.eInterruptRequest = kCMP_InterrruptRequestEnableAll;
