...
qspi_slave_transfer_handle_t g_sHandle;
...
int main(void)
{
    ...
    QSPI_SlaveTransferCreateHandle(EXAMPLE_QSPI_SLAVE_BASEADDR, &g_sHandle, QSPI_SlaveUserCallback, NULL);
    ...
    while (1)
    {
        ...
        QSPI_SlaveTransferNonBlocking(&g_sHandle, &sSlaveXfer);
