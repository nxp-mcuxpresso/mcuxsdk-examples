...
int main(void)
{
    ...
    XBAR_SetSignalsConnection(kXBAR1_InputTpm6LptpmChTrigger0, kXBAR1_OutputSinc2ExtTrigger0);
...
static void DEMO_InitSinc(void)
{
    ...
    sincChannel0ConvOption.convTriggerSource     = kSINC_ConvTrig_HardPosEdge;
