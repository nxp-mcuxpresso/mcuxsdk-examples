...
int main(void)
{
    ...
    PRINTF("GPDMA memory to memory link list transfer example begin.\r\n\r\n");
    ...
    GPDMA_PrepareTransferConfig(&transferConfig,                 /* config. */
                                ...
                                kGPDMA_TransferM2MControllerDma, /* transferType */
                                (uint32_t)&s_descriptor[0]       /* linkListItem */
    );
    ...
    {
        PRINTF("\r\n\r\nGPDMA memory to memory link list transfer example failed.\r\n\r\n");
    ...
    {
        PRINTF("\r\n\r\nGPDMA memory to memory link list transfer example succeed.\r\n\r\n");
    }
