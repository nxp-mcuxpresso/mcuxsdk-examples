...
int main(void)
{
    ...
    PRINTF("\r\nI2C board2board GPDMA example -- Master transfer.\r\n");
    ...
    masterConfig.baudRate_Bps = I2C_BAUDRATE;
        ...
        estatus = I2C_MasterInit(EXAMPLE_I2C_MASTER, &masterConfig, I2C_MASTER_CLOCK_FREQUENCY);
        ...
        memset(&g_m_gpdma_handle, 0, sizeof(g_m_gpdma_handle));
        ...
        GPDMA_CreateHandle(&gpdmaHandle, EXAMPLE_GPDMA, EXAMPLE_I2C_MASTER_CHANNEL);
