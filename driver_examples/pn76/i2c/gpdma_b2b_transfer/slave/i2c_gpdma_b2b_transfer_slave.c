...
i2c_slave_gpdma_handle_t g_s_handle;
...
int main(void)
{
    ...
    PRINTF("\r\nI2C board2board GPDMA example -- Slave transfer.\r\n\r\n");
    ...
    GPDMA_CreateHandle(&g_gpdmaHandle, EXAMPLE_GPDMA, EXAMPLE_I2C_SLAVE_CHANNEL);
    GPDMA_SetChannelDestinationPeripheral(EXAMPLE_GPDMA, EXAMPLE_I2C_SLAVE_CHANNEL, kGpdmaRequestMuxI2cMasterSlv);
    GPDMA_SetChannelSourcePeripheral(EXAMPLE_GPDMA, EXAMPLE_I2C_SLAVE_CHANNEL, kGpdmaRequestMuxI2cMasterSlv);

    I2C_SlaveTransferCreateHandleGPDMA(EXAMPLE_I2C_SLAVE, &g_s_handle, i2c_slave_callback, NULL, &g_gpdmaHandle);
    I2C_SlaveTransferGPDMA(EXAMPLE_I2C_SLAVE, &g_s_handle, kI2C_SlaveCompletionEvent | kI2C_SlaveAddressMatchEvent);
