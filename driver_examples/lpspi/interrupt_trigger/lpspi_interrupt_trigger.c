...
int main(void)
{
    ...
    XBAR_SetSignalsConnection(kXBAR1_InputTpm6LptpmChTrigger0, kXBAR1_OutputLpspi8LpspiTrgInput);
    ...
    EXAMPLE_LPSPI_MASTER_BASEADDR->CFGR0 = EXAMPLE_LPSPI_MASTER_BASEADDR->CFGR0 | LPSPI_CFGR0_HREN(1) | LPSPI_CFGR0_HRDIR(0) | LPSPI_CFGR0_HRSEL(1) | LPSPI_CFGR0_HRPOL(0);
