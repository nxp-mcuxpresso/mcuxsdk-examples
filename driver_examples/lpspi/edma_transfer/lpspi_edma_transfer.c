...
int main(void)
{
    ...
    defined(EXAMPLE_LPSPI_SLAVE_DMAMUX_TX_CHANNEL) && defined(EXAMPLE_LPSPI_SLAVE_DMAMUX_RX_CHANNEL) 
    /* DMA MUX init*/
    DMAMUX_Init(EXAMPLE_LPSPI_MASTER_TX_DMA_MUX_BASEADDR);
    DMAMUX_Init(EXAMPLE_LPSPI_MASTER_RX_DMA_MUX_BASEADDR);

#if (EXAMPLE_LPSPI_MASTER_DMA_MUX_BASE != EXAMPLE_LPSPI_SLAVE_DMA_MUX_BASE)
    DMAMUX_Init(EXAMPLE_LPSPI_SLAVE_TX_DMA_MUX_BASEADDR);
    DMAMUX_Init(EXAMPLE_LPSPI_SLAVE_RX_DMA_MUX_BASEADDR);
#endif

    DMAMUX_SetSource(EXAMPLE_LPSPI_MASTER_RX_DMA_MUX_BASEADDR, EXAMPLE_LPSPI_MASTER_DMAMUX_RX_CHANNEL,
                     EXAMPLE_LPSPI_MASTER_DMA_RX_REQUEST_SOURCE);
    DMAMUX_EnableChannel(EXAMPLE_LPSPI_MASTER_RX_DMA_MUX_BASEADDR, EXAMPLE_LPSPI_MASTER_DMAMUX_RX_CHANNEL);

    DMAMUX_SetSource(EXAMPLE_LPSPI_MASTER_TX_DMA_MUX_BASEADDR, EXAMPLE_LPSPI_MASTER_DMAMUX_TX_CHANNEL,
                     EXAMPLE_LPSPI_MASTER_DMA_TX_REQUEST_SOURCE);
    DMAMUX_EnableChannel(EXAMPLE_LPSPI_MASTER_TX_DMA_MUX_BASEADDR, EXAMPLE_LPSPI_MASTER_DMAMUX_TX_CHANNEL);

    DMAMUX_SetSource(EXAMPLE_LPSPI_SLAVE_RX_DMA_MUX_BASEADDR, EXAMPLE_LPSPI_SLAVE_DMAMUX_RX_CHANNEL,
                     EXAMPLE_LPSPI_SLAVE_DMA_RX_REQUEST_SOURCE);
    DMAMUX_EnableChannel(EXAMPLE_LPSPI_SLAVE_RX_DMA_MUX_BASEADDR, EXAMPLE_LPSPI_SLAVE_DMAMUX_RX_CHANNEL);

    DMAMUX_SetSource(EXAMPLE_LPSPI_SLAVE_TX_DMA_MUX_BASEADDR, EXAMPLE_LPSPI_SLAVE_DMAMUX_TX_CHANNEL,
                     EXAMPLE_LPSPI_SLAVE_DMA_TX_REQUEST_SOURCE);
    DMAMUX_EnableChannel(EXAMPLE_LPSPI_SLAVE_TX_DMA_MUX_BASEADDR, EXAMPLE_LPSPI_SLAVE_DMAMUX_TX_CHANNEL);
#else
    /* DMA MUX init*/
