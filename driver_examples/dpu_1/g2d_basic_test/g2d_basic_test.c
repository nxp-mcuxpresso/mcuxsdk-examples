...
int main(void) 
{
    ...
    us = get_test_runtime(start, test_loops);
    g2d_printf("resize format from nv12 to rgba8888, time %dus, %dfps %dMpixel/s ........\n",
    ...
    us = get_test_runtime(start, test_loops);
    g2d_printf("resize format from bgra8888 to rgba8888, time %dus, %dfps, %dMpixel/s ........\n",
            us, 1000000 / us, frame_pixels / us);
    ...
    us = get_test_runtime(start, test_loops);
    g2d_printf("rotation with resize format from bgra8888 to rgba8888, time %dus, %dfps, %dMpixel/s ........\n",
                us, 1000000 / us, frame_pixels / us);
