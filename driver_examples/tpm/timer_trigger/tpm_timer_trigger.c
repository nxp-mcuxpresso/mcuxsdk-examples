...
int main(void)
{
    ...
    XBAR_SetSignalsConnection(kXBAR1_InputLpit1LpitTrigOut0, kXBAR1_OutputTpm4LptpmTriggerIn0);
    ...
    tpmInfo.enableStartOnTrigger = true;
    tpmInfo.enablePauseOnTrigger = false;
    tpmInfo.enableReloadOnTrigger = true;
