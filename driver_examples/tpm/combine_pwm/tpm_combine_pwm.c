...
int main(void)
{
    ...
    control[0] = TPM_GetChannelControlBits(BOARD_TPM_BASEADDR, (tpm_chnl_t)(BOARD_TPM_CHANNEL_PAIR * 2));
    control[1] = TPM_GetChannelControlBits(BOARD_TPM_BASEADDR, (tpm_chnl_t)((BOARD_TPM_CHANNEL_PAIR * 2) + 1));
    while (1)
    {
        do
        {
