...
int main(void)
{
    ...
    cadcSampleConfigStruct.sampleMode    = DEMO_CADC_CHANNEL1_SAMPLE_MODE;
    ...
    cadcSampleConfigStruct.sampleMode    = DEMO_CADC_CHANNEL2_SAMPLE_MODE;
    ...
    cadcSampleConfigStruct.sampleMode    = DEMO_CADC_CHANNEL3_SAMPLE_MODE;
    ...
    cadcSampleConfigStruct.sampleMode    = DEMO_CADC_CHANNEL4_SAMPLE_MODE;
    ...
    while (1)
    {
        ...
        {
            PRINTF("%d\t\t", CADC_GetSampleResultValue(DEMO_CADC_BASEADDR, 0U));
            PRINTF("%d\t\t", CADC_GetSampleResultValue(DEMO_CADC_BASEADDR, 1U));
            PRINTF("%d\t\t", CADC_GetSampleResultValue(DEMO_CADC_BASEADDR, 2U));
            PRINTF("%d", CADC_GetSampleResultValue(DEMO_CADC_BASEADDR, 3U));
        }
