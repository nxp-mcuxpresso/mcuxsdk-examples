...
uint8_t gHostInitResetController = 0;
...
static gapAdStructure_t advScanStruct[] = {
    ...
    {.length = NumberOfElements(adData1) + 1, .adType = gAdIncomplete16bitServiceList_c, .aData = (uint8_t *)adData1},
    {.adType = gAdShortenedLocalName_c,
     .length = 19,
     .aData  = (uint8_t *)(char[19]){'H', 'C', 'I', 'O', 'T', '_', 'P', 'E', 'R', 'I', 'P', 'H', '\0'}}};
...
gapDeviceSecurityRequirements_t deviceSecurityRequirements = {.pSecurityRequirements        = (void *)&masterSecurity,
                                                              .cNumServices                 = 3,
