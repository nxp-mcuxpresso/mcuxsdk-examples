...
********************************************************************************
    ...
    File info:
        ...
        Created:      2024/10/29 15:58:52
        Created By:   
        Modified:     2025/3/12 17:59:39
        Modified By:  
...
typedef struct {
    ...
    uint8_t x6000_testArray_sub0;
    uint32_t x6000_testArray[OD_CNT_ARR_6000];
    uint8_t x6001_reqData;
    uint32_t x6002_eventData;
} OD_RAM_t;
...
#define OD_ENTRY_H6000_testArray &OD->list[33]
#define OD_ENTRY_H6001_reqData &OD->list[34]
#define OD_ENTRY_H6002_eventData &OD->list[35]
