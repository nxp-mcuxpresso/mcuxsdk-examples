/*******************************************************************************
    ...
    This file was automatically generated by CANopenEditor v4.2.2-0-g07966bd-dirty+07966bd15078ef960cf1227fc184a85d0070bf0e
...
OD_ATTR_PERSIST_COMM OD_PERSIST_COMM_t OD_PERSIST_COMM = {
    ...
    .x1016_consumerHeartbeatTime = {0x0002EA60, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000},
    ...
    .x1019_synchronousCounterOverflowValue = 0x05,
...
OD_ATTR_RAM OD_RAM_t OD_RAM = {
    ...
    .x6000_testArray_sub0 = 0x01,
    .x6000_testArray = {0x00000000},
    .x6001_reqData = 0x00,
    .x6002_eventData = 0x00000000
};
...
typedef struct {
    ...
    OD_obj_array_t o_6000_testArray;
    OD_obj_var_t o_6001_reqData;
    OD_obj_var_t o_6002_eventData;
} ODObjs_t;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_6000_testArray = {
        .dataOrig0 = &OD_RAM.x6000_testArray_sub0,
        .dataOrig = &OD_RAM.x6000_testArray[0],
        .attribute0 = ODA_SDO_R,
    ...
    .o_6001_reqData = {
        .dataOrig = &OD_RAM.x6001_reqData,
        .attribute = ODA_SDO_RW | ODA_RPDO,
        .dataLength = 1
    },
    .o_6002_eventData = {
        .dataOrig = &OD_RAM.x6002_eventData,
        .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
        .dataLength = 4
    }
};
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x6000, 0x02, ODT_ARR, &ODObjs.o_6000_testArray, NULL},
    {0x6001, 0x01, ODT_VAR, &ODObjs.o_6001_reqData, NULL},
    {0x6002, 0x01, ODT_VAR, &ODObjs.o_6002_eventData, NULL},
