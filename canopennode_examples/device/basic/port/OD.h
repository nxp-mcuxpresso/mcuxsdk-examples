...
********************************************************************************
    ...
    File info:
        ...
        Project File: co_basic_device.xdd
        File Version: 1

        Created:      2025/7/15 14:01:43
        Created By:   
        Modified:     2025/7/15 20:18:31
        Modified By:  

    Device Info:
        Vendor Name:  
        Vendor ID:    
        Product Name: co_basic_device
        Product ID:   
...
typedef struct {
    ...
    uint16_t x2000_device_rx_var0;
    uint16_t x2001_device_tx_var0;
    uint16_t x2002_device_tx_var1;
} OD_RAM_t;
...
#define OD_ENTRY_H2000_device_rx_var0 &OD->list[30]
#define OD_ENTRY_H2001_device_tx_var0 &OD->list[31]
#define OD_ENTRY_H2002_device_tx_var1 &OD->list[32]
