...
********************************************************************************
    ...
    File info:
        ...
        Project File: co_basic_manager.xdd
        File Version: 1

        Created:      2025/7/15 14:00:19
        Created By:   
        Modified:     2025/7/15 20:16:57
        Modified By:  

    Device Info:
        Vendor Name:  
        Vendor ID:    
        Product Name: co_basic_manager
        Product ID:   
...
typedef struct {
    ...
    uint16_t x2000_manager_tx_var0;
    uint16_t x2001_manager_rx_var0;
    uint16_t x2002_manager_rx_var1;
} OD_RAM_t;
...
#define OD_ENTRY_H1200_SDOServerParameter &OD->list[12]
...
#define OD_ENTRY_H2000_manager_tx_var0 &OD->list[30]
#define OD_ENTRY_H2001_manager_rx_var0 &OD->list[31]
#define OD_ENTRY_H2002_manager_rx_var1 &OD->list[32]
