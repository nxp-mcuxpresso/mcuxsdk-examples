...
static status_t CAMERA_I2CSend(
    uint8_t deviceAddress, uint32_t subAddress, uint8_t subAddressSize, const uint8_t *txBuff, uint8_t txBuffSize);
static status_t CAMERA_I2CReceive(
...
static void CAMERA_Init(void)
{
    const camera_config_t cameraConfig = {.pixelFormat   = kVIDEO_PixelFormatRGB565,
 ...
 *
 */
static void lpi2c_camera_callback(LPI2C_Type *base, lpi2c_master_handle_t *handle, status_t status, void *userData)
{
...
static void CAMERA_I2CInit(void)
{
    ...
    LPI2C_MasterTransferCreateHandle(SCCB_BASE, &s_handle, lpi2c_camera_callback, NULL);
